...
if ($totalRows > 0) {
	...
	if ($_GET["lstOrientacionPDF"] == "V") {
		...
		$arrayCol = array(
			...
			array("tamano" => "90", "descripcion" => "CLIENTE\n\n"),
			array("tamano" => "40", "descripcion" => "TIPO PAGO\n\n"),
			array("tamano" => "60", "descripcion" => "FECHA / HORA IMPRESORA\n"),
			array("tamano" => "60", "descripcion" => "CONSECUTIVO FISCAL / SERIAL IMPRESORA\n"),
		...
		$arrayCol = array(
			...
			array("tamano" => "35", "descripcion" => "NRO. FACTURA\n"),
			array("tamano" => "140", "descripcion" => "CLIENTE\n\n"),
			array("tamano" => "50", "descripcion" => "TIPO PAGO\n\n"),
			array("tamano" => "70", "descripcion" => "FECHA / HORA IMPRESORA\n"),
			array("tamano" => "70", "descripcion" => "CONSECUTIVO FISCAL / SERIAL IMPRESORA\n"),
	...
	$pdf->Cell($totalAncho,10,("NOTAS DE CRÉDITO IMPRESAS"),0,0,'C');
	...
	while ($row = mysql_fetch_assoc($rs)) {
		...
		$pdf->Cell($arrayCol[9]['tamano'],14,($row['fecha_hora']),'LR',0,'C',true);
		$pdf->Cell($arrayCol[10]['tamano'],14,($row['consecutivo_serial']),'LR',0,'R',true);
	...
	$pdf->Cell($arrayCol[0]['tamano'] + $arrayCol[1]['tamano'] + $arrayCol[2]['tamano'] + $arrayCol[3]['tamano'] + $arrayCol[4]['tamano'] + $arrayCol[5]['tamano'] + $arrayCol[6]['tamano'] + $arrayCol[7]['tamano'] + $arrayCol[8]['tamano'] + $arrayCol[9]['tamano'],14,"",'T',0,'L',true);
	$pdf->SetFillColor(204,204,204,204);
	$pdf->Cell($arrayCol[10]['tamano'],14,"TOTALES: ",1,0,'R',true);

...
$objPHPExcel->getActiveSheet()->setCellValue("O".$contFila, "Fecha / Hora Impresora");
$objPHPExcel->getActiveSheet()->setCellValue("P".$contFila, "Consecutivo Fiscal / Serial Impresora");
$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, "Items");
$objPHPExcel->getActiveSheet()->setCellValue("R".$contFila, "Saldo Nota de Crédito");
$objPHPExcel->getActiveSheet()->setCellValue("S".$contFila, "Total Nota de Crédito");
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("O".$contFila, utf8_encode($row['fecha_hora']));
	$objPHPExcel->getActiveSheet()->setCellValue("P".$contFila, utf8_encode($row['consecutivo_serial']));
	$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, $row['cant_items']);
	$objPHPExcel->getActiveSheet()->setCellValue("R".$contFila, $row['saldoNotaCredito']);
	$objPHPExcel->getActiveSheet()->setCellValue("S".$contFila, $row['montoNetoNotaCredito']);
...
$objPHPExcel->getActiveSheet()->setCellValue("Q".$contFila, $arrayTotal[12]);
$objPHPExcel->getActiveSheet()->setCellValue("R".$contFila, $arrayTotal[13]);
$objPHPExcel->getActiveSheet()->setCellValue("S".$contFila, $arrayTotal[14]);

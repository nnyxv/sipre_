...
if(!(validaAcceso("cjrs_historico_nota_credito_list"))) {
...
include("controladores/ac_cjrs_historico_nota_credito_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Histórico de Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Histórico de Notas de Crédito</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
...
'||' + byId('lstAplicaLibro').value + '|' + lstEstadoNotaCredito.join());
</script>

...
if(!(validaAcceso("cjrs_facturas_por_pagar_list","insertar"))) {
...
include("controladores/ac_cjrs_facturas_por_pagar_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Pago de Facturas</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Pago de Factura</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
			...
			<form id="frmDcto" name="frmDcto" style="margin:0">
				...
				<tr>
                    ...
                    <fieldset><legend class="legend">Factura</legend>
                        ...
                        <tr align="left">
                            <td align="right" class="tituloCampo">Fecha Factura:</td>
            ...
            <form id="frmListaPagos" name="frmListaPagos" style="margin:0">
                <fieldset><legend class="legend">Desglose de Pagos</legend>
                    ...
                    <tr align="center" class="tituloColumna">
                        ...
                        <td width="40%">Nro. Tranferencia / Cheque / Anticipo / Nota Crédito</td>

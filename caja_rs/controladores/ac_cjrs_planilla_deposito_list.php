	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			if ($row['anulada'] == "NO") { // IMPRIMIR
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"verVentana('reportes/cjrs_impresion_planilla_deposito_pdf.php?valBusq=%s|%s', 1010, 500);\" src=\"../img/iconos/ico_print.png\" title=\"Imprimir\"/>",
					$row['id_empresa'],
					$row['idPlanilla']); 
			}
			$htmlTb .= "</td>";

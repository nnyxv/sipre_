...
function imprimirNotaDebito($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_nota_debito_cobrar_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));

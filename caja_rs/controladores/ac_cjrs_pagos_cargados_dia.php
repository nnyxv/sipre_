...
function cerrarCaja($frmCerrar){
	...
	$sqlSelectEncabezadoPagoFACT = sprintf("SELECT * FROM cj_cc_encabezado_pago_rs WHERE fecha_pago = %s",
		valTpDato($fechaApertura, "date"));
	...
	$sqlSelectEncabezadoPagoNC = sprintf("SELECT * FROM cj_cc_encabezado_pago_nc_rs WHERE fecha_pago = %s",
		valTpDato($fechaApertura, "date"));

...
function exportarNotaDebito($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjrs_nota_debito_historico_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirNotaDebito($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjrs_nota_debito_historico_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));

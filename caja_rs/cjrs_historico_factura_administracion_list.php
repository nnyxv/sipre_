...
if(!(validaAcceso("cjrs_historico_factura_administracion_list"))) {
...
include("controladores/ac_cjrs_historico_factura_administracion_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Histórico de Facturas de Administración</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Histórico de Facturas de Administración</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>

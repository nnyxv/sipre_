...
if(!(validaAcceso("cjrs_nota_cargo_por_pagar_list","insertar"))) {
...
include("controladores/ac_cjrs_nota_cargo_por_pagar_form.php");
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Pago de Nota de Débito</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
			...
			<form id="frmDcto" name="frmDcto" style="margin:0">
				...
				<tr>
                    ...
                    <fieldset><legend class="legend">Nota de Débito</legend>
                        ...
                        <tr id="trSaldoFinanciamiento" name="trSaldoFinanciamiento" align="right" class="trResaltarTotal3" style="display:none">
                            <td class="tituloCampo">Financiamiento Cuota:</td>
                            <td><input type="text" id="txtCuotaFinanciamientoTotal" name="txtCuotaFinanciamientoTotal" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
		...
		<tr id="trFormaDePago">
            ...
            <form id="frmListaPagos" name="frmListaPagos" style="margin:0">
                <fieldset><legend class="legend">Desglose de Pagos</legend>
                    ...
                    <tr id="trItmPiePagoFinanciamiento" class="trResaltarTotal3" style="display:none">
                    	<td align="right" class="tituloCampo" colspan="7"> Saldo Cuota Financiamiento:</td>
                        <td><input type="text" id="txtSaldoCuotaFinanciamiento" name="txtSaldoCuotaFinanciamiento" class="inputSinFondo" readonly="readonly" style="text-align:right" value="0.00"/></td>
                        <td></td>
                    </tr>

...
if(!(validaAcceso("cjrs_historico_anticipo_list"))) {
...
include("controladores/ac_cjrs_historico_anticipo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Histórico de Anticipos</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
				<td class="tituloPaginaCajaRS">Histórico de Anticipos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
...
xajax_listaAnticipo(0,'idAnticipo','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
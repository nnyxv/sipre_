...
if(!(validaAcceso("cjrs_devolucion_repuestos_form","insertar"))) {
...
require("controladores/ac_cjrs_devolucion_repuestos_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Nota de Crédito de Repuestos</title>
	...
	function validarFrmDcto() {
		if (validarCampo('txtNumeroControlNotaCredito','t','') == true) {
			if (byId('hddObj').value.length > 0) {
				...
				alert("El Documento No Tiene Articulos");
				return false;
			}
		} else {
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Nota de Crédito de Repuestos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
				...
				<tr>
					...
					<fieldset><legend class="legend">Datos de la Factura</legend>
						...
						<tr align="left">
							...
							<td>
								<input type="hidden" id="hddFechaPedido" name="hddFechaPedido" readonly="readonly" size="14"/>
								<input type="text" id="txtIdPedido" name="txtIdPedido" readonly="readonly" size="20" style="text-align:center"/>
							</td>
						</tr>
						<tr align="left">

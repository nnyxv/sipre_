...
if(!(validaAcceso("cjrs_nota_credito_list"))) {
...
include("controladores/ac_cjrs_nota_credito_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Notas de Crédito</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>

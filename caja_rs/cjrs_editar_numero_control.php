...
if(!(validaAcceso("cjrs_editar_numero_control"))) {
...
include("controladores/ac_cjrs_editar_numero_control.php");
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Edición del Número de Control</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>

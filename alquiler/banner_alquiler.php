...
<link rel="stylesheet" href="../js/styleDropdownMenuAlquiler.css" type="text/css" />
...
<tr>
	<td style="border-radius:6px;" background="../img/alquiler/header.gif">
<ul class="menu" id="menu">
	<li><a href="../index2.php" class="menulink"><table cellpadding="0" cellspacing="0" width="100%"><tr><td><img src="../img/alquiler/resultset_next.png"></td><td>&nbsp;</td><td width="100%"><?php echo utf8_encode("Menú ERP"); ?></td></tr></table></a></li>
<?php
...
while ($rowModulo = mysql_fetch_assoc($rsModulo)) {
	...
	while ($rowMenu2 = mysql_fetch_assoc($rsMenu2)) {
		...
		if ($totalRowsMenu3 > 0) {
			echo "<li><a href=\"#\" class=\"menulink\"><table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td><img src=\"../img/alquiler/resultset_next.png\"></td><td>&nbsp;</td><td width=\"100%\">".utf8_encode($rowMenu2['nombre'])."</td></tr></table></a>";
				echo "<ul>";

...
require("controladores/ac_al_cliente_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Clientes</title>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor) {
		...
		if (verTabla == "tblCliente") {
			...
			byId('txtFechaExpiracionLicencia').className = 'inputHabilitado';
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Clientes</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
                ...
                <tr>
                    ...
                    <a class="modalImg" id="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblCliente');">
						...
						<button type="button" onclick="xajax_exportarCliente(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
                </tr>
                </table>
	...
	<div id="tblCliente" style="max-height:500px; overflow:auto; width:960px;">
        ...
        <tr>
            <td>
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanUrbanizacion); ?>:</td>
                    <td><input type="text" id="txtUrbanizacion" name="txtUrbanizacion" size="26"/></td>
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanCalleAv); ?>:</td>
                    <td><input type="text" id="txtCalle" name="txtCalle" size="26"/></td>
                </tr>
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanCasaEdif); ?>:</td>
                    <td><input type="text" id="txtCasa" name="txtCasa" size="26"/></td>
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanMunicipio); ?>:</td>
                    <td><input type="text" id="txtMunicipio" name="txtMunicipio" size="26"/></td>
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanCiudad); ?>:</td>
                    <td><input type="text" name="txtCiudad" id="txtCiudad" size="26"/></td>
                </tr>
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span><?php echo utf8_encode($spanEstado); ?>:</td>
                    <td><input type="text" name="txtEstado" id="txtEstado" size="26"/></td>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<input type="text" id="txtLicencia" name="txtLicencia" autocomplete="off" size="26" />
                    </td>
                	<td align="right" class="tituloCampo">Fecha de Expiración Lic.:</td>
                    <td>
                    	<input type="text" id="txtFechaExpiracionLicencia" name="txtFechaExpiracionLicencia" autocomplete="off" size="10" style="text-align:center"/>
                    </td>
                	<td align="right" class="tituloCampo">Fecha de Nacimiento:</td>
                    <td>
                    	<input type="text" id="txtFechaNacimiento" name="txtFechaNacimiento" autocomplete="off" size="10" style="text-align:center" onblur="xajax_calcularEdad(this.value);"/> <span id="spanEdad"></span> 
                    </td>                    
                </tr>
                <tr align="left">
                    ...
                    <td>
                    <div style="float:left">
                        <input type="text" name="txtCorreo" id="txtCorreo" maxlength="50" size="26"/>
                    </div>
                    <div style="float:left">
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Datos del Contacto</legend>
                        ...
                        <tr align="left">
                            <td align="right" class="tituloCampo">Correo Electrónico:</td>
                            <td>
                            <div style="float:left">
                                <input type="text" id="txtCorreoContacto" name="txtCorreoContacto" size="26"/>
                            </div>
                            <div style="float:left">
                                <img src="../img/iconos/information.png" title="Formato Ej.: <?php echo $titleFormatoCorreo; ?>"/>
                            </div>
...
window.onload = function(){
	jQuery(function($){
		...
		$("#txtFechaExpiracionLicencia").maskInput("<?php echo spanDateMask; ?>",{placeholder:" "});
	...
	new JsDatePick({
		useMode:2,
		target:"txtFechaExpiracionLicencia",
		dateFormat:"<?php echo spanDatePick; ?>",
		cellColorScheme:"naranja"
	});
	...
	fecha1.setOnSelectedDelegate(function(){
		byId('txtFechaNacimiento').value = this.getSelectedDayFormatted();
		this.closeCalendar();
		xajax_calcularEdad(byId('txtFechaNacimiento').value);
	});
};

...
if((!validaAcceso("al_contrato_venta_list","insertar") && !$_GET['id'])
|| (!validaAcceso("al_contrato_venta_list","editar") && $_GET['id'] > 0)) {
...
require("../caja_vh/inc_caja.php");
require("controladores/ac_al_contrato_venta_form.php");
...
<head>
	...
	function validarFrmDcto() {
		...
		&& validarCampo('txtDiasContrato','t','cantidad') == true) {
			...
			msj = '¿Seguro desea Guardar el Contrato?';
			
			if(byId('hddAcc').value == "1"){//SI ESTA FINALIZANDO VALIDAR DATOS DE ENTRADA
				msj = '¿Seguro desea Cerrar el Contrato?';
				
				if (validarCampo('txtKilometrajeEntrada','t','') == true
					...
					&& validarCampo('lstEstadoAdicionalEntrada','t','lista') == true){
					//no hacer nada y continua a la confirmacion		
				}else{
					...
					validarCampo('lstEstadoAdicionalEntrada','t','lista');
    ...
    <div id="divInfo" class="print">
            ...
            <input type="hidden" id="hddIdDetPrecioEliminar" name="hddIdDetPrecioEliminar" readonly="readonly"/>
                ...
                <tr align="left">                    
                    <td width="60%">
						...
						<fieldset><legend class="legend">Cliente Contrato</legend>
                            <table border="0" width="100%">
                            <tr align="left">
                    ...
                    <td>
                        ...
                        <tr>
							<td width="40%"><br>
                            <fieldset><legend class="legend">Datos del Contrato</legend>
                                <table border="0" width="100%">
                                <tr align="left">
            ...
            <form id="frmTotalDcto" name="frmTotalDcto" style="margin:0">
                ...
                <tr>
                    ...
                    <td valign="top" width="50%">
                        ...
                        <tr align="right">
                        	<td class="tituloCampo">Anticipos:</td>
                            <td></td>
                            <td></td>
                            <td id="tdAnticipoMoneda"></td>
                            <td><input type="text" id="txtTotalAnticipo" name="txtTotalAnticipo" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        <tr align="right">
                        	<td class="tituloCampo">Resta por Pagar:</td>
                            <td></td>
                            <td></td>
                            <td id="tdRestaPagarMoneda"></td>
                            <td><input type="text" id="txtTotalRestaPagar" name="txtTotalRestaPagar" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        </table>
					</td>
				</tr>
        ...
        <tr>
        	<td align="right"><hr>
                ...
                <button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('al_contrato_venta_list.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
			</td>
        </tr>
        </table>
    </div>
...
byId('hddVehiculoYaCambiado').value = "";

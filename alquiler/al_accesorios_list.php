...
if(!(validaAcceso("al_accesorios_list"))) {
...
require("controladores/ac_al_accesorios_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Accesorios</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		<table border="0" width="100%">
			<tr>
				<td class="tituloPaginaAlquiler">Accesorios</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>

...
if(!(validaAcceso("al_factura_venta_historico_list"))) {
...
include("controladores/ac_al_factura_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Histórico de Facturas de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Hist&oacute;rico de Facturas de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,3);byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option  value="1">Contrato Activo</option>
                            <option value="2">Contrato Cerrado</option>
                            <option selected="selected" value="3">Facturado</option>
...
xajax_listaContratoVenta(0,'numeroFactura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusContrato').value);
</script>
...
if(!(validaAcceso("al_devolucion_vale_salida_historico_list"))) {
...
include("controladores/ac_al_devolucion_vale_salida_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :.  Alquiler -  Histórico de Vale de Entrada</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Hist&oacute;rico de Vale de Entrada</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,6);byId('btnBuscar').click();">
                            ...
                            <option value="5">Vale de Salidad</option>
							<option selected="selected" value="6">Vale de Entrada</option>                            
                        </select>
                    </td>
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_print.png"/></td><td>Vale Entrada PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
xajax_listaContratoVenta(0,'numero_vale_entrada','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusContrato').value);
</script>
...
if(!(validaAcceso("al_devolucion_venta_historico_list"))) {
...
include("controladores/ac_al_devolucion_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Histórico de Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Hist&oacute;rico de Notas de Cr&eacute;dito</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,4);byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option value="1">Contrato Activo</option>
                            <option value="2">Contrato Cerrado</option>
                            <option value="3">Facturado</option>
							<option selected="selected" value="4">Nota de Cr&eacute;dito</option>  
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_print.png"/></td><td>Nota de Cr&eacute;dito PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
        ...
        <tr>
        	<td align="right"><hr>
                ...
                <tr align="right" class="trResaltarTotal">
                    <td class="tituloCampo">Total Nota(s):</td>
...
xajax_listaContratoVenta(0,'numeracion_nota_credito','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusContrato').value);
</script>
...
if(!(validaAcceso("al_presupuesto_venta_list"))) {
...
require("controladores/ac_al_presupuesto_venta_list.php");
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Presupuestos de Alquiler</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('al_presupuesto_venta_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusPresupuesto" name="lstEstatusPresupuesto" onchange="selectedOption(this.id,0); byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option value="0" selected="selected">Presupuesto Sin Aprobar</option>
                        </select>
                    </td>
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/accept.png"/></td><td>Aprobar Presupuesto</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/cancel.png"/></td><td>Anular Presupuesto</td>
                            <td>&nbsp;</td>

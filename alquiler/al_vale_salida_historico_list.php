...
if(!(validaAcceso("al_vale_salida_historico_list"))) {
...
include("controladores/ac_al_vale_salida_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler -  Histórico de Vale de Salida</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Hist&oacute;rico de Vale de Salida</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,5);byId('btnBuscar').click();">
                            ...
                            <option selected="selected" value="5">Vale de Salida</option> 
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/ico_morado.gif"/></td><td>Vale de Salida</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_gris.gif"/></td><td>Vale de Entrada</td>
                        </tr>
                        </table>
                    </td>
				</tr>
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_print.png"/></td><td>Vale Salida PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
        ...
        <tr>
        	<td align="right"><hr>
                ...
                <tr align="right" class="trResaltarTotal">
                    <td class="tituloCampo">Total Vale(s):</td>
...
xajax_listaContratoVenta(0,'numero_vale_salida','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusContrato').value);
</script>
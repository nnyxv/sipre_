...
if(!(validaAcceso("al_contrato_venta_historico_list"))) {
...
include("controladores/ac_al_contrato_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Contrato de Alquiler</title>
    ...
    <script>
    	function cargarAtributo(){/*COLOCAR EL ATRIBUTO TITEL*/
			...
			var fechaHasta = document.getElementById('txtFechaHasta').value;
				if( fechaDesde != "" && fechaHasta != "" ){
					var titulo = "Informe Historico Contratos de Alquiler desde: "+fechaDesde+" Hasta: "+fechaHasta;
				} else {
					var titulo = "Informe de Historico Contratos de Alquiler";
				}
		...
		function abreExcel(){ //ABRE EL EXCEL
			var fechaDesde = document.getElementById("txtFechaDesde").value;
			var fechaHasta = document.getElementById('txtFechaHasta').value;
			var url = 'reportes/al_historico_contrato_alquiler_excel.php';
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Histórico Contratos de Alquiler</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
            	<table align="left" border="0">
                    <tr>
                        <td>
                        	<button type="button" id="btnExportarExcel" name="btnExportarExcel" onmouseover="cargarAtributo();" onclick="xajax_abrilExcel(xajax.getFormValues('frmBuscar'));">
                                <table cellspacing="0" cellpadding="0" align="center">
                                	<tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel_import.png"></td><td>&nbsp;</td><td>Exportar</td></tr>
                                </table>
                            </button>
                        </td>
                    </tr>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option value="1">Contrato Activo</option>
                            <option value="2">Contrato Cerrado</option>
                            <option value="3">Facturado</option>
							<option value="4">Nota de Cr&eacute;dito</option>
                            <option value="5">Vale de Salida</option> 
                            <option value="6">Vale de Entrada</option>                            
                        </select>
                    </td>
        ...
        <tr>
        	<td>
            <form id="frmlistaContratoVenta" name="frmlistaContratoVenta" style="margin:0">
            	<div id="divlistaContratoVenta" style="width:100%"></div>
            </form>
            </td>
        </tr>
        <tr>
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/ico_verde.gif"/></td><td>Contrato Activo</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_azul.gif"/></td><td>Contrato Cerrado</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_morado.gif"/></td><td>Facturado</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_gris.gif"/></td><td>Nota de Cr&eacute;dito</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_rojo.gif"/></td><td>Vale de Salida</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_amarillo.gif"/></td><td>Vade de Entrada</td>
                            <td>&nbsp;</td>
                        </tr>
                        </table>
                    </td>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Contrato PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
byId('lstEstatusContrato').className = "inputHabilitado";
...
xajax_listaContratoVenta(0,'numero_contrato_venta','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusContrato').value);
</script>
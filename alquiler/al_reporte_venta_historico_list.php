...
if(!(validaAcceso("al_reporte_venta_historico_list"))) {
...
include("controladores/ac_al_reporte_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Alquiler - Reporte de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Histórico de Reporte de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                    <td>
                        <button type="button" onclick="xajax_exportarFacturaVentaPdf(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                    	<button type="button" onclick="xajax_exportarFacturaVentaExcel(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
                </tr>
                </table>
				...
				<tr>
					...
					<td align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_print.png"/></td><td>Factura Venta PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
xajax_listaContratoVenta(0,'fecha_dcto, nro_control_dcto','ASC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+byId('txtFechaDesde').value+'|'+byId('txtFechaHasta').value+'||');
</script>
...
if(!(validaAcceso("al_contrato_venta_list"))) {
...
include("controladores/ac_al_contrato_venta_list.php");
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Contratos de Alquiler</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('al_contrato_venta_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,1); byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option selected="selected" value="1">Contrato Activo</option>
                        </select>
                    </td>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/pencil.png"/></td><td>Editar Contrato</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/accept.png"/></td><td>Cerrar Contrato</td>
                            <td>&nbsp;</td>

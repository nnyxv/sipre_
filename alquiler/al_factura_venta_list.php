...
if(!(validaAcceso("al_factura_venta_list"))) {
...
include("controladores/ac_al_factura_venta_list.php");
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaAlquiler">Contratos Cerrados</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusContrato" name="lstEstatusContrato" onchange="selectedOption(this.id,2);byId('btnBuscar').click();">
                        	<option value="-1">[ Seleccione ]</option>
                            <option selected="selected" value="2">Contrato Cerrado</option>                   
                        </select>
                    </td>

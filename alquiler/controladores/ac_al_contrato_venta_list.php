...
function listaContratoVenta($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL) {
	...
	$query = sprintf("SELECT 
		...
		DATEDIFF(DATE(contrato.fecha_entrada), CURDATE()) AS dias_entrega,
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaContratoVenta", "1%", $pageNum, "dias_entrega", $campOrd, $tpOrd, $valBusq, $maxRows, "D&iacute;as Entrega");
	...
	while ($row = mysql_fetch_assoc($rsLimit)) {
		...
		$htmlTb .= "<tr align=\"left\" class=\"".$clase."\" height=\"24\">";
			...
			$htmlTb .= "<td align=\"center\"".(($row['dias_entrega'] < 0) ? "class=\"divMsjError\"" : "class=\"\"").">";
				$htmlTb .= $row['dias_entrega'];
			$htmlTb .= "</td>";			
			...
			$htmlTb .= "<td>";
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"window.open('al_contrato_venta_form.php?id=%s','_self');\" src=\"../img/iconos/pencil.png\" title=\"Editar Contrato\"/>",
					$row['id_contrato_venta']);
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";
				$htmlTb .= sprintf("<img class=\"puntero\" onclick=\"window.open('al_contrato_venta_form.php?id=%s&acc=1','_self');\" src=\"../img/iconos/accept.png\" title=\"Cerrar Contrato\"/>",
					$row['id_contrato_venta']);
			$htmlTb .= "</td>";
			$htmlTb .= "<td>";

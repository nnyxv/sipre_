...
while ($rowModulo = mysql_fetch_assoc($rsModulo)) {
	...
	while ($rowMenu2 = mysql_fetch_assoc($rsMenu2)) {
		...
		if ($totalRowsMenu3 > 0) {
			echo "<li><a href=\"#\" class=\"menulink\"><table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td><img src=\"../img/contabilidad/resultset_next.png\"></td><td>&nbsp;</td><td width=\"100%\">".utf8_encode($rowMenu2['nombre'])."</td></tr></table></a>";
				echo "<ul>";

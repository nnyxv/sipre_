...
class PDF extends FPDF{
	...
	function Header(){//Cabecera de página
		global $balanceGananciaPerdidaTitulo;
		global $al;
		...
		$TituloReporte = $balanceGananciaPerdidaTitulo;
...
$pdf->nameExcel = "GanaciayPerdidasporNiveles";
...
//auditoria
auditoria('consulta','cuentageneral',$sCampos,'consulta estado de ganancias/perdidas, fecha desde: '.$cDesde1);
//fin auditoria

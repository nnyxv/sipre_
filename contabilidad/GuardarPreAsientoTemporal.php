...
$sTabla = "enc_dif";
	...
	$sCampos.=",CC";	
  	...
  	$sValores.=",''"; 
  	$sValores.=",''"; 
  	$sValores.=",'ASIENTO DE PRE CIERRE'";   	  	
  	$sValores.=",'P'";     	
  	$sValores.=",0";    
  	$sValores.=",'CON'";    
...
/* 	$SqlStr="update parametros set comp_cierr = '$iNroConseComprobant',fechacomp_cierr = '$sFecha'";
  	$exc = EjecutarExec($con,$SqlStr) or die($SqlStr); */
	MJ("Se ha Generado el Comprobante de Pre cierre en diferido con el Numero $iNroConseComprobant y Fecha $fecha se reiniciara el sistema");
?>

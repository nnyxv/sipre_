...
<!--*****************************************************************************************-->
	function Limpiar(){
		...
		document.frmDiarios.oVerStatus.value='Estatus (Inclusi'+u00f3+'n)';
	...
	/*function insertar(){
		if(document.frmDiarios.StatusOculto.value == "IN"){
			//alert("inertar!!!")
			document.getElementById('descta').style.display='block';
			document.getElementById('desmov').style.display='none';
			
			//document.frmDiarios.oDesMovimiento.value = document.frmDiarios.oDesCta.value;
			
		}else{
			//alert("modificar!!!")
			document.getElementById('desmov').style.display='block';
			document.getElementById('descta').style.display='none';	
		}
	}*/
...
<!--*****************************************************************************************-->
	...
	function Regresar(){
		document.frmDiarios.target = "mainFrame";	
		document.frmDiarios.action = "index_contabilidad.php";		
		document.frmDiarios.StatusOculto.value = 'BU';
		document.frmDiarios.submit(); 
	}
...
?>
         <div class"divMsjInfo" style="background-color: #E6FFE6;border: 1px solid #006600;color: #000000;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 10.5px;font-weight: bold;height:20px;padding-top:8px" align="center">
			Movimientos con mes menor o igual al de fecha de proceso <font color="#FF0000">(<?php echo obFecha($_SESSION["sFec_Proceso"],'D')."/".obFecha($_SESSION["sFec_Proceso"],'M')."/".obFecha($_SESSION["sFec_Proceso"],'A');; ?>)</font>
</div>
         Movimientos Diarios
<?php 
	} 

	if ($cad == 'P'){//posteriores
		$numeroMenu = 4;
   		$xDia =obFecha($_SESSION["sFec_Proceso"],'D');
		$xMes =obFecha($_SESSION["sFec_Proceso"],'M');
		$xAno =obFecha($_SESSION["sFec_Proceso"],'A');
...
?>	
		<div class"divMsjInfo" style="background-color: #E6FFE6;border: 1px solid #006600;color: #000000;font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 10.5px;font-weight: bold;height:20px;padding-top:8px" align="center">
			Movimientos con mes mayor al de la fecha de proceso <font color="#FF0000">(<?php echo obFecha($_SESSION["sFec_Proceso"],'D')."/".obFecha($_SESSION["sFec_Proceso"],'M')."/".obFecha($_SESSION["sFec_Proceso"],'A');; ?>)</font>
</div>
...
<form name="frmDiarios" action="frmDiarios.php" onsubmit="return false;" method="post">
...
<?php	//para el centro de costo
	...
	if($cad == 'H' || $cad == 'I'){//históricos/importados
...
?>	
                        ...
                        <td align="left">  
                            <input onFocus="SelTexto(this);" onKeyPress="fn(this.form,this,event,'xDFecha')" maxlength="8"  onDblClick="<?php print("AbrirBus(this.name,'$ArreCC')");?>" id="oCC"  name="oCC"  type="text" size="10" onBlur="<?php print("BuscarDescripGeneral(this.value,'$sClaveCon','$ArreCC')");?>"   class='cTexBoxdisabled' >
                            <button type="button" title="Listar" onclick="<?php print("AbrirBus(this.name,'$ArreCC')");?>"><img src="../img/iconos/help.png"/></button>
                        ...
                        <td align="left">
                            <input class="cTexBoxdisabled"  id="xDFecha" name="xDFecha" type="text"maxlength=2 onKeyPress="return CheckNumericJEnter(this.form,this,event,'oConcepto')" onFocus="SelTexto(this);" size="1" value="<?php  print($xDia); ?>">
                            <input class='cTexBoxdisabled'  name="xMFecha" type="text" maxlength=2 onKeyPress="return CheckNumericJEnter(this.form,this,event,'')" size="1" class="cNumdisabled" value="<?php  print($xMes); ?>">
                            <input class='cTexBoxdisabled'  name="xAFecha" type="text"maxlength=4 onKeyPress="return CheckNumericJEnter(this.form,this,event,'')" size="4" class="cNumdisabled" value="<?php  print($xAno); ?>">	
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left"  width="930" colspan="4"><input onFocus="this.form.oCodigoCuenta.focus();" readonly="false" style="color:#666666"  name="oDesCuenta" type="text"maxlength=80 size="130" class="cTexBox"  value="<?php print(trim($oCuenta));?>"> 
                        </td>
					</tr>
				</table>
                </fieldset>
...
<table width="100%"  align="center">
	<tr>
        ...
        <!--<td height="12" width="141" valign="top"  align="right"> <p>
	    	<input type="button" name="BtnRDebe" onClick="Reconvertir(document.frmDiarios.oDebe)" value="Reconvertir">
    	</td>
    	<td height="12" width="123" valign="top"  align="right"> <p>
    		<button type="button" name="BtnRHaber" onClick="Reconvertir(document.frmDiarios.oHaber)" value="Reconvertir">Reconvertir</button>
    	</td>-->
    ...
    <tr class="tituloColumna" align="center">
        ...
        <td width="550"> 
        	Descripci&oacute;n del Movimiento
        </td>
        <td width="145"> 
        	Debe
        </td>
...
//if($_SESSION["CCSistema"] != ""){
	...
	$Arretabla1[4][1]= 'O';
	$Arretabla1[5][0]= "oDesCta"; //Objeto del Campo2
	$Arretabla1[5][1]= 'O';
	$Arretabla1[6][0]= 'frmDiarios';// Pantalla donde estamos ubicados
	$Arretabla1[6][1]= 'P';
...
?>
		...
		<td height="12"  valign="top"> 
        	<input <?=$sDeshabilitar?> maxlength="80"   onMouseMove="BuscarCuentaTemp('');"  onFocus="BuscarCuentaTemp(this);"   onKeyPress="fnCuenta(this.form,this,event,'')"  onDblClick="<?php print("AbrirBus(this.name,'$Arre1')");?>"   name="oCodigoCuenta" class="cTexBox" type="text" size="18" onBlur="<?php print("BuscarDescrip(this.value,'$sClaveCon','$Arre')");?>;insertar()" ></td>
        <td height="12"  valign="top"> 
        ...
        <!--prueba////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
        <div id="descta" style="display:none"> 
			 <input <?=$sDeshabilitar?>  maxlength="250" class="cTexBox" onMouseMove="BuscarCuentaTemp('');" onFocus="BuscarCuentaTemp(this);" name="oDesCta" type="text" size="35"   o value="<?php print(trim($oCuenta));?>"> 
        </div>                  
            
        <div id="desmov" style="display:block"> 
            <input <?=$sDeshabilitar?> maxlength="250"   class="cTexBox" onMouseMove="BuscarCuentaTemp('');" onFocus="BuscarCuentaTemp(this);"  onKeyPress="fn(this.form,this,event,'')" name="oDesMovimiento"  onKeyPress="fn(this.form,this,'')"  type="text" size="35">
        </div>
        <!--fin prueba/////////////////////////////////////////////////////////////////////////////////////////////////////////-->
        ...
        <td height="12"  valign="top" align="right"> 
            <input <?=$sNumDeshabilitar?> maxlength="20"  onMouseMove="BuscarCuentaTemp('');" onKeyPress="return CheckNumericJEnter(this.form,this,event,'')"  onFocus="BuscarCuentaTemp(this);" name="oDebe" type="text" size="18" onBlur="validar(this)"></td>
        ...
        <td height="12"  valign="top">
        	<button <?=$sDeshabilitar?> type="button"  onMouseMove="BuscarCuentaTemp('');" onFocus="BuscarCuentaTemp(this);"  name="BrnAgregar"  class="inputBoton" onClick="jBuscarRenglones('');">...</button></td>
	</tr>
</table>
...
<table align="center" width="100%">
	<tr>
   		<td align="right"><hr/>
	<?php   if ($cad != 'H' && $cad != 'I'){  ?>
			<button name="BtnAtras" type="button" value="Regresar" onClick="Regresar()"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/return.png"/></td><td>&nbsp;</td><td>Atr&aacute;s</td></tr></table></button>
        	<button name="BtnGuardar" type="button" value="Guardar" onClick="Guardar();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_save.png"/></td><td>&nbsp;</td><td>Guardar</td></tr></table></button>
   		   	<button name="BtnImprimir" type="button" value="Imprimir" onClick="<?php print(" RepImprimir('$cad') ");?>"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/print.png"/></td><td>&nbsp;</td><td>Imprimir</td></tr></table></button>
		   	<button name="BtnBuscar" type="button" value="Buscar" onClick="<?php print("PantallaBuscar('oComprobante','$Arre2')");?>"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/find.png"/></td><td>&nbsp;</td><td>Buscar</td></tr></table></button>
           	<button name="BtnIncluir"  type="button" value="Incluir" onClick="Limpiar();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/add.png"/></td><td>&nbsp;</td><td>Incluir</td></tr></table></button>
		   
			<?php 
			//if(VerificarAcceso($numeroMenu, 'D') == false){  
    	    	  echo "<button name='BtnEliminar' type='button' value='Eliminar' onClick='Eliminar();'><table align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td><td><img src='../img/iconos/delete.png'/></td><td>&nbsp;</td><td>Eliminar</td></tr></table></button>";
			//}?> 	   
	<?php   }else{  ?>
    		<button name="BtnAtras" type="button" value="Regresar" onClick="Regresar2();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/return.png"/></td><td>&nbsp;</td><td>Atr&aacute;s</td></tr></table></button>
		   	<button name="BtnBuscar" type="button" value="Buscar" onClick="<?php print("PantallaBuscar('oComprobante','$Arre2')");?>"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/find.png"/></td><td>&nbsp;</td><td>Buscar</td></tr></table></button>
  	       <button name="BtnImprimir" type="button" value="Imprimir" onClick="<?php print("RepImprimir('$cad')");?>"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/print.png"/></td><td>&nbsp;</td><td>Imprimir</td></tr></table></button>
	<?php   } ?>
	<?php 	if ($cad == 'I'){  ?>		   
	    	<button name="GenerarComprobante" type="button" value="Generar Comprobante Contable" onClick="<?php print("GenerarCom()");?>"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_generar.png"/></td><td>&nbsp;</td><td>Generar Comprobante Contable</td></tr></table></button>
			<?php } ?>  
		</td>
	</tr>
</table>

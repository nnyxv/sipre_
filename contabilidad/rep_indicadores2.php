...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="width: 820px; margin-bottom: 10px; margin-top:0px" >
        ...
        <table border="1" style='width:300%'>
				   ...
				   $condicionBoG = " and codigo >=4 and length(ltrim(rtrim(codigo))) <=9 or codigo='4.1.01.01.003'";
				   $condicionBoG.= " or codigo='4.1.02.01.002' or codigo='4.1.02.01.003' or codigo='4.1.02.02.002'";
				   $condicionBoG.= " or codigo='4.1.02.03.001' or codigo='4.1.02.03.002' or codigo='4.1.02.02.003'";
								...
								<td>
									<table border='0' width="100%">
										...
										<?php if($ubicacionU == "TITU"){?>
											...
											<td style='width:25%' align="right">
												 <strong><?=number_format($ventas2U,2)?></strong>
											</td>
										<?php }else{ ?>	
						...
						<!---MES ACTUAL----->			
								<td>
									...
									<?php if($ubicacionU == "TITU"){?>
											...
											<td style='width:25%' align="right">
												 <strong><?=number_format($ventas4U,2)?></strong>
											</td>
									<?php }else{ ?>	
											<td style='width:25%' align="right"></td>
											<td style='width:25%' align="right"></td>
								...
								<td>
									<table border='0' width="100%">
										...
										<?php if($ubicacionU == "TITU"){?>
											...
											<td style='width:25%' align="right">
											     <strong><?=number_format($ventas6U,2)?></strong>
											</td>
										<?php }else{ ?>	
											<td style='width:25%' align="right"></td>
											<td style='width:25%' align="right"></td>
                        ...
                        <td>
                            <table border='0' width="100%">
								...
								<?php }elseif($ubicacion == "TITU"){ ?>	
									...
									<td style='width:25%' align="right">
                                         <strong><?=number_format($ventas2,2)?></strong>
                                    </td>
								<?php }else{ ?>	
							        <td style='width:25%' align="right"></td>
									<td style='width:25%' align="right"></td>
					...
					<?php if($ubicacion == "DETA"){?>
                        ...
                        <td style='width:2%' align="right">
							...
							<?php }elseif($ubicacion == "TITU"){ ?>	
								<td style='width:5%' align="right">
												<?php if($dif1 < 0){ ?>
												<strong><font color="red"><?= number_format(abs($dif1),2)?></font></strong>
												<?php }else{ ?>
													<strong><?= number_format($dif1,2)?></strong>
												<?php } ?>	
								</td>	
								<td style='width:2%' align="right">
									<?php if($dif1 < 0){ ?>
				...
				<!---MES ACTUAL----->			
					    <td>
							...
							<?php }elseif($ubicacion == "TITU"){ ?>			
									...
									<td style='width:25%' align="right">
                                        <strong><?=number_format($ventas4,2)?></strong>
                                    </td>
							<?php }else{ ?>	
                                    <td style='width:25%' align="right">
                                    </td>
						...
						<?php }elseif($ubicacion == "TITU"){ ?>
						 <td style='width:5%' align="right" >
						     <?php if($dif2 < 0){ ?>
                              <strong><font color="red"> <?= number_format($dif2,2)?></font></strong>
							 <?php }else{ ?>
                              <strong><?=number_format($dif2,2)?></strong>
							<?php } ?>							 
                        </td>
                        <td style='width:2%' align="right">
							<?php if($dif2 < 0){ ?>
						...
						<td>
                            <table border='0' width="100%">
								...
								<?php }elseif($ubicacion == "TITU"){ ?>
									...
									<td style='width:25%' align="right">
                                         <strong><?=number_format($ventas6,2)?></strong>
                                    </td>
								<?php }else{ ?>	
							        <td style='width:25%' align="right"></td>
                                    <td style='width:25%' align="right"></td>
					...
					<?php }elseif($ubicacion == "TITU"){ ?>	
							<td style='width:5%' align="right" >
						     <?php if($dif3 < 0){ ?>
                              <strong><font color="red"> <?= number_format($dif3,2)?></font></strong>
							 <?php }else{ ?>
                              <strong><?=number_format($dif3,2)?></strong>
							<?php } ?>							 
                        </td>
                        <td style='width:2%' align="right">
							<?php if($dif3 < 0){ ?>

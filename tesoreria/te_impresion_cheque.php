<?php
    ...
    include("controladores/ac_te_impresion_cheque.php");
...
<title>Impresion de Cheques</title>
...
{
	if(confirm("El cheque se imprimio correctamente?"))
	{
...
<table width="70%" border="0" cellpadding="0" cellspacing="0" style="margin:auto; ">  
  ...
  <tr>
    <td colspan="2"><iframe src="<?php echo sprintf("reportes/te_imprimir_cheque_pdf.php?id=%s", $_GET['id']);?>" width="100%" height="800" ></iframe></td>
  </tr>
</table>
</body>
</html>

...
require("controladores/ac_te_propuesta_pago.php");
...
<script>	
	...
	function validarChequeraSeleccionada(idFactura, tipo){
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr class="solo_print">
			...
			<tr>
				<td class="tituloPaginaTesoreria" colspan="2">Propuesta de Pago</td>
			</tr>
			<tr class="noprint">
				<td align="right">
            ...
            <tr class="noprint" id="trBotones">
                <td align="right">
                    ...
                    <button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('te_propuesta_pago_mantenimiento.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_error.gif"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
                </td>
            </tr>
		</table>
    </div>

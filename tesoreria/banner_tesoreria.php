...
<link rel="stylesheet" href="../js/styleDropdownMenuTesoreria.css" type="text/css" />

<script type="text/javascript" language="JavaScript" src="../js/dropdownMenu/scriptDropdownMenu.js"></script>
<!-- <script type="text/javascript" language="javascript" src="../js/scriptRafk.js"></script>-->
<div class = "noprint" style="font-size: 11px;"><!-- Corrige el tamaño de las letras para que no hereden de body -->
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr height="6">
	<td></td>
</tr>
<tr>
	<td style="white-space:nowrap;"><?php $raiz = "../"; include("../banner_sesion.php"); ?></td>
</tr>
<tr height="6">
	<td></td>
</tr>
<tr>
	<td style="border-radius:6px;" background="../img/tesoreria/header.gif">
<ul class="menu" id="menu">
	<li><a href="../index2.php" class="menulink"><table cellpadding="0" cellspacing="0" width="100%"><tr><td><img src="../img/tesoreria/resultset_next.png"></td><td>&nbsp;</td><td width="100%"><?php echo ("Menú ERP"); ?></td></tr></table></a></li>
<?php
...
while ($rowModulo = mysql_fetch_assoc($rsModulo)) {
	...
	if (!$rsMenu2) return $objResponse->alert(mysql_error()."\n\nLine: ".__LINE__);
	...
	while ($rowMenu2 = mysql_fetch_assoc($rsMenu2)) {
		...
		if (!$rsMenu3) return $objResponse->alert(mysql_error()."\n\nLine: ".__LINE__);
		$totalRowsMenu3 = mysql_num_rows($rsMenu3);
		if ($totalRowsMenu3 > 0) {
			echo "<li><a href=\"#\" class=\"menulink\"><table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td><img src=\"../img/tesoreria/resultset_next.png\"></td><td>&nbsp;</td><td width=\"100%\">".utf8_encode($rowMenu2['nombre'])."</td></tr></table></a>";
				echo "<ul>";
...
function menuRecursivo($idUsuario, $idEmpresa, $idPadre, $nombrePadre, $linkPadre) {
	...
	if (!$rsMenu) return $objResponse->alert(mysql_error()."\n\nLine: ".__LINE__);
	...
	if ($totalRowsMenu > 0) {
		...
		while ($rowMenu = mysql_fetch_assoc($rsMenu)) {
			...
			if (!$rsMenuVerifica) return $objResponse->alert(mysql_error()."\n\nLine: ".__LINE__);

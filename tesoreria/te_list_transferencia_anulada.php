...
require("controladores/ac_te_list_transferencia_anulada.php");
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
    	<table border="0" width="100%">
            <tr>
                <td class="tituloPaginaTesoreria" colspan="2" id="tdReferenciaPagina">Transferencias Anuladas</td>
            </tr>
            <tr>
                <td align="right">
				...
				<tr align="left">                            
                        <td align="right" class="tituloCampo" >Fecha Transferencia:</td>
                    <td align="left">
...
xajax_listadoTransferenciaAnulada(0,'fecha_registro','DESC','-1|0||');

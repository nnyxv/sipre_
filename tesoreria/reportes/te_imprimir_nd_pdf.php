...
$idDocumento = $_GET["id"];
    ...
    $query = sprintf("SELECT 
                      ...
                      WHERE
                        te_nota_debito.id_nota_debito ='%s'",
...
imagestring($img,1,395,20,"NOTA DEBITO",$textColor);
imagestring($img,1,395,30,"# ".$row['id_nota_debito'],$textColor);
...
imagestring($img,1,10,55,"No. NOTA DEBITO:   ".$row['numero_nota_debito'],$textColor);
...
imagestring($img,1,0,390,"-------------------------------------------------------------------------------------------------------------------",$textColor);
    ...
    imagestring($img,1,455,400,strtoupper(str_pad(number_format($row['monto_nota_debito'], 2, ".", ","), 15, " ", STR_PAD_LEFT)),$textColor); // <----
...
$arrayImg[] = "tmp/nota_debito".$pageNum.".png";

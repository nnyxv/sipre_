...
$styleArrayTitulo = array(
    'font' => array(
        'bold' => true,
		'color' => array(
			'argb' => 'FF9B0000' // Mismo que trResaltar5:hover
		),
		'size' => 12,
    ),
    'alignment' => array(
...
$styleArrayCampo = array(
    ...
    'borders' => array(
        'outline' => array(
			...
			'color' => array(
				'argb' => 'FFFF9797' // Mismo que trResaltar5:hover PERO MAS CLARO
			),
        ),
    ),
    'fill' => array(
...
$styleArrayFila1 = array(
    ...
    'fill' => array(
        ...
        'rotation' => 90,
        'startcolor' => array(
            'argb' => 'FFFFF4F4', // Mismo que trResaltar5
        ),
        'endcolor' => array(
            'argb' => 'FFFFF4F4', // Mismo que trResaltar5
        ),
...
function cabeceraExcel($objPHPExcel, $idEmpresa, $colHasta, $verDatosEmpresa = true, $cantFilasInsert = 8) {
	...
	if ($totalRowsEmp > 0 && $verDatosEmpresa == true) {
		...
		$objPHPExcel->getActiveSheet()->setCellValueExplicit($colHasta3."1", "Generado".((strlen($_SESSION['nombreEmpleadoSysGts']) > 0) ? " por: ".$_SESSION['nombreEmpleadoSysGts']." el " : ": ").date(spanDateFormat." h:i a"), PHPExcel_Cell_DataType::TYPE_STRING);

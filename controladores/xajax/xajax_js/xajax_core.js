...
xajax.config.setDefault('defaultResponseDelayTime',10000);
xajax.config.setDefault('defaultExpirationTime',1000000000000); // POR DEFECTO 10000
xajax.config.setDefault('defaultMethod','POST');
xajax.config.setDefault('defaultRetry',20); // POR DEFECTO 5
xajax.config.setDefault('defaultReturnValue',false);
xajax.config.setDefault('maxObjectDepth',2000000000); // POR DEFECTO 20
xajax.config.setDefault('maxObjectSize',200000000000); // POR DEFECTO 2000
xajax.config.setDefault('responseQueueSize',100000000000); // POR DEFECTO 1000

xajax.config.status={
	update:function(){
		return{
			onRequest:function(){window.status='Sending Request...'; },
...
xajax.config.cursor={
	update:function(){
		return{
			onWaiting:function(){if(xajax.config.baseDocument.body)

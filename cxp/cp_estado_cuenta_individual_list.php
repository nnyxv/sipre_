...
if(!(validaAcceso("cp_estado_cuenta_individual_list"))) {
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaCuentasPorPagar">Estado Cuenta Individual</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
                    ...
                    <td>
                        <button type="button" onclick="
                            if (validarCampo('txtIdProv','t','') == true) {
                                xajax_exportarcuentaindividual(xajax.getFormValues('frmBuscar'));
                            } else {
                                alert('Los campos señalados en rojo son requeridos');
                                return false;
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <select multiple id="lstEstadoFactura" name="lstEstadoFactura" onchange="byId('btnBuscar').click();" style="width:99%">
                                    ...
                                    <option selected="selected" value="2">Cancelado Parcial / Asignado Parcial</option>
                    ...
                    <fieldset><legend class="legend">Tipo de Estado de Cuenta</legend>
                        ...
                        <tr align="left">
                            ...
                            <td width="75%">
                                ...
                                <br>
                                <label><input type="radio" id="radioOpcion3" name="radioOpcion" value="3"/> Resumido</label>
							</td>
                        </tr>
                        <tr align="left">

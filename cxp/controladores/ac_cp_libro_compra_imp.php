					...
					if ($rowDocumento['id_factura'] > 0 || $rowDocumento['id_notacredito'] > 0 || $rowDocumento['id_notacargo'] > 0) {
						...
						$htmlTb .= "<tr align=\"right\" class=\"".$clase."\" height=\"24\">";
							...
							$htmlTb .= "<td nowrap=\"nowrap\" title=\"".
								...
								$objDcto->tipoMovimiento = (in_array($rowEstadoCuenta['tipoDocumento'],array("FA","ND","AN","CH","TB"))) ? 1 : 4;
							...
							$htmlTb .= "<td nowrap=\"nowrap\" title=\"".
								...
								$objDcto = new Documento;
								$objDcto->raizDir = $raiz;
								$objDcto->tipoMovimiento = (in_array($tipoDocumentoAfectado,array("FA","ND","AN","CH","TB"))) ? 1 : 4;
...
function volver(){
	...
	$objResponse -> script(sprintf("window.open('cp_libro_compra_inicio.php','_self');"));

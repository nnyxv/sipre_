...
if(!(validaAcceso("cp_pago_factura_list"))) {
...
include("controladores/ac_cp_pago_factura_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Pago de Factura</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Pago de Factura</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/money_add.png"/></td><td>Desglose de Pagos</td>
                            <td>&nbsp;</td>

...
if(!(validaAcceso("cp_factura_captura_list"))) {
...
include("controladores/ac_cp_factura_captura_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Facturas de Proveedores</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Facturas de Proveedores</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="window.open('cp_factura_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
					...
					<td>
						<button type="submit" id="btnBuscar" onclick="xajax_buscarFactura(xajax.getFormValues('frmBuscar'));">Buscar</button>
        ...
        <tr>
        	<td><div id="divListaRegistroCompra" style="width:100%"></div></td>
        </tr>
        <tr>
        	<td>
...
xajax_listaRegistroCompra(0,'id_factura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value + '|' + byId('lstAplicaLibro').value + '|' + lstEstadoFactura.join());
</script>
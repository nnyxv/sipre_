...
if(!(validaAcceso("cp_nota_credito_captura_list"))) {
...
include("controladores/ac_cp_nota_credito_captura_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Nota de Crédito de Proveedores</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Nota de Crédito de Proveedores</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    <td>
                    	<button type="button" onclick="window.open('cp_nota_credito_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button><!--formnovalidate="formnovalidate"-->
                        <button type="button" onclick="window.open('cp_nota_credito_form.php?hddTipo=1','_self');" disabled="disabled"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/book_previous.png"/></td><td>&nbsp;</td><td>Nuevo desde Factura Compra</td></tr></table></button>

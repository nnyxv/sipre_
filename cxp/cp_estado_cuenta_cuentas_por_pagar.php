...
if(!(validaAcceso("cp_estado_cuenta_cuentas_por_pagar"))) {
...
include("controladores/ac_cp_estado_cuenta_cuentas_por_pagar.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - E.C. Cuentas Por Pagar</title>
	...
	function validarFrmBuscar(){
		...
		if (byId('radioOpcion1').checked == true || byId('radioOpcion3').checked == true) {
			if (!(validarCampo('txtIdProv','t','') == true)) {
				validarCampo('txtIdProv','t','');
				
				error = true;
			}
		} else if (byId('radioOpcion2').checked == true || byId('radioOpcion4').checked == true) {
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorPagar">E.C. Cuentas Por Pagar</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
					...
					<td>
						...
						if (byId('radioOpcion1').checked == true) {
							...
							if (validarCampo('txtFecha','t','') == true) {
								byId('txtIdProv').className = 'inputInicial';
								byId('txtIdProv').value = '';
								byId('txtNombreProveedor').value = '';
								byId('txtCedulaRifProveedor').value = '';
								byId('txtNITProveedor').value = '';
								byId('txtTelefonoProveedor').value = '';
								//byId('txtDireccionProveedor').value = '';
                ...
                <tr>
                    ...
                    <fieldset><legend class="legend">Tipo de Estado de Cuenta</legend>
                        ...
                        <tr align="left">
                            ...
                            <td width="75%"><input type="text" name="txtFecha" id="txtFecha" readonly="readonly" size="10" style="text-align:center"/></td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Ver Estado de Cuenta:</td>
                            <td>
                                <label><input type="radio" id="radioOpcion1" name="radioOpcion" checked="checked" value="1"/>Facturas (Individual)</label>
                                <br>
                                <label><input type="radio" id="radioOpcion2" name="radioOpcion" value="2"/>Facturas (General)</label>
                                <br>
                                <label><input type="radio" id="radioOpcion3" name="radioOpcion" value="3"/>Notas de Débito (Individual)</label>
                                <br>
                                <label><input type="radio" id="radioOpcion4" name="radioOpcion" value="4"/>Notas de Débito (General)</label>
                            </td>
                        </tr>
                        <tr align="left">
                            <td align="right" class="tituloCampo">Módulo:</td>
                            <td id="tdModulos" colspan="2" valign="top"></td>
                        </tr>
                        </table>
                    </fieldset>
                    </td>
			...
			<td>
				...
				<tr>
					...
					<td align="center">
						<table>
						<tr>
							<td><img src="../img/iconos/ico_plan_mayor.png"/></td><td>Plan Mayor</td>
							<td>&nbsp;</td>

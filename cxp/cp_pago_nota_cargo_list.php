...
if(!(validaAcceso("cp_pago_nota_cargo_list"))) {
...
include("controladores/ac_cp_pago_nota_cargo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Pago de Nota de Débito</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Pago de Nota de Débito</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

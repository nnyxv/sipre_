...
include("controladores/ac_cp_notacredito_factura.php");
...
<div id="divGeneralVehiculos">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
	        <td align="left"><input type="button" id="btnFacturas" name="btnFacturas" onclick="xajax_listadoFacturas(0,'','','' + '|' + -1);" value="Buscar Facturas"/></td>
        </tr>
        <tr>
        	<td align="left">
        ...
        <tr>
            <td>
              <form id="frmDatosFactura" name="frmDatosFactura">
                ...
                <tr>
                    <td align="right" class="tituloCampo" width="15%"><span class="textoRojoNegrita">*</span>Nº de la Factura:</td>
                ...
                <tr>
	                ...
	                <td colspan="3" rowspan="2" align="left"><label> <textarea name="txtObservacionFactura" id="txtObservacionFactura" readonly="readonly" cols="59" rows="2"></textarea> </label></td>
    	...
    	<td id="tdListado">
            ...
            <table width="50%">
                <tr>
					...
					<td align="left">
                    	<input type="text" name="txtBusq" id="txtBusq"/><input type="button" name="btnBuscarFacturas" id="btnBuscarFacturas" value="Buscar" onclick="xajax_buscarFactura(xajax.getFormValues('frmBuscarFactura'));"/>
                    </td>
				</tr>
				<tr>
					<td></td>

...
if(!(validaAcceso("cp_estado_cuenta_factura_cancelada_list"))) {
...
include("controladores/ac_cp_estado_cuenta_factura_cancelada_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - E.C. Facturas Canceladas</title>
	...
	function validarFrmBuscar(){
		...
		if (byId('radio1').checked == true) {
			if (!(validarCampo('txtIdProv','t','') == true)) {
				validarCampo('txtIdProv','t','');
				
				error = true;
			}
		} else if (byId('radio2').checked == true) {
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
			<td class="tituloPaginaCuentasPorPagar">E.C. Facturas Canceladas</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr>
					...
					<fieldset><legend class="legend">Tipo de Estado de Cuenta</legend>
                        <table border="0" width="100%">
                        <tr align="left">
                            <td align="right" class="tituloCampo" width="25%">Ver Estado de Cuenta:</td>
                            <td width="75%">
                            	<label><input type="radio" id="radio1" name="radio" checked="checked" value="1"/> Individual</label>
                                <br>
                                <label><input type="radio" id="radio2" name="radio" value="2"/> General</label>
							</td>
                        </tr>
                        <tr>
                        	<td></td>
                        	<td>
                                <label><input type="radio" id="radioOpcion1" name="radioOpcion" checked="checked" value="1"/> Todos los documentos</label>
                                <br>
                                <label><input type="radio" id="radioOpcion2" name="radioOpcion" value="2"/> Por tipo de documento</label>
                            </td>
                        </tr>
                        <tr align="left">

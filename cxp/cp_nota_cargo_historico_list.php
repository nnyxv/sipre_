...
if(!(validaAcceso("cp_nota_cargo_historico_list"))) {
...
include("controladores/ac_cp_nota_cargo_historico_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Histórico de Notas de Débito</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Histórico de Notas de Débito</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

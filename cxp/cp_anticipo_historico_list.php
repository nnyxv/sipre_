...
if(!(validaAcceso("cp_anticipo_historico_list"))) {
...
include("controladores/ac_cp_anticipo_historico_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Histórico de Anticipos</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Histórico de Anticipos</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

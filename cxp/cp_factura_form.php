...
if (!(isset($_GET['id']))) {
	if(!(validaAcceso("cp_factura_captura_list","insertar")) && !(validaAcceso("cp_factura_captura_list","editar"))) {
...
include("controladores/ac_cp_factura_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Pagar - Factura</title>
	...
	function validarFrmDcto() {
		...
		if (!(byId('txtIdFactura').value > 0)) {
			if (!(validarCampo('txtTotalExento','t','numPositivo') == true
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCuentasPorPagar">Factura</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Proveedor</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td width="16%"><input type="hidden" id="hddIdMoneda" name="hddIdMoneda"/></td>
                                    <td align="right" width="12%"></td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button" id="btnRegistroCompraPDF"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>Registro Compra PDF</td></tr></table></button>
                                    </td>
                                </tr>
                                </table>
                            </td>
                            ...
                            <fieldset><legend class="legend">Datos de la Factura</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td>
                                    	<input type="text" id="txtNumeroFactura" name="txtNumeroFactura" size="20" style="text-align:center"/>
                                ...
                                <tr align="left">
                                    <td id="tdtxtActiva" colspan="2"><input type="text" id="txtActiva" name="txtActiva" class="inputSinFondo" readonly="readonly" size="20" style="text-align:center"/></td>
                                </tr>
                                </table>
                            </fieldset>
							</td>
        ...
        <tr id="trListaPagoDcto">
            ...
            <form id="frmListaPagoDcto" name="frmListaPagoDcto" style="margin:0">
                ...
                <tr id="trBtnListaPagoDcto">
                    <td align="left">
                        <a class="modalImg" id="aAgregarArticulo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblMetodoPago');">
                        ...
                        <button type="button" id="btnQuitarArticulo" name="btnQuitarArticulo" onclick="xajax_eliminarMetodoPago(xajax.getFormValues('frmListaPagoDcto'));" title="Eliminar Artículo"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/delete.png"/></td><td>&nbsp;</td><td>Quitar</td></tr></table></button>
                    </td>
                </tr>
                </table>
            ...
            <form id="frmTotalDcto" name="frmTotalDcto" style="margin:0">
                ...
                <tr>
                    ...
                    <fieldset id="fieldsetDatosImportación"><legend class="legend">Datos de Importación</legend>
                    	<table border="0" width="100%">
                        <tr align="right">
                        	<td class="tituloCampo">Gastos:
                            	<br>
                        		<span class="textoNegrita_10px">(No afecta cuenta por pagar)</span></td>
                            <td><input type="text" id="txtTotalGastosNoAfecta" name="txtTotalGastosNoAfecta" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        <tr align="right">
                        	<td class="tituloCampo">Gastos por Importación:</td>
                            <td><input type="text" id="txtTotalGastosImportacion" name="txtTotalGastosImportacion" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        <tr align="right">
                        	<td class="tituloCampo">Impuestos:</td>
                            <td><input type="text" id="txtTotalImpuesto" name="txtTotalImpuesto" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        <tr align="right">
                    ...
                    <fieldset id="fieldsetPlanMayor"><legend class="legend">Factura por Plan Mayor</legend>
                    	<table border="0" width="100%">
                        <tr align="left">
                        	...
                        	<td>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                    <a id="aVerNotaCargo" target="_self"><img src="../img/iconos/ico_view.png" title="Ver Nota de Débito"/></a>
                                    </td>
                                </tr>
                                </table>
							</td>
                        	<td align="right" class="tituloCampo">Fecha Registro:</td>
                            <td><input type="text" id="txtFechaRegistroNotaCargo" name="txtFechaRegistroNotaCargo" readonly="readonly" size="10" style="text-align:center"/></td>
                        </tr>
                        <tr align="left">
                        	<td align="right" class="tituloCampo">Nro. Control:</td>
                        	<td><input type="text" id="txtNumeroControlNotaCargo" name="txtNumeroControlNotaCargo" readonly="readonly" size="20" style="text-align:center"/></td>
                        </tr>
                        <tr align="left">
                        	<td align="right" class="tituloCampo">Fecha:</td>
                        	<td><input type="text" id="txtFechaNotaCargo" name="txtFechaNotaCargo" readonly="readonly" size="10" style="text-align:center"/></td>
                        </tr>
                        <tr align="left">
                        ...
                        <tr>
                            <td id="tdtxtEstatusNotaCargo" colspan="4"><input type="text" id="txtEstatusNotaCargo" name="txtEstatusNotaCargo" class="inputSinFondo" readonly="readonly" size="20" style="text-align:center"/></td>
                        </tr>
                        <tr align="left">
        ...
        <tr>
        	...
        	<script type="text/javascript">
				...
				<script type="text/javascript">
					...
					$query = "SELECT * FROM cp_factura  WHERE id_factura = $v1 ";

					$rs = mysql_query($query);
					$reg=mysql_fetch_array($rs);
					echo "consulta";
					echo $reg['fecha_origen'];
					$fechaRegistro = $reg['fecha_origen'];
    ...
    <tr>
        ...
        <fieldset id="fieldsetTransferencia"><legend class="legend">Transferencia</legend>
            ...
            <tr align="left">
            	...
            	<td><input type="text" id="txtMontoTransferencia" name="txtMontoTransferencia" maxlength="16" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event)" size="16" style="text-align:right"/></td>
            </tr>
            </table>
        </fieldset>
        <fieldset id="fieldsetCheque"><legend class="legend">Cheque</legend>
            ...
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Monto a Cancelar:</td>
            	<td><input type="text" id="txtMontoCheque" name="txtMontoCheque" maxlength="16" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event)" size="16" style="text-align:right"/></td>
            </tr>
            </table>
        </fieldset>
        <fieldset id="fieldsetAnticipo"><legend class="legend">Anticipo</legend>
            ...
            <tr align="left">
            	...
            	<td width="30%"><input type="text" id="txtTotalAnticipo" name="txtTotalAnticipo" maxlength="16" readonly="readonly" size="16" style="text-align:right"/></td>
            	<td align="right" class="tituloCampo" width="20%"><span class="textoRojoNegrita">*</span>Saldo:</td>
            	<td width="30%"><input type="text" id="txtSaldoAnticipo" name="txtSaldoAnticipo" maxlength="16" readonly="readonly" size="16" style="text-align:right"/></td>
            </tr>
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Monto a Cancelar:</td>
            	<td><input type="text" id="txtMontoAnticipo" name="txtMontoAnticipo" maxlength="16" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event)" size="16" style="text-align:right"/></td>
            </tr>
            </table>
        </fieldset>
        <fieldset id="fieldsetNotaCredito"><legend class="legend">Nota de Crédito</legend>
            ...
            <tr align="left">
            	<td align="right" class="tituloCampo" width="20%">Total:</td>
            	<td width="30%"><input type="text" id="txtTotalNotaCredito" name="txtTotalNotaCredito" maxlength="16" readonly="readonly" size="16" style="text-align:right"/></td>
            	<td align="right" class="tituloCampo" width="20%"><span class="textoRojoNegrita">*</span>Saldo:</td>
            	<td width="30%"><input type="text" id="txtSaldoNotaCredito" name="txtSaldoNotaCredito" maxlength="16" readonly="readonly" size="16" style="text-align:right"/></td>
            </tr>
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Monto a Cancelar:</td>
            	<td><input type="text" id="txtMontoNotaCredito" name="txtMontoNotaCredito" maxlength="16" onblur="setFormatoRafk(this,2);" onkeypress="return validarSoloNumerosReales(event)" size="16" style="text-align:right"/></td>
            </tr>
            </table>
        </fieldset>
        </td>
...
xajax_formFactura('<?php echo $_GET['id']; ?>', xajax.getFormValues('frmListaPagoDcto'));

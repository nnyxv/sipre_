...
<div id="divGeneralPorcentaje">
	<form id="frmCerrar" name="frmCerrar" method="post">
        ...
        while ($rowFormaPago = mysql_fetch_array($rsFormaPago)) {
            ...
            if ($sw != $idFormaPago) {
                ...
                WHERE cxc_pago.fechaPago = '".$fechaApertura."'
                    ...
                    AND cxc_pago.idCierre = ".valTpDato($_GET['idCierre'], "int")."
                ...
                WHERE cxc_ch.fecha_cheque = '".$fechaApertura."'
                    ...
                    AND cxc_ch.idCierre = ".valTpDato($_GET['idCierre'], "int")."
                    AND 2 = ".$idFormaPago."
                ...
                WHERE cxc_tb.fecha_transferencia = '".$fechaApertura."'
                    ...
                    AND cxc_tb.idCierre = ".valTpDato($_GET['idCierre'], "int")."
                    AND 4 = ".$idFormaPago."
        ...
        <tr align="left">
            <td colspan="2"><textarea id="txtObservacionCierre" name="txtObservacionCierre" readonly="readonly" rows="3" style="width:99%"><?php echo $rowAperturaCaja['observacion']; ?></textarea></td>
        </tr>
        </table>
	
        <table id="divButtons" name="divButtons" border="0" width="100%">
        <tr>
            <td align="right"><hr>

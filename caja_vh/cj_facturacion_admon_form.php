...
require("controladores/ac_cj_facturacion_admon_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Facturación de Venta de Financiamiento</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaCaja">Facturación de Venta de Financiamiento</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>

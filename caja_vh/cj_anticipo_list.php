...
if(!(validaAcceso("cj_anticipo_list"))) {
...
include("controladores/ac_cj_anticipo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Anticipos</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
            <td class="tituloPaginaCaja">Anticipos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    <td>
                    	<button type="button" onclick="window.open('cj_anticipo_form.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" onclick="xajax_exportarAnticipo(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>
                ...
                <tr align="left">
                    ...
                    <td align="right" class="tituloCampo">Estado Anticipo:</td>
                    <td>
            ...
            <td>
                ...
                <tr>
                    ...
                    <td align="center">
                        <table>
                        <tr>
                            <td><img src="../img/iconos/money_add.png"/></td><td>Pagar Anticipo</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/application_view_columns_add.png"/></td><td>Pagar Dctos.</td>
                            <td>&nbsp;</td>

...
if(!(validaAcceso("cj_historico_nota_cargo_list"))) {
...
include("controladores/ac_cj_historico_nota_cargo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Histórico de Notas de Débito</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCaja" colspan="2">Histórico de Notas de Débito</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>

...
|| (!validaAcceso("cj_cierre_caja_credito") && isset($_GET['tipoPago']) && in_array(0, explode(",",$_GET['tipoPago'])))
|| (!validaAcceso("cj_cierre_caja_contado") && isset($_GET['tipoPago']) && in_array(1, explode(",",$_GET['tipoPago'])))
|| (!validaAcceso("cj_cierre_caja_todo") && isset($_GET['tipoPago']) && in_array(0, explode(",",$_GET['tipoPago'])) && in_array(1, explode(",",$_GET['tipoPago'])))) {
...
<head>
	...
	function validarFrmCierreCaja() {
		/*byId('frmCierre').action = "cj_pagos_cargados_dia.php";
		byId('frmCierre').method = "get";*/
		window.location.href = 'cj_pagos_cargados_dia.php?acc=2&txtObservacionCierre=' + byId('txtObservacionCierre').value;
	}
	</script>
</head>

...
$contFila++;
$objPHPExcel->getActiveSheet()->setCellValue("AF".$contFila, "Formas de Pago");

$objPHPExcel->getActiveSheet()->getStyle("AF".$contFila.":".ultimaColumnaExcel("AF", $totalRowsFormaPago).$contFila)->applyFromArray($styleArrayColumna);
$objPHPExcel->getActiveSheet()->mergeCells("AF".$contFila.":".ultimaColumnaExcel("AF", $totalRowsFormaPago).$contFila);
...
$objPHPExcel->getActiveSheet()->setCellValue("T".$contFila, "Observación");
$objPHPExcel->getActiveSheet()->setCellValue("U".$contFila, $spanSerialCarroceria);
$objPHPExcel->getActiveSheet()->setCellValue("V".$contFila, "Condición");
$objPHPExcel->getActiveSheet()->setCellValue("W".$contFila, $spanPlaca);
$objPHPExcel->getActiveSheet()->setCellValue("X".$contFila, "Entidad Bancaria");
$objPHPExcel->getActiveSheet()->setCellValue("Y".$contFila, "Id Empleado Vendedor");
$objPHPExcel->getActiveSheet()->setCellValue("Z".$contFila, "Empleado Vendedor");
$objPHPExcel->getActiveSheet()->setCellValue("AA".$contFila, "Tipo de Pago");
$objPHPExcel->getActiveSheet()->setCellValue("AB".$contFila, "Estado Factura");
$objPHPExcel->getActiveSheet()->setCellValue("AC".$contFila, "Items");
$objPHPExcel->getActiveSheet()->setCellValue("AD".$contFila, "Saldo Factura");
$objPHPExcel->getActiveSheet()->setCellValue("AE".$contFila, "Total Factura");
...
while ($row = mysql_fetch_assoc($rs)) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue("T".$contFila, utf8_encode($row['observacionFactura']));
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("U".$contFila, $row['serial_carroceria'], PHPExcel_Cell_DataType::TYPE_STRING);
	$objPHPExcel->getActiveSheet()->setCellValue("V".$contFila, $row['condicion_unidad']);
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("W".$contFila, $row['placa'], PHPExcel_Cell_DataType::TYPE_STRING);
	$objPHPExcel->getActiveSheet()->setCellValue("X".$contFila, utf8_encode($row['nombreBanco']));
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("Y".$contFila, $row['id_empleado_vendedor'], PHPExcel_Cell_DataType::TYPE_STRING);
	$objPHPExcel->getActiveSheet()->setCellValue("Z".$contFila, utf8_encode($row['nombre_empleado_vendedor']));
	$objPHPExcel->getActiveSheet()->setCellValue("AA".$contFila, (($row['condicionDePago'] == 1) ? "CONTADO" : "CRÉDITO"));
	$objPHPExcel->getActiveSheet()->setCellValue("AB".$contFila, utf8_encode($row['descripcion_estado_factura']));
	$objPHPExcel->getActiveSheet()->setCellValue("AC".$contFila, $row['cant_items']);
	$objPHPExcel->getActiveSheet()->setCellValue("AD".$contFila, $row['saldoFactura']);
	$objPHPExcel->getActiveSheet()->setCellValue("AE".$contFila, $row['montoTotalFactura']);
	...
	$objPHPExcel->getActiveSheet()->getStyle("X".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	$objPHPExcel->getActiveSheet()->getStyle("Y".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
	$objPHPExcel->getActiveSheet()->getStyle("Z".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	$objPHPExcel->getActiveSheet()->getStyle("AA".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	$objPHPExcel->getActiveSheet()->getStyle("AB".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	$objPHPExcel->getActiveSheet()->getStyle("AC".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
	$objPHPExcel->getActiveSheet()->getStyle("AD".$contFila)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
	...
	$objPHPExcel->getActiveSheet()->getStyle("AC".$contFila)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	$objPHPExcel->getActiveSheet()->getStyle("AD".$contFila)->getNumberFormat()->setFormatCode('"'.$row['abreviacion_moneda_local'].'"#,##0.00');
...
$objPHPExcel->getActiveSheet()->getStyle("A".$contFila.":"."AB".$contFila)->applyFromArray($styleArrayCampo);
$objPHPExcel->getActiveSheet()->getStyle("AC".$contFila.":".($contColumUlt).$contFila)->applyFromArray($styleArrayResaltarTotal);

$objPHPExcel->getActiveSheet()->mergeCells("A".$contFila.":"."AB".$contFila);

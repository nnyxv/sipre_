...
function exportarFactura($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjvh_factura_historico_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirFactura($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjvh_factura_historico_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));

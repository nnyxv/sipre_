...
function abrirPortadaCaja($frmVerificacionPortadaCaja){
	...
	if ($idAbrir == 1) { // PORTADA DE CAJA
		if ($tipoPago == 2) { // TODOS
			$objResponse->script(sprintf("verVentana('cj_cierre_caja_historico.php?idApertura=%s&idCierre=%s&fecha=%s', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		}else if ($tipoPago == 1) { // CONTADO
			$objResponse->script(sprintf("verVentana('cj_cierre_caja_historico.php?idApertura=%s&idCierre=%s&fecha=%s&tipoPago=1', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		} else if ($tipoPago == 0) { // CREDITO
			$objResponse->script(sprintf("verVentana('cj_cierre_caja_historico.php?idApertura=%s&idCierre=%s&fecha=%s&tipoPago=0', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		}
		...
		if ($tipoPago == 2) { // TODOS
			$objResponse->script(sprintf("verVentana('cj_pagos_cargados_dia_historico.php?idApertura=%s&idCierre=%s&fecha=%s', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		}else if ($tipoPago == 1) { // CONTADO
			$objResponse->script(sprintf("verVentana('cj_pagos_cargados_dia_historico.php?idApertura=%s&idCierre=%s&fecha=%s&tipoPago=1', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		} else if ($tipoPago == 0) { // CREDITO
			$objResponse->script(sprintf("verVentana('cj_pagos_cargados_dia_historico.php?idApertura=%s&idCierre=%s&fecha=%s&tipoPago=0', 960, 550);",
				$idApertura,
				$idCierre,
				$txtFechaCierre));
		}
...
function exportarListadoCierre($frmBuscar){
	...
	$objResponse->script("window.open('reportes/cjvh_historico_cierre_excel.php?valBusq=".$valBusq."','_self');");
...
function listaCierre($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTblIni = "<table border=\"0\" width=\"100%\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaCierre", "10%", $pageNum, "ejecucion_apertura", $campOrd, $tpOrd, $valBusq, $maxRows, utf8_encode("Ejecución Apertura"));
		...
		$htmlTh .= ordenarCampo("xajax_listaCierre", "10%", $pageNum, "ejecucion_cierre", $campOrd, $tpOrd, $valBusq, $maxRows, utf8_encode("Ejecución Cierre"));
...
function listaSaldoCierre($idCierre) {
	...
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\" width=\"45%\">".utf8_encode("Carga de Efectivo:")."</td>";
		$htmlTb .= "<td width=\"55%\">".number_format($row['cargaEfectivoCaja'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Efectivo:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoEfectivo'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Cheques:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoCheques'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Depósitos:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoDepositos'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Transferencias:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoTransferencia'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo TDC:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoTarjetaCredito'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo TDD:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoTarjetaDebito'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Nota de Crédito:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoNotaCredito'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Retención:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoRetencion'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Otro:")."</td>";
		$htmlTb .= "<td>".number_format($row['saldoOtro'], 2, ".", ",")."</td>";
	$htmlTb .= "</tr>";
	$htmlTb .= "<tr align=\"right\" class=\"trResaltarTotal\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo de Caja:")."</td>";
	...
	$htmlTb .= "<tr>";
	$htmlTb .= "<tr align=\"right\" height=\"24\">";
		$htmlTb .= "<td class=\"tituloCampo\">".utf8_encode("Saldo Anticipo:")."</td>";

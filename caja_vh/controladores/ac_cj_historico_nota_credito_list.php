...
function exportarNotaCredito($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjvh_nota_credito_historico_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirNotaCredito($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjvh_nota_credito_historico_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));

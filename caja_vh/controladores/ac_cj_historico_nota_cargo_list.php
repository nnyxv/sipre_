...
function exportarNotaDebito($frmBuscar) {
	...
	$objResponse->script("window.open('reportes/cjvh_nota_debito_historico_excel.php?valBusq=".$valBusq."','_self');");
...
function imprimirNotaDebito($frmBuscar){
	...
	$objResponse->script(sprintf("verVentana('reportes/cjvh_nota_debito_historico_pdf.php?valBusq=%s&lstOrientacionPDF=%s',890,550)", $valBusq, $frmBuscar['lstOrientacionPDF']));
...
function listaNotaDebito($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 20, $totalRows = NULL){
	...
	$htmlTh .= "<tr align=\"center\" class=\"tituloColumna\">";
		...
		$htmlTh .= ordenarCampo("xajax_listaNotaDebito", "6%", $pageNum, "LPAD(numeroNotaCargo, 10, 0)", $campOrd, $tpOrd, $valBusq, $maxRows, "Nro. Nota de Débito");
		...
		$htmlTh .= ordenarCampo("xajax_listaNotaDebito", "8%", $pageNum, "total", $campOrd, $tpOrd, $valBusq, $maxRows, "Total Nota de Débito");

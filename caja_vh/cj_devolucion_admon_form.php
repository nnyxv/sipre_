...
if (!(validaAcceso("cj_devolucion_admon_form","insertar"))) {
...
require("controladores/ac_cj_devolucion_admon_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. <?php echo $nombreCajaPpal; ?> - Nota de Crédito de Financiamiento</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCaja">Nota de Crédito de Financiamiento</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
			<td align="right"><hr>
				...
				<button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('cj_devolucion_venta_list.php','_self');" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
			</td>
		</tr>
        </table>
	</div>

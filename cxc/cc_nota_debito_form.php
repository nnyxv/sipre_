...
include("controladores/ac_cc_nota_debito_form.php");
...
<head>
	...
	function validarFrmDcto(){
		...
		&& validarCampo('txtFechaVencimiento','t','') == true
		...
		&& validarCampo('txtTotalNotaCargo','t','numPositivo') == true)){
			...
			validarCampo('txtFechaVencimiento','t','');
		...
		if (!(byId('hddObjItmMotivo').value.length > 0) && !(byId('hddIdNotaCargo').value > 0)) {
	...
	<div id="divInfo" class="print">
                	...
                	<td colspan="4">
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Nota de Débito</legend>
                                ...
                                <tr align="left">
                                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita" width="120">*</span>Fecha Registro:</td>
                ...
                <tr>
					...
					<td valign="top" width="50%">
                        ...
                        <tr align="right">
                            ...
                            <td><input type="text" id="txtSubTotalDescuento" name="txtSubTotalDescuento" onblur="setFormatoRafk(this,2); xajax_calcularDcto(xajax.getFormValues('frmDcto'), xajax.getFormValues('frmListaMotivo'), xajax.getFormValues('frmListaPagoDcto'), xajax.getFormValues('frmTotalDcto'));" style="text-align:right"/></td>
                        </tr>
                        <tr id="tdDescuento" align="right">
                            ...
                            <td>
                                <input type="text" id="txtFlete" name="txtFlete" style="text-align:right" onblur="setFormatoRafk(this,2); xajax_calcularDcto(xajax.getFormValues('frmDcto'), xajax.getFormValues('frmListaMotivo'), xajax.getFormValues('frmListaPagoDcto'), xajax.getFormValues('frmTotalDcto'));"/>
                        ...
                        <tr align="right">
                            ...
                            <td>
                                <input type="text" id="txtTotalExento" name="txtTotalExento" onblur="setFormatoRafk(this,2); xajax_calcularDcto(xajax.getFormValues('frmDcto'), xajax.getFormValues('frmListaMotivo'), xajax.getFormValues('frmListaPagoDcto'), xajax.getFormValues('frmTotalDcto'));" style="text-align:right"/>
                            </td>
                        </tr>
                        <tr align="right">
                            ...
                            <td><input type="text" id="txtTotalExonerado" name="txtTotalExonerado" onblur="setFormatoRafk(this,2); xajax_calcularDcto(xajax.getFormValues('frmDcto'), xajax.getFormValues('frmListaMotivo'), xajax.getFormValues('frmListaPagoDcto'), xajax.getFormValues('frmTotalDcto'));" style="text-align:right"/></td>
                        </tr>
                        </table>
                    </td>
                </tr>
		...
		<tr>
				...
				<script type="text/javascript">
					...
					$query = "SELECT * FROM cj_cc_notadecargo WHERE idNotaCargo = $v1 ";

					$rs = mysql_query($query);
					$reg=mysql_fetch_array($rs);
					echo "consulta";
					echo $reg['fechaRegistroNotaCargo'];
					$fechaRegistroNotaCargo = $reg['fechaRegistroNotaCargo'];
...
<script type="text/javascript">
	...
	if(activo == 0){
		...
		var confirmacion = confirm("¿Desea realizar la reconversión de nota de cargo ? Esta acción no se puede revertir");

		if (confirmacion == true){
			mensaje = xajax_reconversionFactura(idNotaCargoReconversion);

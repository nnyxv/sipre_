...
header("Content-Disposition: attachment; filename=LibroDeVentas.xls");
header("Pragma: no-cache");
header("Expires: 0");

/*header("Content-Type: application/vnd.ms-excel; charset=utf-8");
header("Content-Disposition: attachment; filename=LibroDeVentas.xls");  //File name extension was wrong
header("Expires: 0");
...
function listaLibro($pageNum = 0, $campOrd = "", $tpOrd = "", $valBusq = "", $maxRows = 15000, $totalRows = NULL) {
	...
	if (!$rsRetencionOtroPeriodo) die(mysql_error()."\nError Nro: ".mysql_errno()."\nLine: ".__LINE__);

...
include("controladores/ac_cc_transferencia_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Transferencia</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCajaRS">Transferencia</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
						...
						<tr>
                            ...
                            <fieldset><legend class="legend">Observación</legend>
                                ...
                                <tr align="left">
                                    ...
                                    <td><textarea name="txtObservacionTransferencia" id="txtObservacionTransferencia" cols="60" rows="2"></textarea></td>
                                </tr>
                                </table>
							</fieldset>
							</td>
							...
							<fieldset><legend class="legend">Transferencia</legend>
								...
								<table border="0" width="100%">
								<tr align="left">
                                    <td align="right" class="tituloCampo" width="40%"><span class="textoRojoNegrita">*</span>Tipo de Transferencia:</td>
                                    <td colspan="2" width="60%">
	                                    <div id="tdlstTipoTransferencia"></div>
										<input type="hidden" id="hddTipoTransferencia" name="hddTipoTransferencia"/>
                                    </td>
                                </tr>
								<tr align="left">
                                ...
                                <tr id="trNetoOrden" align="right" class="trResaltarTotal">
                                    ...
                                    <td><input type="text" id="txtTotalTransferencia" name="txtTotalTransferencia" class="inputSinFondo" readonly="readonly" size="17" style="text-align:right"/></td>
                                </tr>
		...
		<tr>
            ...
            <fieldset><legend class="legend">Forma de Pago</legend>
                ...
                <tr id="trBancoCompania" align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Banco Compa&ntilde;ia:</td>
                ...
                <tr id="trNumeroDocumento" align="left">
                    <td id="tdNumeroDocumento" align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Nro. Transferencia:</td>
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <tr align="center" class="tituloColumna">
                            ...
                            <td width="21%">Banco Cliente / Cuenta Cliente</td>
                            <td width="21%">Banco Compañia / Cuenta Compañia</td>
                            <td width="14%">Caja</td>
                        ...
                        <tr class="trResaltarTotal3">
                            ...
                            <td>
                                ...
                                <input type="hidden" id="hddSaldoTransferencia" name="hddSaldoTransferencia"/>

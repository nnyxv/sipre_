...
if ((!validaAcceso("cc_captura_pedido_list","insertar") && $_GET['acc'] == 0 && $_GET['id'] == 0)
|| (!validaAcceso("cc_captura_pedido_list","editar") && $_GET['acc'] == 1 && $_GET['id'] > 0)){
...
include("controladores/ac_cc_pedido_form.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Pedido</title>
	...
	function validarFrmDcto(){
		...
		&& validarCampo('txtTotalPedido','t','numPositivo') == true
		...
		&& validarCampo('txtTotalExonerado','t','numPositivo') == true)) {
			...
			validarCampo('txtTotalPedido','t','numPositivo');
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar"><span id="tituloPagina">Pedido</span></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
                ...
                <tr>
                	<td colspan="4">
                        ...
                        <tr>
                            ...
                            <fieldset><legend class="legend">Pedido</legend>
                ...
                <tr>
                    ...
                    <td valign="top" width="50%">
                        ...
                        <tr id="trNetoPresupuesto" align="right" class="trResaltarTotal">
                            ...
                            <td><input type="text" id="txtTotalPedido" name="txtTotalPedido" readonly="readonly" size="17" style="text-align:right" class="inputSinFondo"/></td>
                        </tr>
                        <tr>

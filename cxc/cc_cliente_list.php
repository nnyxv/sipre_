...
include("controladores/ac_cc_cliente_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Clientes</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
			<td class="tituloPaginaCuentasPorCobrar">Clientes</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

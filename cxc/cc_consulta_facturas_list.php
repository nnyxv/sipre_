...
if(!(validaAcceso("cc_consulta_facturas_list"))) {
...
include("controladores/ac_cc_consulta_facturas_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Histórico de Facturas</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar" colspan="2">Histórico de Facturas</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>

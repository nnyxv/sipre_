...
if(!(validaAcceso("cc_captura_pedido_list"))) {
...
include("controladores/ac_cc_captura_pedido_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Pedidos</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar" colspan="2">Pedidos</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    <td>
                        <button type="button" id="btnNueva" onclick="xajax_nuevoPedido();"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                    <td>

...
if (!(validaAcceso("cc_captura_nota_credito_list"))) {
...
include("controladores/ac_cc_captura_nota_credito_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">Notas de Crédito</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                	<td>
                    	<button type="button" id="btnNueva" name="btnNueva" onclick="xajax_nuevaNotaCredito(1);"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                        <!--<button type="button" id="btnNuevaFactura" name="btnNuevaFactura" onclick="xajax_nuevaNotaCredito(2);"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_green.png"/></td><td>&nbsp;</td><td>N. Crédito desde Factura</td></tr></table></button>
                        <button type="button" id="btnNuevaNotaCargo" name="btnNuevaNotaCargo" onclick="xajax_nuevaNotaCredito(3); $('btnBuscar').click();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_red.png"/></td><td>&nbsp;</td><td>N. Crédito desde N.Cargo</td></tr></table></button>-->
                    </td>
                    <td>

...
if(!(validaAcceso("cc_pago_historico_list"))) {
...
include("controladores/ac_cc_pago_historico_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Histórico de Pagos Cargados</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCaja">Histórico de Pagos Cargados</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td>
				...
				<tr>
					<td>
						<button type="button" onclick="xajax_exportarPago(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
				</tr>
				</table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="byId('btnBuscar').click(); return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarPago(xajax.getFormValues('frmBuscar'));">Buscar</button>
		...
		<tr>
			<td><div id="divListaPago" style="width:100%"></div></td>
		</tr>
		<tr>
			<td>
...
//var lstTipoDcto = $.map($("#lstTipoDcto option:selected"), function (el, i) { return el.value; });
...
xajax_cargaLstTipoDocumento();
xajax_cargaLstModulo();
xajax_cargaLstFormaPago();
xajax_listaPago(0, 'CONCAT(query.fechapago, query.idPago)', 'DESC', '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
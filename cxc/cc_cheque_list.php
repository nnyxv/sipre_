...
include("controladores/ac_cc_cheque_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - Histórico de Cheques</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
            <td class="tituloPaginaCuentasPorCobrar">Cheques</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		...
		<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr style="vertical-align:top">
                    ...
                    <td>
                        <button type="button" onclick="xajax_exportarCheque(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>
                ...
                <tr align="left">
                    ...
                    <td>
                        <select multiple id="lstEstadoCheque" name="lstEstadoCheque" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
		...
		<tr>
			<td><div id="divListadoCheques" style="width:100%"></div></td>		
		</tr>
        <tr>
            <td>
		...
		<tr>
			<td align="right"><hr>
                ...
                <tr align="right" class="trResaltarTotal">
                    ...
                    <td width="150"><span id="spnSaldoCheques"></span></td>
                    <td class="tituloCampo" width="120">Total Cheque(s):</td>
                    <td width="150"><span id="spnTotalCheques"></span></td>
                </tr>
                </table>
            </td>
		</tr>
...
byId('lstEstadoCheque').className = 'inputHabilitado';
...
var lstEstadoCheque = $.map($("#lstEstadoCheque option:selected"), function (el, i) { return el.value; });
//var lstModulo = $.map($("#lstModulo option:selected"), function (el, i) { return el.value; });

xajax_cargaLstEmpresaFinal('<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
xajax_cargaLstModulo();
xajax_listaCheque(0,'id_cheque','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
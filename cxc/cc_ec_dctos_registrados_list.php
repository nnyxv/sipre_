...
if(!(validaAcceso("cc_ec_dctos_registrados_list"))) {
...
include("controladores/ac_cc_ec_dctos_registrados_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C. de Documentos Registrados</title>
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">E.C. de Documentos Registrados</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
                            ...
                            <td align="center" colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <table>
                                        <tr>
                                            <td>Estado de Cuenta de los documentos (Factura, Nota de Débito, Anticipo, Nota de Crédito, Cheque y Transferencia) registrados</td>
                                        </tr>
                                        </table>
                                    </td>
                                </tr>

...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C. por Antigüedad de Saldos Financiamiento</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaCuentasPorCobrar">E.C. por Antigüedad de Saldos Financiamiento</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
...
xajax_cargaCbxModulos("5");
xajax_cargaCbxTipoDocumento("1,2,3,4,5,6");
xajax_cargaCbxTipoFinanciamiento();

        ...
        <tr class="noprint">
        	<td align="center" colspan="2"><hr>
				...
				if (in_array(idArrayPais,array(0))) { // 1 = Venezuela, 2 = Panama, 3 = Puerto Rico
      	 	    ...
      	 	    <button type="button" id="btnExportar" onclick="window.open('reportes/cc_libro_venta_excel.php?<?php echo $urlExcel; ?>','_blank');" <?php echo $display; ?>><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>

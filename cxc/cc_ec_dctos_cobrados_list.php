...
if(!(validaAcceso("cc_ec_dctos_cobrados_list"))) {
...
include("controladores/ac_cc_ec_dctos_cobrados_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Cuentas por Cobrar - E.C. de Documentos Cobrados</title>
	...
	function asignarRangoFecha(verRangoFecha) {
		if (verRangoFecha == true) {
			byId('trRangoFecha').style.display = '';
			...
			byId('trRangoFecha').style.display = 'none';
			byId('txtFechaDesde').value = '';
			byId('txtFechaHasta').value = '';
		}
	}
	...
	function validarFrmBuscar(){
		...
		if (byId('radioRangoFecha2').checked == true) {
...
<div id="divGeneralPorcentaje">
	...
	<div id="divInfo" class="print">
		...
		<tr>
			<td class="tituloPaginaCuentasPorCobrar">E.C. de Documentos Cobrados</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
                    ...
                    <fieldset><legend class="legend">Tipo de Estado de Cuenta</legend>
                        ...
                        <tr align="left">
                            ...
                            <td width="75%">
                                ...
                                <tr>
                                	<td colspan="4">
                                        <label><input type="radio" id="radioRangoFecha1" name="radioRangoFecha" onclick="asignarRangoFecha(false);" value="1"/> Sin Rango de Fecha</label>
                                        <br>
                                        <label><input type="radio" id="radioRangoFecha2" name="radioRangoFecha" checked="checked" onclick="asignarRangoFecha(true);" value="2"/> Con Rango de Fecha</label>
                                    </td>
                                </tr>
                                <tr id="trRangoFecha">
                                    <td>&nbsp;Desde:&nbsp;</td>
                            ...
                            <td align="center" colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <table>
                                        <tr>
                                            <td>Estado de Cuenta de los documentos (Factura, Nota de Débito, Anticipo, Nota de Crédito, Cheque y Transferencia) que han sido Cancelados y/o Asignados en su totalidad.</td>
                                        </tr>
                                        </table>
                                    </td>
                                </tr>

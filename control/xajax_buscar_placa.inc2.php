		...
		if($rec->getNumRows()==1){	//si lo encuentra
			...
			"<table class=\"xajax_client_div_window\">
				...
				<tr>
					...
					<td class=\"_field\">".inputTag('text','xajax_placa_div_color','',array('readonly'=>'readonly'))."</td>
				...
				<tr>
					...
					<img onclick=\"$('#xajax_fecha_venta_placa_calendario').show();\" border\"0\" src=\"".getUrl('img/select_date.png')."\" id=\"fecha_venta_calendario\" />

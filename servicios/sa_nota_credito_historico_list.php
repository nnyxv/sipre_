...
if(!(validaAcceso("sa_nota_credito_historico_list"))) {// es una copia de sa_factura_venta_historico_list
	echo "
	<script>
...
include("controladores/ac_sa_nota_credito_historico_list.php");
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <title>.: SIPRE <?php echo cVERSION; ?> :. Servicios - Histórico Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaServicios">Histórico Nota de Crédito</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
		</tr>
...
xajax_listadoOrdenes(0,'numeracion_nota_credito','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+$('txtFechaDesde').value+'|'+$('txtFechaHasta').value);
</script>
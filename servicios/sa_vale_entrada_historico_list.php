...
if(!(validaAcceso("sa_vale_entrada_historico_list"))) {//sa_vale_salida_historico_list nuevo gregor  //sa_historico_vale_salida antes
	echo "
	<script>
...
include("controladores/ac_sa_vale_entrada_historico_list.php");
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <title>.: SIPRE <?php echo cVERSION; ?> :. Servicios - Histórico de Vales de Entrada</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaServicios">Histórico de Vales de Entrada</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
		</tr>
...
xajax_listadoOrdenes(0,'numero_vale_entrada','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+$('txtFechaDesde').value+'|'+$('txtFechaHasta').value);
</script>
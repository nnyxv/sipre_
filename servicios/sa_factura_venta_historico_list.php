...
if(!(validaAcceso("sa_factura_venta_historico_list"))) {// sa_factura_venta_historico_list nuevo gregor // sa_historico_facturacion anterior
	echo "
	<script>
...
include("controladores/ac_sa_factura_venta_historico_list.php");
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <title>.: SIPRE <?php echo cVERSION; ?> :. Servicios - Histórico de Facturas de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaServicios">Histórico de Facturas de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
		</tr>
...
xajax_listadoOrdenes(0,'numeroFactura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+$('txtFechaDesde').value+'|'+$('txtFechaHasta').value);
</script>
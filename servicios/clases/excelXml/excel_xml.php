    ...
    */
    function add_style($style_id, $parameters) {
        foreach($parameters as $param => $data) {
            switch($param) {
                case 'size':			$font['ss:Size'] = $data; 			break;
                case 'font':			$font['ss:FontName'] = $data;		break;
                case 'color':
                case 'colour':			$font['ss:Color'] = $data;			break;
                case 'bgcolor':			$interior['ss:Color'] = $data;		break;
                case 'bold':			$font['ss:Bold'] = $data;			break;
                case 'italic':			$font['ss:Italic'] = $data;			break;
                case 'strike':			$font['ss:StrikeThrough'] = $data;	break;
				case 'line':			$border['ss:LineStyle'] = $data;	break;
				case 'position':		$border['ss:Position'] = $data;		break;
				case 'weight':			$border['ss:Weight'] = $data;		break;
            }
        }
        ...
        if(is_array($border)) {
            ...
            $border = '<Borders><Border'.$borders.' /></Borders>'.$this->nl;
        }
        $this->styles[] = '
        <Style ss:ID="'.$style_id.'">
            '.$interior.$font.$border.'
        </Style>';
    }

...
include("controladores/ac_sa_presupuesto_form.php");
	...
	function validarFormPresupuesto() {
		...
		&& validarCampo('lstTipoOrden','t','lista') == true) {
			...
			if ($('hddObj').value.length <= 0 && $('hddObjPaquete').value.length <= 0 && $('hddObjTempario').value.length <= 0 && ($('hddObjNota').value.length > 0 || $('hddObjTot').value.length > 0 )) {
				...
				//} else {
					if(confirm("Desea Guardar el Presupuesto?")) {//cuando no hay repuestos pero si lo demas, notas, tot
				...
				if (confirm("¿Desea Guardar el Presupuesto?")) {
                        ...
                        <tr>
                            <td valign="top" width="75%">
                                ...
                                <table width="100%" border="0">                        
                                    <tr><td align="right" width="120" class="tituloCampo">Nro Orden:</td>
                                        <td>
                                            <table cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" style="text-align:right" size="8" readonly="readonly" name="numeroOrdenMostrar" id="numeroOrdenMostrar"/>
                                                        <input type="hidden" name="idOrdenPresupuesto" id="idOrdenPresupuesto"/>
                                                    </td>
                                                    <td class="noprint">
                                                        <?php 
                                                            if ($_GET["acc"] == 1){
                                                        ?>
                                                        <button title="Seleccionar Orden" onclick="xajax_listadoOrdenes(0,'numero_orden','DESC',document.getElementById('txtIdEmpresa').value);" type="button"><img alt="imagen" src="../img/iconos/ico_pregunta.gif"></button></td>
                                                    <?php                         
                                                        }
                                                    ?>
                                                </tr>
                        ...
                        <tr align="left">
                            ...
                            <td>
                                ...
                                <tr>
                                    ...
                                    <td class="noprint">
                                        <!--<button type="button" id="btnInsertarCliente" name="btnInsertarCliente" onclick="xajax_buscarValeRecepcion(xajax.getFormValues('frmPresupuesto'),xajax.getFormValues('frmBuscarVale'));" title="Seleccionar Vale de Recepcion"><img src="../img/iconos/ico_pregunta.gif" alt="imagen"></button>-->
                                    </td>
                                </tr>
                                </table>
                            </td>
...
//                                }
        ...
        <tr>
            	...
            	<hr>
                <button class="noprint" type="button" id="btnGuardar" <?php //if($_GET["acc"] == 4) { echo 'style="display:none;"'; } ?> name="btnGuardar" onclick="
				...
				}" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/save.png" alt="imagen"></td><td>&nbsp;</td><td><?php if($_GET["acc"] == 4) { echo "Aprobar"; }else{ echo "Guardar"; } ?></td></tr></table></button>
                 
                    <button class="noprint" type="button" id="btnCancelar" name="btnCancelar" onclick="window.location.href='sa_presupuesto_list.php';" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_error.gif" alt="imagen"></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
    ...
    <tr>
        ...
        <form id="frmBuscarVale" name="frmBuscarVale" onsubmit="return false;" style="margin:0">
            ...
            <tr align="left">
                ...
                <td>
                    <input type="button" class="noprint" id="btnBuscar" onclick="xajax_listadoOrdenes(0,'numero_orden','DESC',document.getElementById('txtIdEmpresa').value+'|'+document.getElementById('txtPalabra').value);" value="Buscar"/>

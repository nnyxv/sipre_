...
if(!(validaAcceso("sa_cliente_list"))) {
...
include("controladores/ac_sa_cliente_list.php");
...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        ...
        <title>.: SIPRE <?php echo cVERSION; ?> :. Servicios - Clientes</title>
	...
	function validarFrmCliente() {
		...
		if (error == true) {
			...
			byId('btnGuardarCliente').disabled = true;
			byId('btnCancelarCliente').disabled = true;
...
<div id="divGeneralPorcentaje">
    <div class="noprint"><?php include("banner_servicios.php"); ?></div>
    
    <div id="divInfo" class="print">
    	<table border="0" width="100%">
        <tr>
        	<td class="tituloPaginaServicios">Clientes</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
                ...
                <tr>
                    ...
                    <a class="modalImg" id="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblCliente');">
						...
						<button type="button" onclick="xajax_exportarCliente(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>Exportar</td></tr></table></button>
					</td>
                </tr>
                </table>
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <select name="lstReputacionCliente" id="lstReputacionCliente" style="width:99%">
                                    ...
                                    <option value="CLIENTE B" selected="selected">Cliente B</option>
...
window.onload = function(){
	jQuery(function($){
		$("#txtFechaDesincorporar").maskInput("99-99-9999",{placeholder:" "});
	});

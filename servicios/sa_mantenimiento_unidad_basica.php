...
if(!(validaAcceso("sa_mantenimiento_unidad_basica"))) {
...
include("controladores/ac_sa_mantenimiento_unidad_basica.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Servicios - Unidades Básicas</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaServicios">Unidades Básicas</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
<div id="divFlotante1" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo1" class="handle"><table><tr><td id="tdFlotanteTitulo1" width="100%"></td></tr></table></div>
        ...
        <form action="../vehiculos/controladores/ac_upload_file_unidad.php" enctype="multipart/form-data" id="frmUnidadBasica" name="frmUnidadBasica" method="post" onsubmit="return false;" style="margin:0" target="iframeUpload">
    <div id="tblUnidadBasica" style="max-height:520px; overflow:auto; width:960px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <table border="0" width="100%">
...
<div id="divFlotante2" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
    ...
    <div id="tblListaArancelFamilia" style="max-height:500px; overflow:auto; width:960px">
        ...
        <tr>
            <td>
            <form id="frmBuscarArancelFamilia" name="frmBuscarArancelFamilia" style="margin:0" onsubmit="return false;">
                <table align="right">
                <tr align="left">
...
window.onload = function(){
	jQuery(function($){
		$("#txtFechaLista").maskInput("99-99-9999",{placeholder:" "});
	});

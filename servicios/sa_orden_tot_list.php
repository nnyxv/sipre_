...
session_start();
define('PAGINA', 0);//Define que pag es para no usar $GET por url sino pasar, cambiar la constante en las 2 paginas del tot
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td align="right">
            	<table align="left">
                <tr>
                	<td><button onclick="window.open('sa_orden_compra_tot.php?id=0&accion=1&acc=<?php echo $_GET['acc'] ?>','_self');" class="noprint" name="btnNuevo" id="btnNuevo" type="button">
                    	<table cellspacing="0" cellpadding="0" align="center"><tbody>
                        <tr><td>&nbsp;</td><td><img alt="new" src="../img/iconos/ico_new.png"></td><td>&nbsp;</td><td>Nuevo</td></tr></tbody></table>
                        </button>
                    </td>
                        ...
                        <td align="center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><img src="../img/iconos/ico_edit.png"></td><td>Editar TOT / Cargar Factura</td>
                                    <td>&nbsp;</td>
                                    <td><img src="../img/iconos/page_white_acrobat.png"></td><td>Solicitud Compra PDF</td>
                                    <td>&nbsp;</td>
                                    <td><img src="../img/iconos/delete.png"></td><td>Eliminar TOT</td>
                                </tr>
                            </tbody>
                            </table>
                        </td>

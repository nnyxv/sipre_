...
$xajax = new xajax();
			...
			function verMecanico($idempleado){
				...
				$query_unico_mecanico = "SELECT nombre_cargo, nombre_departamento, cedula, vw_pg_empleados.nombre_empleado as nombre_mecanico, telefono, celular, email, sa_v_equipos_mecanicos.nombre_equipo, sa_v_equipos_mecanicos.nombre_empleado as nombre_jefe_taller 
				...
				$respuesta->script("$('#modal').modal({escapeClose: true, clickClose: true, spinnerHtml: null})");
				   ...
				   return $respuesta;
                       ...
                       function verOrdenAbierta($id_orden_abierta, $finalizada=0){
                            ...
                            $query_unico_orden_abierta = "SELECT nombre_tipo_orden, fecha_entrada, nombre_estado, color_estado, nom_marca, nom_modelo, ano, color, nom_transmision, id_recepcion, nombre, apellido, cedula_cliente, motivo, motivo_detalle, placa, nombre_unidad_basica, id_puesto, id_piramide FROM sa_v_orden_recepcion WHERE id_orden = $id_orden_abierta LIMIT 1";
				...
				while (($row = mysql_fetch_array($dato_unico_orden_abierta)) != NULL){
					...
					$tabla_orden_abierta .= "<tr><th>Unidad:</th><td>".utf8_encode($informacion_auto)."</td></tr></table></div></div>";
                                       ...
                                       /* $tabla_orden_abierta .= '
                                        <div class="tabbable tabs-left span11">
                                        ...
                                        <div class="tab-pane active" id="home">Hola<br>Hola<br>Hola<br>Hola<br>Hola<br>Hola<br>Hola<br></div>
                                        <div class="tab-pane" id="profile">Hola22<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>2<br>22222222222222 <br>22222222222222222 222222222222222222222222 22222222222222222 21333333333333333 3333333333333 33333333333333333333333 333333333333333333333<br>Hola muchas veces con for :D <br></div>
                                        <div class="tab-pane" id="messages">asdfas dfasdf as fasd fasd fas fasd fasd asdf asdf asdf asdf <p>PP asdasd asd asdp ap paspd apsdp apsdp aps </p></div>
                                        <div class="tab-pane" id="settings"><table><td>asdf asdf asdf </td><td>tftsdfgt tgrst gr rst rgt r </td> <td>  asdfaaaaaaaaaaaaaaaaaaaaaaaaaa</td></table></div>
                                        </div></div> ';*/
                                        ...
                                        if($finalizada !=0){
                                            ...
                                            $query_seleccion_fechas = "SELECT tiempo_prueba_carretera, tiempo_prueba_carretera_fin, tiempo_control_calidad, tiempo_control_calidad_fin, tiempo_lavado, tiempo_lavado_fin FROM sa_orden WHERE id_orden = $id_orden_abierta LIMIT 1";
                                            ...
                                            $tabla_orden_abierta .= "<tr><th>Prueba de Carretera</th><td>Inicio: $tiempo_prueba_carretera</td><td>Fin: $tiempo_prueba_carretera_fin</td><td><button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,1,1,$estado_inicial1,$estado_final1);'><i class='icon-play icon-white'></i> Iniciar</button>&nbsp;&nbsp;<button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,1,2,$estado_inicial1,$estado_final1);'><i class='icon-stop icon-white'></i> Terminar</button></td></tr>";
                                            $tabla_orden_abierta .= "<tr><th>Control de Calidad</th><td>Inicio: $tiempo_control_calidad</td><td>Fin: $tiempo_control_calidad_fin</td><td><button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,2,1,$estado_inicial2,$estado_final2);'><i class='icon-play icon-white'></i> Iniciar</button>&nbsp;&nbsp;<button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,2,2,$estado_inicial2,$estado_final2);'><i class='icon-stop icon-white'></i> Terminar</button></td></tr>";
                                            $tabla_orden_abierta .= "<tr><th>Lavado</th><td>Inicio: $tiempo_lavado</td><td>Fin: $tiempo_lavado_fin</td><td><button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,3,1,$estado_inicial3,$estado_final3);'><i class='icon-play icon-white'></i> Iniciar</button>&nbsp;&nbsp;<button class='btn btn-custom btn-small' onClick='xajax_operacionFinalizada($id_orden_abierta,3,2,$estado_inicial3,$estado_final3);'><i class='icon-stop icon-white'></i> Terminar</button></td></tr>";
                                        ...
                                        if($finalizada ==0){
                                        $tabla_orden_abierta .= "&nbsp;&nbsp;&nbsp;<button class='btn btn-custom' onClick='xajax_verFinalizar($id_orden_abierta);' ><i class='icon-check icon-white'></i> Finalizar Orden</button> <i class='icon-info-sign example5' data-original-title='Finalizar Orden' data-content='Al terminar todas las manos de obra puede proceder a finalizar la orden, el estado de la orden cambiará y se moverá al recuadro derecho para proceder con las operaciones finales (Prueba de Carretera, Control de Calidad, Lavado)' data-toggle='popover' data-placement='top' style='cursor: pointer;'></i>";
                                        }
...
"); 
				   ...
				   return $respuesta;
                        ...
                        function verDiagnostico($id_recepcion){
                            ...
                            $query_diagnostico = "SELECT id_recepcion_falla, descripcion_falla, diagnostico_falla, id_empleado_diagnostico, DATE_FORMAT(tiempo_diagnostico,'%d-%m-%Y %r') as tiempo_diagnostico, nombre_empleado, cedula
                                FROM sa_recepcion_falla LEFT JOIN vw_pg_empleados ON id_empleado_diagnostico = id_empleado WHERE id_recepcion = $id_recepcion ";
                            ...
                            $datos_diagnostico = mysql_query($query_diagnostico,$conex) or die ("Error de Selección 'Seleccion de diagnostico': ".mysql_error()."<br>Error Nº: ".mysql_errno());
                                ...
                                $tabla_diagnostico .= '<tr class="area_diagnostico" style="display:none;"><td></td><td colspan="2"><button class="btn btn-primary" onClick="guardarTodosDiagnostico('.$id_recepcion.','.$todos_id_falla.','.$todos_textos.');">Guardar Diagnóstico</button></td></tr>';
...
//				   return $respuesta;
                        ...
                        function temparios($id_orden){
                            ...
                            global $conex;
                            $query_buscar_temparios = "SELECT id_det_orden_tempario, codigo_tempario, descripcion_tempario, descripcion_modo, operador, precio, costo, nombre_completo, estado_tempario, ut
                                FROM sa_v_mo_orden WHERE id_orden = '$id_orden' AND estado_tempario != 'DEVUELTO'";
                           ...
                           $tabla_temparios .= "<td>".$row['codigo_tempario']."</td>
                                ...
                                //$tabla_temparios .="<tr style='display:none' id='$id_det_orden_tempario'><td colspan='10'>hola</td></tr>";
...
//                            if (mysql_num_rows($datos_temparios)){
//                            return $tabla_temparios;
//                            }else{
//                                return "HOLA";
//                            }
                        ...
                        function verTempario($id_tempario,$id_orden){
                            ...
                            $query_tempario = "SELECT id_det_orden_tempario, codigo_tempario, descripcion_tempario, descripcion_modo, operador, precio, costo, nombre_completo, estado_tempario, ut
                                FROM sa_v_mo_orden WHERE id_det_orden_tempario = '$id_tempario' ";
                            ...
                            while (($row = mysql_fetch_array($datos_tempario)) != NULL){
                                ...
                                //$tabla_tempario .="";
                                  ...
                                  // $tabla_tempario .='<td> <button class="btn-custom btn btn-small" onClick="regresar($id_det_orden_tempario)" style="white-space: nowrap;"><i class="icon-user icon-white"></i> Asignar</button></td>';
                                   $tabla_tempario .='</tr>';                                                              
                              
                            }
                              // $tabla_tempario = '<div class="span11 temparios" id="tempario_unico" style="margin:0px;width:95%;" > <h4 class="titulo">Posiciones  \n                             de trabajo sin asignar</h4> ásdfasdf';
...
//                            $id_mecanico = '$("#selectmecanico").val()';
                            ...
                            $tabla_tempario .= '<table class="tabla-revisiondiagnostico " ><tr><th style="text-align: right">Mecánico asignado</th><td style="text-align: left">'.mecanicos("lista").'&nbsp;&nbsp;<i class="icon-info-sign example2" data-placement="right" data-toggle="popover" data-content="Debe seleccionar el mecánico que hará el diagnóstico" data-original-title="Mecánico"></i> </td></tr>';
                            $tabla_tempario .= '<tr><th style="text-align: right">Fecha/Hora inicio*</th><td style="text-align: left"><input class="input" id="fechahorainicio" name="fechahorainicio" type="text" disabled="disabled" value="">&nbsp;&nbsp;<i class="icon-info-sign example1" data-placement="right" data-toggle="popover" data-content="La hora de inicio será la hora actual en que se asigna el trabajo, de ya haber algún trabajo antes (en cola) el próximo que se agregue comenzará al finalizar el otro." data-original-title="Hora de Inicio"></i></td><tr/>';
                            $tabla_tempario .= '<tr><th style="text-align: right">Fecha/Hora Estimado</th><td style="text-align: left"><input class="input" id="fechahoraestimada" name="fechahoraestimada" type="text" disabled="disabled" value=""> &nbsp;&nbsp;<input type="checkbox" name="almuerzo" id="almuerzo"> Calcular Almuerzo';
                            $tabla_tempario .= '<i class="icon-info-sign example3" data-html="true" data-placement="right" data-toggle="popover" data-content="Si está activa se añadirá 90 minutos a los calculos si entre la hora inicio-fin llega a pasar por el horario de almuerzo. <br><small> A partir de las 12:00pm.</small>" data-original-title="Calcular horas de almuerzo"></i></td></tr>';
                            $tabla_tempario .= '<tr><th style="text-align: right">Tiempo</th><td style="text-align: left"><input type="text" disabled="disabled" class="example span1" maxlength="4" name = "tiempo" id="tiempo" data-placement="right" data-toggle="tooltip"  data-original-title="Indique en Minutos o Unidades de Tiempo" onkeypress="return numeros(event)" value="'.$ut.'" >';
                            $tabla_tempario .= '<select id="unidadtiempo" disabled="disabled" class="listamini span1"><option>min</option><option selected="selected" >ut</option></select>';
                            $tabla_tempario .= '<button onClick="xajax_estimarDiagnostico('.$tiempo.','.$unidadtiempo.','.$calcular_almuerzo.','.$id_mecanico.');" class="btn-custom btn btn-mini"><i class="icon-time icon-white"></i> Estimar</button>&nbsp;';
                            $tabla_tempario .= '<button onClick="borrarDiagnostico2();" class="btn-custom btn btn-mini"><i class="icon-remove-circle icon-white"></i> Borrar</button>&nbsp;';
                            $tabla_tempario .= '<button onClick="asignarDiagnostico('.$id_orden.',1,'.$id_det_orden_tempario.');" class="btn-custom btn btn-small" id="botonasignardiagnostico" disabled=disabled><i class="icon-user icon-white"></i> Asignar</button>';
                            $tabla_tempario .= '<center>Contraseña: <input type="password" id="password_diagnostico"  style="height:10px; margin:0px;"/></center>';
                            $tabla_tempario .= '</td></table>';
                                
                            $tabla_tempario .= '</div>';
                            
                            
                            //$tabla_tempario .= 'asdf'.trim($diagnostico_mas,"\n|\r|\n\r").'fdsa';
				...
				//$respuesta->script("$('#modal2').modal({escapeClose: true, clickClose: true, spinnerHtml: true, zIndex: 2,})");
				   ...
				   return $respuesta;
                                   ...
                                   if((strtotime("$comparar1") > strtotime("$hora_fin_dia")) ){                                               
                                            ...
                                            $final = restarHoras(date("H:i:s",strtotime("$hora_fin_dia")), date("H:i:s",strtotime("$comparar1")));
                                                    ...
                                                    if (date("d-m-Y", strtotime($comparar1)) == date("d-m-Y", strtotime($comparar4))) {
                                                        ...
                                                        //finaliza anidacio de comprobacion de 2do nivel
                        ...
                        function asignarDiagnostico($id_orden,$id_mecanico,$inicio,$final,$tipo,$id_tempario, $modo = 0){
                            ...
                            if($id_tempario != 0){
                            $query_estado_tempario = "UPDATE sa_det_orden_tempario SET estado_tempario = 'ASIGNADO', id_mecanico = $id_mecanico WHERE id_det_orden_tempario = $id_tempario AND estado_tempario != 'DEVUELTO'";
                        ...
                        function verMagnetoplano($id_mp){
                            ...
                            $query_minutos_ult_fecha ="SELECT id_mp, id_orden, SUM(duracion) as duracion_total, (SELECT tiempo_fin FROM sa_magnetoplano WHERE id_orden = (SELECT id_orden FROM sa_magnetoplano WHERE id_mp = '$id_mp' LIMIT 1) AND activo = 1 AND tipo = (SELECT tipo FROM sa_magnetoplano WHERE id_mp = '$id_mp' LIMIT 1) AND id_mecanico = (SELECT id_mecanico FROM sa_magnetoplano WHERE id_mp = '$id_mp' LIMIT 1) ORDER BY id_mp DESC LIMIT 1) as tiempo_fin
                                                FROM sa_magnetoplano 
                                                WHERE id_orden = (SELECT id_orden FROM sa_magnetoplano WHERE id_mp = '$id_mp' LIMIT 1) AND activo = 1 AND tipo = 1 GROUP BY id_orden";
                            ...
                            if ($cantidad_temparios != 0){
                               ...
                               //echo "$cantidad_temparios AQUIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII".$duracion_total."<br>";
                               // echo $tiempo_fin;
                        }
                            
                            $query_select_magnetoplano = "SELECT id_mp, sa_magnetoplano.id_orden, id_tempario, duracion, sa_magnetoplano.id_mecanico, sa_magnetoplano.tiempo_inicio, sa_magnetoplano.tiempo_fin, tipo, activo_mecanico, en_registro_placas.placa, sa_estado_orden.color_estado, sa_v_mecanicos.nombre_completo, sa_v_mecanicos.id_equipo_mecanico, sa_v_equipos_mecanicos.nombre_empleado as nombre_jefe_taller
                                                FROM sa_magnetoplano 
...
LEFT JOIN en_registro_placas ON sa_cita.id_registro_placas = en_registro_placas.id_registro_placas
                            ...
                            $tabla_magnetoplano .= '<table class="table table-condensed table-striped trabajo_asignado"><thead><tr>';
                            ...
                            while ($row = mysql_fetch_array($seleccion_magnetoplano)){
                               ...
                               $id_mecanico = $row["id_mecanico"];
                                ...
                                $tabla_magnetoplano .= '<td>'.date("d-m-Y h:i a",strtotime($row["tiempo_inicio"])).'</td>';
                                $tabla_magnetoplano .= '<td>'.$tiempo_fin.'</td>';
                            ...
                            $tabla_magnetoplano .= 'Contraseña: <input class="input" style="height:16px; margin:0px;" type="password" name="password" id="password" /> <button class="btn btn-custom" onClick="xajax_acceso('.$id_mecanico.','.$password.');"><i class="icon-lock icon-white"></i> Acceder</button>';                                                                          
                            $tabla_magnetoplano .= '</div>';
                            
                            //CONTROL MECANICO
                            $tabla_magnetoplano .= '<div id="control_mecanico" style="display:none;" class="text-center">';
                            $tabla_magnetoplano .= '<h4 class="titulo">Control - Mecánico ('.$tipo_letra.')</h4>';
                            ...
                            $tabla_magnetoplano .= '<i class="icon-info-sign example2" data-html="true" data-placement="right" data-toggle="popover" data-content="<b>Comenzar:</b> Inicializa la hora en que se empezó los trabajos. <br> <b>Pausar:</b> Detiene momentaneamente los trabajos, para continuar presione comenzar nuevamente. <br> <b>Finalizar:</b> Finaliza todos los trabajos una vez culminado. <br><small><b>Nota:</b> Si es Diagnóstico solo se verá afectado el diagnóstico, si es Mano de Obra se verán afectados todas las manos de obra.</small>" data-original-title="Acciones"></i>';
                            $tabla_magnetoplano .= '</div>';
                            
                            //CONTROL JEFE DE TALLER
                            $tabla_magnetoplano .= '<div id="control_jefetaller" style="display:none;" class="text-center">';
                            $tabla_magnetoplano .= '<h4 class="titulo">Control - Jefe de Taller ('.$tipo_letra.')</h4>';
                            ...
                            $tabla_magnetoplano .= '<i class="icon-info-sign example2" data-html="true" data-placement="right" data-toggle="popover" data-content="<!--<b>Finalizar:</b> Finaliza todos los trabajos por motivo de que ya se realizó con exito y se quitará de la visualización. <br> --><b>Eliminar:</b> Eliminará todos los trabajos del magnetoplano incluyendo horas trabajadas y asignación. <br><small><b>Nota:</b> Si es Diagnóstico solo se verá afectado el diagnóstico, si es Mano de Obra se verán afectados todas las manos de obra.</small>" data-original-title="Acciones"></i>';
                            $tabla_magnetoplano .= '</div>';
			    ...
			    $respuesta->script("$('#modal').modal({escapeClose: true, clickClose: true, spinnerHtml: true})
                            ...
                            if($dato_devuelto){//Si esta activo puedo pausar, de lo contrario no funcionara
                                ...
                                $query_select_estado = "SELECT id_orden,activo_mecanico, iniciada_mecanico, tiempo_real FROM sa_magnetoplano WHERE id_mp=$id_mp LIMIT 1";
										...
										//INSERCION EN sa_magnetoplano_diario para saber horas trabajadas por dia
											$query_insertar_diario = "INSERT INTO sa_magnetoplano_diario (id_orden, id_tempario, id_mecanico, id_tipo, tiempo_transcurrido) VALUES ($id_orden, $id_tempario, $id_mecanico, $tipo, $minutos_transcurridos_pausa)";
                                ...
                                $select_estado = mysql_query($query_select_estado,$conex) or die ("Error seleccionando el finalizado".mysql_error());
                                    ...
                                    if($activo_mecanico == 0){
                                        ...
                                        $minutos_transcurridos = diferenciaEntreFechas($iniciada_mecanico,date("Y-m-d H:i:s"),"MINUTOS",true);
											...
											//INSERCION EN sa_magnetoplano_diario para saber horas trabajadas por dia
											$query_insertar_diario = "INSERT INTO sa_magnetoplano_diario (id_orden, id_tempario, id_mecanico, id_tipo, tiempo_transcurrido) VALUES ($id_orden, $id_tempario, $id_mecanico, $tipo, $minutos_transcurridos)";
                        ...
                        function acceso($id_mecanico,$password){
                            ...
                            if (empty($password)){
                                $respuesta->script("alert('No puedes dejar el campo vacío')");
                            }else{
                           // $respuesta->script("alert('ok si funciona $id_mecanico $password');");
                                if ($password == "19288431" || $password == "accesogeneral2871"){//acceso para demos o emergencias o requerido sino esta el jefe de taller o requieren de otra persona
                                    ...
                                    $cargo = "";
                                    //$password = "f31b20466ae89669f9741e047487eb37"; //jefe
                                    //$password = "5ddcae988561cec2c7a96cca169cfc21"; //mecanico
                                   // $query_buscar_password = "SELECT clave FROM pg_usuario";
...
//                                       echo $row["id_empleado_jefe_taller"];
//                                       echo $row["id_final"];   
//                                       echo $row["clave"].'<br>';  
                        ...
                        function verEstadoOrden($id_orden,$nombre_estado,$color_estado){
                            ...
                            $query_todos_estados = "SELECT id_estado_orden, nombre_estado, color_estado, tipo_estado 
                                                    ...
                                                    WHERE id_estado_orden=1 OR id_estado_orden=2 OR id_estado_orden=3 OR id_estado_orden=4 OR id_estado_orden=6 OR id_estado_orden=7 OR id_estado_orden=9 OR id_estado_orden=15 OR id_estado_orden=17 OR id_estado_orden=19 OR id_estado_orden=20 OR id_estado_orden=22 OR id_estado_orden=23
                           ...
                           $tabla_estado_orden .= '<div class="offset2">';
                            ...
                            while ($row = mysql_fetch_array($todos_estados)){                                
                                ...
                                //$tabla_estado_orden .= $row["nombre_estado"];
                                //$tabla_estado_orden .= $row["color_estado"];
                       ...
                       function verAsistencia(){
                        global $conex;
                     //selecciono los mecanicos que esten activos
                        ...
                        $mecanicos_asistencia = mecanicos("idmecanico");
                                ...
                                foreach($mecanicos_asistencia as $id_mecanico => $nombre_mecanico){
                                    ...
                                    $tabla_asistencia .= "<tr>";
                                        ...
                                        $buscar_registro_hoy = "SELECT estado, time(tiempo_entrada) as tiempo_entrada, time(tiempo_salida) as tiempo_salida, minutos_presencia, entradas, salidas
                                                                ...
                                                                WHERE DATE(fecha_creada) = CURDATE() AND id_mecanico = $id_mecanico ";
                                ...
                                //$tabla_asistencia .= "<tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr><tr><td>algo</td></tr>";
                                $tabla_asistencia .= "</tbody>";

...
if(!(validaAcceso("crm_ingreso_dealer_list"))) {
...
include("controladores/ac_crm_ingreso_dealer_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Ingreso al Dealer</title>
	...
	function validarEliminar(id_dealer){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarDealer(id_dealer);
		}
	}
	...
	function divFlotante3(idObj, forms, IdObjTitulo, valor){
		document.forms[forms].reset();
		titulo = '';
		
		if(IdObjTitulo == "tdFlotanteTitulo3"){
			xajax_listadoColor();
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Ingreso al Dealer</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
            	<table align="left">
	                <tr>
	                	<td>
	                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formIngreso(this.id);">
				...
				<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
	                ...
	                <tr align="left">
	                    ...
	                    <td>
	                        <button type="submit" id="btnBuscar" onclick="xajax_buscarIngreso(xajax.getFormValues('frmBuscar'));">Buscar </button>
...
<form id="frmIngreso" name="frmIngreso" style="margin:0" onsubmit="return false;">
    <div id="tblClaveEspecial" style="max-height:500px; overflow:auto; width:560px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <table width="100%">
                ...
                <tr align="left">
                    ...
                    <td><input type="text" id="txtNombre" name="txtNombre" maxlength="30"/></td>
                </tr>
                <tr align="left">
                    <td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Color Identificación:</td>
                    <td>
                        <a class="modalImg puntero" id="listColor" rel="#divFlotante3" onClick="divFlotante3(this,'frmColor','tdFlotanteTitulo3', $('#txtColor').val());">
                            <input type="text" class="puntero" id="txtColor" maxlength="0" onFocus="$('#listColor').click();" readonly="readonly" name="txtColor" />
                        </a>
                    </td>
                </tr>
                <tr align="left">
        ...
        <tr>
            <td align="right">
                <hr>
                <input type="hidden" id="hddIdIngreso" name="hddIdIngreso"/>
                <button type="submit" id="btnGuardar" name="btnGuardar" value="1" onclick="validarForm(this.value);">
...
<div id="divFlotante2" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;" class="root">
	<div id="divFlotanteTitulo2" class="handle"><table><tr><td id="tdFlotanteTitulo2" width="50%"></td></tr></table></div>
    
    <div id="tblListaEmpresa" style="max-height:500px; overflow:auto; width:760px;">
        <table border="0" width="100%">
        <tr>
            <td>
...
<!--Listad de Colores-->
<div id="divFlotante3" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;" class="root">
	<div id="divFlotanteTitulo3" class="handle"><table><tr><td id="tdFlotanteTitulo3" width="100%"></td><td><img class="close puntero" id="imgCerrarDivFlotante3" src="../img/iconos/cross.png" title="Cerrar"/></td></tr></table></div>
    
<form id="frmColor" name="frmColor" style="margin:0" onsubmit="return false;">
    <div id="tblColor" style="max-height:500px; overflow:auto; width:360px;">
        <table border="0" width="100%">
        <tr>
            <td>
                <div id="divListColor"></div>
            </td>
        </tr>
        <tr>
            <td align="right"><hr>
                <button type="button" id="btnCancelarColor" name="btnCancelarColor" class="close">Cerrar</button>
            </td>
        </tr>
    	</table>
	</div>
...
<script language="javascript">
	...
	xajax_listaModoIngreso(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
	xajax_listadoColor();

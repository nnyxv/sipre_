...
if(!(validaAcceso("crm_estatus_list"))) {
...
include("controladores/ac_crm_estatus_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Estatus</title>
	...
	function validarForm() {
		...
		&& validarCampo('lstEstatus','t','listaExceptCero') == true
			...
			xajax_guardarEstatus(xajax.getFormValues('frmEstatus'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
	...
	function validarEliminar(idEstatus){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarEstatus(idEstatus, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Estatus</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formEstatus(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarEstatus(xajax.getFormValues('frmBuscar'));"/>Buscar</button>
...
<div id="divFlotante" class="root" style="cursor:auto; display:none; left:0px; position:absolute; top:0px; z-index:0;">
	<div id="divFlotanteTitulo" class="handle"><table><tr><td id="tdFlotanteEstatus" width="100%"></td></tr></table></div>
    
<form id="frmEstatus" name="frmEstatus" style="margin:0" onsubmit="return false;">
    ...
    <tr align="left">
    	<td>
            ...
            <tr align="left">
            	...
            	<td id="tdLstPosicion">
                	<select id="lstPosicion" name="lstPosicion">
                    </select>
                </td>
            </tr>
            <tr align="left">
    ...
    <tr align="left">
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdEstatus" name="hddIdEstatus"/>
...
xajax_listadoEstatus(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>

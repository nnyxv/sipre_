...
if(!(validaAcceso("crm_titulo_list"))) {
...
include("controladores/ac_crm_titulo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Titulo</title>
	...
	function validarForm() {
		...
		&& validarCampo('txtNombreTitulo','t','') == true
		&& validarCampo('lstEstatus','t','listaExceptCero') == true
		) {
			xajax_guardarTitulo(xajax.getFormValues('frmTitulo'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
			validarCampo('txtIdEmpresa','t','');
			validarCampo('txtNombreTitulo','t','');
	...
	function validarEliminar(idTitulo){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarTitulo(idTitulo, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Titulo</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formTitulo(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarTitulo(xajax.getFormValues('frmBuscar'));"/> Buscar </button>
...
<form id="frmTitulo" name="frmTitulo" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td>
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtNombreTitulo" name="txtNombreTitulo"/></td>
            </tr>
            <tr align="left">
    ...
    <tr align="left">
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdTitulo" name="hddIdTitulo"/>
...
xajax_listadoTitulo(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');

...
if(!(validaAcceso("crm_puesto_list"))) {
...
include("controladores/ac_crm_puesto_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Puesto</title>
	...
	function validarForm() {
		...
		&& validarCampo('lstEstatus','t','listaExceptCero') == true
			...
			xajax_guardarPuesto(xajax.getFormValues('frmPuesto'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
	...
	function validarEliminar(idPuesto){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarPuesto(idPuesto, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Puesto</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formPuesto(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="button" id="btnBuscar" onclick="xajax_buscarPuesto(xajax.getFormValues('frmBuscar'));"> Buscar </button>
...
<form id="frmPuesto" name="frmPuesto" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdPuesto" name="hddIdPuesto"/>
...
xajax_listadoPuesto(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');

...
include("controladores/ac_crm_reporte_prospecto_list.php"); //contiene todas las funciones xajax
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        <table width="100%" border="0"> <!--tabla principa-->
            <tr><td class="tituloPaginaCrm">Reporte de Actividades Prospecto</td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
            	<td>
                	<table border="0" width="100%">
                    	<tr>
                            <td valign="top" align="left" width="46%">
                               <button type="button" onclick="xajax_exportarClienteActividad(xajax.getFormValues('frmBuscar'));" style="cursor:default">
                            	...
                            	<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
						                    ...
						                    <td id="tdlstTipoActividad" ></td>
						                    <td align="right" class="tituloCampo" width="80">Estatus:</td>
						                    <td>
                                        ...
                                        <tr colspan="4">
                                            ...
                                            <td>
                                            	Desde: <input id="textDesdeCreacion" name="textDesdeCreacion" class="inputHabilitado" value="<?php echo date("d-m-Y") ?>" style="width:26%; text-align:center" />
                                                Hasta: <input id="textHastaCreacion" name="textHastaCreacion" class="inputHabilitado" value="<?php echo date("d-m-Y") ?>" style="width:26%; text-align:center" />
                                            </td>
                                        </tr>
                                        <tr align="left" colspan="4">
                                            <td align="right" class="tituloCampo" width="120">Criterio</td>
                                            <td>
                                            	<input id="textCriterio" name="textCriterio" class="inputHabilitado" style="width:80%;" onblur="byId('btnBuscar').click();" />
                                            </td>
                                            <td align="right">
...
<script>
	...
	xajax_cargaLstActividad('<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
	...
	xajax_lstSeguimiento(0,"seg.id_seguimiento","ASC","<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|||"+"<?php echo date("Y-m-d"); ?>"+"|"+"<?php echo date("Y-m-d"); ?>|");

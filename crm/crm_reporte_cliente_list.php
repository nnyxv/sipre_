...
include("controladores/ac_crm_reporte_cliente_list.php"); //contiene todas las funciones xajax
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        <table width="100%" border="0"> <!--tabla principa-->
            <tr><td class="tituloPaginaCrm">Reporte por Cliente</td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
            	<td>
                            	...
                            	<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                                    <table border="0" width="100%">
                                        ...
                                        <tr align="left">
                                            ...
                                            <td>
                                            	<input id="textCriterio" name="textCriterio" class="inputHabilitado" style="width:74%; margin-right: 28px;" onblur="byId('btnBuscar').click();" />
                                            </td>
                                            <td> 
...
<script>
	...
	*/
    xajax_buscarSeguimiento(xajax.getFormValues('frmBuscar'));//jafm

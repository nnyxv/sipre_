...
if(!(validaAcceso("crm_motivo_rechazo_list"))) {
...
include("controladores/ac_crm_motivo_rechazo_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Motivo de Rechazo</title>
	...
	function validarForm() {
		...
		&& validarCampo('lstEstatus','t','listaExceptCero') == true
			...
			xajax_guardarMotivoRechazo(xajax.getFormValues('frmMotivoRechazo'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
	...
	function validarEliminar(idMotivoRechazo){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarMotivoRechazo(idMotivoRechazo, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Motivo de Rechazo</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formMotivoRechazo(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarMotivoRechazo(xajax.getFormValues('frmBuscar'));">Buscar</button>
...
<form id="frmMotivoRechazo" name="frmMotivoRechazo" style="margin:0" onsubmit="return false;">
    ...
    <tr align="left">
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdMotivoRechazo" name="hddIdMotivoRechazo"/>
...
xajax_listadoMotivoRechazo(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');

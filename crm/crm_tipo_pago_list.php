...
include("controladores/ac_crm_tipo_pago_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Tipo de Pago</title>
	...
	function validarForm() {
		if ( validarCampo('txtNombreTipoPago','t','') == true 
		&& validarCampo('lstEstatus','t','listaExceptCero') == true) {
			xajax_guardarTipoPago(xajax.getFormValues('frmTipoPago'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
			validarCampo('txtNombreTipoPago','t','');
			validarCampo('lstEstatus','t','listaExceptCero');
			
			alert("Debe introducio algun dato");
			return false;
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Tipo de Pago</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formTipoPago(this.id);">
...
<form id="frmTipoPago" name="frmTipoPago" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td>
            ...
            <tr align="left">
                ...
                <td><input type="text" id="txtNombreTipoPago" name="txtNombreTipoPago" size="40"/></td>
            </tr>
            <tr align="left">
    ...
    <tr>
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdTipoPago" name="hddIdTipoPago"/>
...
xajax_listadoTipoPago(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>

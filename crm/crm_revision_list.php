...
if(!(validaAcceso("crm_revision_list"))) {
...
include("controladores/ac_crm_revision_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Revision</title>
	...
	function validarForm() {
		...
		&& validarCampo('marca','t','listaExceptCero') == true
		&& validarCampo('cantidadMeses','t','listaExceptCero') == true
		&& validarCampo('rangoInicio','t','') == true
		&& validarCampo('rangoFin','t','') == true
		&& validarCampo('lstEstatus','t','listaExceptCero') == true) 
		{
			xajax_guardarRevision(xajax.getFormValues('frmRevision'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
			validarCampo('txtIdEmpresa','t','');
			validarCampo('marca','t','listaExceptCero');
			validarCampo('cantidadMeses','t','listaExceptCero');
		    validarCampo('rangoInicio','t','');
		    validarCampo('rangoFin','t','');
	...
	function validarEliminar(idRevision){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarRevision(idRevision, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Revisi&oacute;n</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_frmRevision(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="button" id="btnBuscar" onclick="xajax_buscarRevision(xajax.getFormValues('frmBuscar'));"> Buscar </button>
...
<form id="frmRevision" name="frmRevision" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td>
            ...
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Cantidad de meses:</td>
                <td><!--<input type="text" id="cantidadMeses" name="cantidadMeses" size="30"/>-->
                    <select id="cantidadMeses" name="cantidadMeses">
            ...
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Rango KM Inicio:</td>
            	<td><input type="text" id="rangoInicio" name="rangoInicio" size="30"/></td>
            </tr>
            <tr align="left">
            	<td align="right" class="tituloCampo"><span class="textoRojoNegrita">*</span>Rango KM Fin:</td>
            	<td><input type="text" id="rangoFin" name="rangoFin" size="30"/></td>
            </tr>
            <tr align="left">
    ...
    <tr>
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdRevision" name="hddIdRevision"/>
            <button type="submit" id="btnGuardar" name="btnGuardar" onclick="validarForm();"> Guardar </button>
            <button type="button" id="btnCancelar" name="btnCancelar" class="close" onclick="this.form.reset()">Cerrar</button>
        </td>
    </tr>
    </table>
</form>
...
xajax_listadoRevision(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');

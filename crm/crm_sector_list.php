...
if(!(validaAcceso("crm_sector_list"))) {
...
include("controladores/ac_crm_sector_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. CRM - Sector</title>
	...
	function validarForm() {
		...
		&& validarCampo('lstEstatus','t','listaExceptCero') == true
			...
			xajax_guardarSector(xajax.getFormValues('frmSector'), xajax.getFormValues('frmListaConfiguracion'));
		} else {
	...
	function validarEliminar(idSector){
		if (confirm('Seguro desea eliminar este registro?') == true) {
			xajax_eliminarSector(idSector, xajax.getFormValues('frmListaConfiguracion'));
		}
	}
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCrm">Sector</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    <a class="modalImg" id="aNuevo" rel="#divFlotante" onclick="xajax_formSector(this.id);">
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarSector(xajax.getFormValues('frmBuscar'));">Buscar </button>
...
<form id="frmSector" name="frmSector" style="margin:0" onsubmit="return false;">
    ...
    <tr>
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdSector" name="hddIdSector"/>
...
xajax_listadoSector(0,'','','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>

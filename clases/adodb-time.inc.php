...
if (!function_exists("adodb_date_test_strftime")) {
...
/**
	 Test Suite
*/
if (!function_exists("adodb_date_test")) {
...
*/
if (!function_exists("_adodb_is_leap_year")) {
...
*/
if (!function_exists("adodb_is_leap_year")) {
...
*/
if (!function_exists("adodb_year_digit_check")) {
...
if (!function_exists("adodb_get_gmt_diff_ts")) {
...
*/
if (!function_exists("adodb_get_gmt_diff")) {
...
*/
if (!function_exists("adodb_getdate")) {
...
if (!function_exists("adodb_validdate")) {
...
*/
if (!function_exists("_adodb_getdate")) {
...
/*
		if ($isphp5)
				...
				$dates .= sprintf('%s%04d',($gmt<0)?'+':'-',abs($gmt)/36); 
			break;*/
if (!function_exists("adodb_tz_offset")) {
...
*/
if (!function_exists("adodb_gmmktime")) {
...
if (!function_exists("adodb_mktime")) {
	function adodb_mktime($hr,$min,$sec=0,$mon=false,$day=false,$year=false,$is_dst=false,$is_gmt=false) {
		if (!defined('ADODB_TEST_DATES')) {
...
if (!function_exists("adodb_gmstrftime")) {

...
//require_once(RELATIVE_PATH.'fpdf2.php');
//require_once(RELATIVE_PATH.'htmltoolkit.php');

//////////////////////////////////////////////////////////////////////////////////////////////////////////////
if(!class_exists('FPDF2'))
{
...
function HTML2FPDF($orientation='P',$unit='mm',$format='A4',$lineheight=5)
{
...
//! @return An object (a class instance)
  ...
  $this->lineheight = $lineheight; // Related to FontSizePt == 11

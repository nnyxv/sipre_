...
function cargaLstEmpresa($idUsuario, $selId) {
	...
	while ($row = mysql_fetch_assoc($rs)) {
		...
		$html .= "<option ".$selected." value=\"".$row['id_empresa_reg']."\">".htmlentities($row['nombre_empresa'])."</option>";
	}
	$html .= "</select>";
...
function cargaLstEmpresaSucursal($idUsuario, $selId) {
	...
	while ($row = mysql_fetch_assoc($rs)) {
		...
		$html .= "<option ".$selected." value=\"".$row['id_empresa']."\">".htmlentities($row['nombre_empresa'])."</option>";
	}
	$html .= "</select>";
...
function cargaLstSucursal($idUsuario, $idEmpresa, $selId = "") {
	...
	while ($row = mysql_fetch_assoc($rs)) {
		...
		$html .= "<option ".$selected." value=\"".$row['id_empresa_reg']."\">".htmlentities($row['nombre_empresa_suc'])."</option>";
	}
	$html .= "</select>";

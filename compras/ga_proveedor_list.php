...
if (!(validaAcceso("ga_proveedor_list"))) {
...
include("controladores/ac_ga_proveedor_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Compras - Proveedores</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaCompras">Proveedores<br></td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
                ...
                <tr>
                    ...
                    <a class="modalImg" id="aNuevo" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblProveedor');">
                    	...
                    	<button type="button" onclick="xajax_exportarProveedor(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
                    </td>
                </tr>
                </table>

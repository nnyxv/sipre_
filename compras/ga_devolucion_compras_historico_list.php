...
include("controladores/ac_ga_devolucion_compras_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Compras - Histórico Devolución de Facturas de Compra</title>
    	...
    	function cargarAtributo(){/*COLOCAR EL ATRIBUTO TITEL*/
			...
			var fechaHasta = document.getElementById('txtFechaHasta').value;
				if( fechaDesde != "" && fechaHasta != "" ){
					var titulo = "Informe de devolución de compras desde: "+fechaDesde+" Hasta: "+fechaHasta;
				} else {
					var titulo = "Informe de devolución compras";
				}
...
<div id="divGeneralPorcentaje">
    ...
    <table border="0" width="100%">
        ...
        <tr>
        	<td class="tituloPaginaCompras">Histórico Devolución de Facturas de Compra</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                	...
                	<td align="right" class="tituloCampo" width="120">Nro. Nota/Control:</td>
                    <td><input type="text" id="txtNroNotaCredito" name="txtNroNotaCredito" autocomplete="off" onkeyup="byId('btnBuscar').click();" /></td>
				</tr>
                <tr align="left">
                	<td></td>
                    <td></td>
        ...
        <tr>
        	<td>
            	<div id="divListaNotaCredito" style="width:100%">
...
<script>
byId('txtNroNotaCredito').className = "inputHabilitado";
...
xajax_listaNotaCredito(0,'id_factura','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|||' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
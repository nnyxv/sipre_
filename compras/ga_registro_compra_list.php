        ...
        <tr class="noprint">
        	<td>
            	<table align="left" border="0">
                    <tr>
                        <td>
                            <button type="button" onclick="window.open('ga_registro_compra_form.php');" title="Nuevo Registro de Compra" style="cursor:default">
            ...
            <form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo" width="120">Fecha de Orden:</td>
...
xajax_listadoPedidosCompra(0, "fecha_orden", "DESC", '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||<?php echo date("01-m-Y");?>|<?php echo date(spanDateFormat);?>');

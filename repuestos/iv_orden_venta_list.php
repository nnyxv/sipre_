...
if(!(validaAcceso("iv_orden_venta_list"))) {
...
include("controladores/ac_iv_orden_venta_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Aprobación de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Aprobación de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/package_link.png"/></td><td>Detalle del Despacho</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/book_next.png"/></td><td>Aprobar / Desaprobar</td>
                            <td>&nbsp;</td>
...
xajax_listaPedidoVenta(0,'id_pedido_venta','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>
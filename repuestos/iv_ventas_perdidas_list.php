...
if(!(validaAcceso("iv_ventas_perdidas_list"))) {
...
include("controladores/ac_iv_ventas_perdidas_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Ventas Perdidas</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Ventas Perdidas</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                    	<button type="submit" id="btnBuscar" name="btnBuscar" onclick="xajax_buscarVentaPerdida(xajax.getFormValues('frmBuscar'));">Buscar</button>
...
xajax_listaVentaPerdida(0,'codigo_articulo','ASC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
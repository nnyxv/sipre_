...
if(!(validaAcceso("iv_vale_historico_list"))) {
...
include("controladores/ac_iv_vale_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Histórico de Vale Entrada y Salida</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Histórico de Vale Entrada y Salida</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo" width="120">Tipo Dcto.:</td>
                    <td>
                        <select id="lstTipoMovimiento" name="lstTipoMovimiento" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="2">Vale de Entrada</option>
                            <option value="4">Vale de Salida</option>
                        </select>
                    </td>
                	<td align="right" class="tituloCampo" width="120">Tipo de Vale:</td>
                    <td>
                    	<select id="lstTipoVale" name="lstTipoVale" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="1">De Entrada / Salida</option>
                            <option value="2">De Factura de CxC</option>
                            <option value="3">De Nota de Crédito de CxC</option>
                            <option value="4">De Movimiento Inter-Almacen</option>
                            <option value="5">De Ajuste de Inv. Físico</option>
                        </select>
                    </td>
				</tr>
                <tr align="left">
        ...
        <tr>
        	<td>
            	<div id="divListaVale" style="width:100%">
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Vale PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
xajax_cargaLstClaveMovimiento('lstClaveMovimiento', '0', '2,4');
</script>
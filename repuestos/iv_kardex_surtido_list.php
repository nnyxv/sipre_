...
if(!(validaAcceso("iv_kardex_surtido_list"))) {
...
include("controladores/ac_iv_kardex_surtido_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Kardex Surtido</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Kardex Surtido</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                	...
                	<td align="right" class="tituloCampo">Despachado a / Devuelto por:</td>
                    <td id="tdlstEmpleadoReciboDevuelto">
                    	<select id="lstEmpleadoReciboDevuelto" name="lstEmpleadoReciboDevuelto">
                        	<option value="-1">[ Seleccione ]</option>
                        </select>
                    </td>
				</tr>
                <tr align="left">
                    ...
                    <td>
                    	<button type="submit" id="btnBuscar" onclick="xajax_buscarKardexSurtido(xajax.getFormValues('frmBuscar'));">Buscar</button>
        ...
        <tr>
        	<td>
            <form id="frmListaKardexSurtido" name="frmListaKardexSurtido" style="margin:0">
            	<div id="divListaKardexSurtido" style="width:100%">
...
xajax_cargaLstEmpleado('','lstEmpleadoReciboDevuelto','tdlstEmpleadoReciboDevuelto');

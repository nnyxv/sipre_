...
if(!(validaAcceso("iv_devolucion_compra_list"))) {
...
include("controladores/ac_iv_devolucion_compra_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Devolución de Compra</title>
	...
	function validarFrmDcto() {
		...
		if (error == true) {
		 ...
		 function reconversionMonetaria(){			  
			var numFacturareconversion = document.getElementById('txtNumeroFactura').value;
			var idProv = document.getElementById('txtIdProv').value;
			var fecFacturareconversion = document.getElementById('txtFechaRegistroFactura').value;
			
			var confirmacion = confirm("¿Desea realizar la reconversión de la factura? Esta acción no se puede revertir");
				
			if (confirmacion == true){				
				mensaje = xajax_reconversion(numFacturareconversion,idProv,fecFacturareconversion);	
			}			
		 }
	</script>
</head>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Devolución de Compra</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
<form id="frmDcto" name="frmDcto" onsubmit="return false;" style="margin:0">
    ...
    <tr>
    	<td align="right"><hr>
            ...
            <button type="submit" id="btnGuardarDcto" name="btnGuardarDcto" onclick="reconversionMonetaria();"><img width="11px" src="../img/iconos/ico_cambio.png" >Reconversion</button>

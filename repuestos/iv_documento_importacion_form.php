...
if(!(validaAcceso("iv_documento_importacion_list","insertar"))) {
...
include("controladores/ac_iv_documento_importacion_form.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Registro de Documento de Importación</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Registro de Documento de Importación</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="right"><hr>
                ...
                <button type="button" id="btnCancelarFacturaGasto" name="btnCancelarFacturaGasto" onclick="window.open('iv_documento_importacion_list.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
            </td>
        </tr>
        </table>
	</div>

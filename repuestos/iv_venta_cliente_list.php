...
if(!(validaAcceso("iv_venta_cliente_list"))) {
...
include("controladores/ac_iv_venta_cliente_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Ventas por Cliente</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Ventas por Cliente</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

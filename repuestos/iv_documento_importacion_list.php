...
if(!(validaAcceso("iv_documento_importacion_list"))) {
...
include("controladores/ac_iv_documento_importacion_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Documentos de Importación Pendientes</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Documentos de Importación Pendientes</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('iv_documento_importacion_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
					</td>
                </tr>
                </table>
...
<form id="frmTotalDcto" name="frmTotalDcto" onsubmit="return false;" style="margin:0">
	...
	<div class="pane" style="max-height:520px; overflow:auto;">

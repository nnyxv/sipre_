...
if(!(validaAcceso("iv_venta_cliente_articulo_list"))) {
...
include("controladores/ac_iv_venta_cliente_articulo_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Ventas por Cliente (Artículo)</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Ventas por Cliente (Artículo)</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
xajax_cargaLstClaveMovimiento('lstClaveMovimiento', '0,1,2', '3');
</script>
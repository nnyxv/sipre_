...
if(!(validaAcceso("iv_pedido_compra_historico_list"))) {
...
include("controladores/ac_iv_pedido_compra_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Histórico de Pedidos de Compra</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Histórico de Pedidos de Compra</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
xajax_listaPedidoCompra(0, "id_pedido_compra", "DESC", '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>' + '|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
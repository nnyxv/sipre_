                ...
                <tr>
                	<td>
                        ...
                        if (validarCampo('lstAnalisisInv','t','lista') == true) {
                            ...
                            return false;
                        }"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button>
                        <button type="button" onclick="
                        if (validarCampo('lstAnalisisInv','t','lista') == true) {
                            ...
                            alert('Los campos señalados en rojo son requeridos');
                            return false;
                        }"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
				</tr>
				</table>

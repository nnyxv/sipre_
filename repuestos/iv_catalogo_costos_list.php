...
if(!(validaAcceso("iv_catalogo_costos_list"))) {
...
include("controladores/ac_iv_catalogo_costos_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Catálogo de Costos</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
            <td class="tituloPaginaRepuestos">Catálogo de Costos</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_exportarCostos(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td id="tdlstProveedor"></td>
                    <td align="right" class="tituloCampo" width="120">Tipo de Artículo:</td>
        ...
        <tr>
            <td>
            	<div id="divArticulos" style="width:100%"></div>
            </td>
        </tr>
        <tr>
        	<td>
...
xajax_cargaLstProveedor();
xajax_cargaLstTipoArticulo();
xajax_objetoCodigoDinamico('tdCodigoArt','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
xajax_listaCosto(0, "art.codigo_articulo", "ASC", '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
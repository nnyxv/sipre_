...
if(!(validaAcceso("iv_presupuesto_venta_list"))) {
...
include("controladores/ac_iv_presupuesto_venta_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Presupuestos de Venta</title>
    ...
    <script>
	function validarPresupuestoAnulado(idPresupuesto, hddIdItm) {
		if (confirm('¿Seguro desea Anular el Presupuesto?') == true) {
			byId('imgEditarPresupuesto' + hddIdItm).style.display = 'none';
			byId('imgImportarPresupuesto' + hddIdItm).style.display = 'none';
			byId('imgAnularPresupuesto' + hddIdItm).style.display = 'none';
			xajax_anularPresupuesto(idPresupuesto, hddIdItm, xajax.getFormValues('frmListaPedidoVenta'));
		}
	}
	</script>
</head>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Presupuestos de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('iv_presupuesto_venta_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusPedido" name="lstEstatusPedido" onchange="byId('btnBuscar').click();">
                            ...
                            <option selected="selected" value="0">Presupuesto</option>
                            <option value="1">Pedido Pendiente por Terminar</option>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/ico_verde.gif"/></td><td>Pedido</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_amarillo.gif"/></td><td>Pedido Pendiente por Terminar</td>
                            <td>&nbsp;</td>
                            <td><img src="../img/iconos/ico_rojo.gif"/></td><td>Presupuesto</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
xajax_listaPresupuestoVenta(0,'id_presupuesto_venta','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>||||'+byId('lstEstatusPedido').value);
</script>
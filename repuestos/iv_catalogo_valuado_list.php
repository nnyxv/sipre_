...
if(!(validaAcceso("iv_catalogo_valuado_list"))) {
...
include("controladores/ac_iv_catalogo_valuado_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Catálogo Valuado</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Catálogo Valuado</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_exportarCatalogoValuado(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
				</tr>
				</table>
        ...
        <tr>
        	<td>
            	<div id="divListaResumenCatalogoValuado" style="width:100%">
        ...
        <tr>
        	<td>
            	<div id="divListaCatalogoValuado" style="width:100%"></div>
            </td>
        </tr>
        </table>
    </div>

...
if(!(validaAcceso("iv_factura_venta_list"))) {
...
include("controladores/ac_iv_factura_venta_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Facturación de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Pedidos por Facturar</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

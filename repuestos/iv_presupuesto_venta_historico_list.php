...
if(!(validaAcceso("iv_presupuesto_venta_historico_list"))) {
...
include("controladores/ac_iv_presupuesto_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Histórico de Presupuestos de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Histórico de Presupuestos de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusPedido" name="lstEstatusPedido">
                            ...
                            <!--<option value="00">Presupuesto</option>-->
                            <option value="22">Presupuesto Anulado</option>
                            <option value="0">Pedido Pendiente por Terminar</option>
                            <option value="1">Pedido</option>
                            <option value="2">Pedido Aprobado</option>
                            <option value="3">Factura</option>
                            <option value="4">Factura (Con Devolución)</option>

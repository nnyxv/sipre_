...
<head>
    ...
    function verificarImpresion() {
        if (confirm('Desea salir de la impresion del Pedido?')) {
...
<center>
    ...
    <tr>
        <td colspan="2"><iframe src="<?php echo sprintf("reportes/iv_pedido_compra_pdf.php?valBusq=%s", $_GET['valBusq']);?>" width="100%" height="1120" ></iframe></td>
    </tr>
    </table>
</center>
</body>

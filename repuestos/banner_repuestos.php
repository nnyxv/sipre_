...
if ($ResultConfig12[0] != true && strlen($ResultConfig12[1]) > 0) {
	die ($ResultConfig12[1]);
} else if ($ResultConfig12[0] == true) {
	$ResultConfig12 = $ResultConfig12[1];
}

switch($ResultConfig12) {
	case 1 : $class = "divMsjError"; break;
	case 2 : $class = "divMsjInfo"; break;
	case 3 : $class = "divMsjAlerta"; break;
}
$arrayMetodoCosto = array(1 => "Reposición", 2 => "Costo Promedio", 3 => "FIFO");
$_SESSION['idMetodoCosto'] = $ResultConfig12;
?>

<link rel="stylesheet" href="../js/styleDropdownMenuRepuestos.css" type="text/css" />
...
<tr>
	<td style="border-radius:6px;" background="../img/repuestos/header.gif">
<ul class="menu" id="menu">
	<li><a href="../index2.php" class="menulink"><table cellpadding="0" cellspacing="0" width="100%"><tr><td><img src="../img/repuestos/resultset_next.png"></td><td>&nbsp;</td><td width="100%"><?php echo utf8_encode("Menú ERP"); ?></td></tr></table></a></li>
<?php
...
while ($rowModulo = mysql_fetch_assoc($rsModulo)) {
	...
	while ($rowMenu2 = mysql_fetch_assoc($rsMenu2)) {
		...
		if ($totalRowsMenu3 > 0) {
			echo "<li><a href=\"#\" class=\"menulink\"><table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td><img src=\"../img/repuestos/resultset_next.png\"></td><td>&nbsp;</td><td width=\"100%\">".utf8_encode($rowMenu2['nombre'])."</td></tr></table></a>";
				echo "<ul>";
...
<tr>
	<td class="<?php echo $class;?>" height="24"><?php echo utf8_encode("Método: ".$arrayMetodoCosto[$_SESSION['idMetodoCosto']]); ?></td>
</tr>
</table>

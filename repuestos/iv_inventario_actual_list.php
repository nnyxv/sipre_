...
if(!(validaAcceso("iv_inventario_actual_list"))) {
...
include("controladores/ac_iv_inventario_actual_list.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Inventario Actual</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Inventario Actual</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_exportarInventarioActual(xajax.getFormValues('frmBuscar'));"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
				</tr>
				</table>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td colspan="3">
                        <select multiple id="lstSaldos" name="lstSaldos" onchange="byId('btnBuscar').click();">
                            ...
                            <option value="4">Espera por Facturar</option>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<button type="submit" id="btnBuscar" onclick="xajax_buscarInventarioActual(xajax.getFormValues('frmBuscar'));">Buscar</button>
        ...
        <tr>
        	<td>
            <form id="frmListaInventarioActual" name="frmListaInventarioActual" style="margin:0">
            	<div id="divListaInventarioActual" style="width:100%">
...
xajax_listaInventarioActual(0, 'CONCAT(descripcion_almacen, ubicacion, id_articulo_costo)', 'ASC', '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');
</script>
...
if(!(validaAcceso("iv_orden_venta_historico_list"))) {
...
include("controladores/ac_iv_orden_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Historico de Aprobación de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Historico de Aprobación de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
                ...
                <tr align="left">
                    ...
                    <td>
                    	<select id="lstEstatusPedido" name="lstEstatusPedido">
                            ...
                            <!--<option value="0">Pendiente por Terminar</option>
        ...
        <tr>
        	<td>
            	<div id="divListadoPedidoVenta" style="width:100%">
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Orden Venta PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>

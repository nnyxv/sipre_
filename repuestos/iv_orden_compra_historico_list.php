...
if(!(validaAcceso("iv_orden_compra_historico_list"))) {
...
include("controladores/ac_iv_orden_compra_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Histórico de Ordenes de Compra</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Histórico de Ordenes de Compra</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_encabezadoEmpresa($('lstEmpresa').value); window.print();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/ico_print.png"/></td><td>&nbsp;</td><td>Imprimir</td></tr></table></button>
                    </td>
                </tr>
                </table>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select id="lstEstadoPedidoCompra" name="lstEstadoPedidoCompra" onchange="byId('btnBuscar').click();">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="0">Convertido a Pedido Pendiente por Terminar</option>
                            <option value="1">Convertido a Pedido</option>
                            <option value="2">Convertido a Orden</option>
                            <option value="3">Compra Registrada</option>
                            <option value="4">Compra Registrada (Con Devolución)</option>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Orden Compra PDF</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
byId('lstEstadoPedidoCompra').className = "inputHabilitado";
...
xajax_listaPedidoCompra(0, "id_orden_compra", "DESC", '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>' + '|' + byId('txtFechaDesde').value + '|' + byId('txtFechaHasta').value);
</script>
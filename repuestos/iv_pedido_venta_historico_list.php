...
if(!(validaAcceso("iv_pedido_venta_historico_list"))) {
...
include("controladores/ac_iv_pedido_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Histórico de Pedidos de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Histórico de Pedidos de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
							<td><img src="../img/iconos/ico_marron.gif"/></td><td>Anulada</td>
                            <td>&nbsp;</td>

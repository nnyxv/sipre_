...
if(!(validaAcceso("iv_devolucion_venta_list"))) {
...
include("controladores/ac_iv_devolucion_venta_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Repuestos - Devolución de Venta</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaRepuestos">Devolución de Venta</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/arrow_rotate_clockwise.png" /></td><td>Crear Nota de Crédito</td>
                        </tr>
                        </table>
                    </td>
				</tr>

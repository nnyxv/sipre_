...
if(!(validaAcceso("iv_ajuste_inventario_list"))) {
...
include("controladores/ac_iv_ajuste_inventario_list.php");
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="window.open('iv_ajuste_inventario_form.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
        ...
        <tr>
        	<td><div id="divListaVale" style="width:100%"></div></td>
        </tr>
        </table>
    </div>
...
xajax_listaVale(0,'CONCAT(CONVERT(id_vale, CHAR), CONVERT(tipo_documento, CHAR), numeracion_vale)','DESC','<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>|'+byId('txtFechaDesde').value+'|'+byId('txtFechaHasta').value);
</script>
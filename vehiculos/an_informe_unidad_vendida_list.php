...
if(!(validaAcceso("an_informe_unidad_vendida_list"))) {
...
include("controladores/ac_an_informe_unidad_vendida_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Informe Unidades Vendidas</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Informe Unidades Vendidas</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                    <td>
                    	<button type="button" onclick="xajax_exportarUnidadVendida(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>
					</td>
                </tr>
                </table>
            ...
            <form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <select id="lstEstadoFactura" name="lstEstadoFactura">
                            <option value="-1">[ Seleccione ]</option>
                            <option value="NO">Facturado</option>
                            <option value="SI">Factura (Con Devolución)</option>
                        </select>
                    </td>
                    <td align="right" class="tituloCampo" width="120">Facturado:</td>
                    <td>
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarUnidadVendida(xajax.getFormValues('frmBuscar'));">Buscar</button>
        	...
        	<td>
				...
				<tr>
					...
					<td align="center">
                    	<table>
                        <tr>
                            <td><img src="../img/iconos/page_white_acrobat.png"/></td><td>Movimiento Contable</td>
                        </tr>
                        </table>
                    </td>
				</tr>
...
/*xajax_listaUnidadVendida(0, 'CONCAT(vw_iv_modelo.nom_uni_bas, vw_iv_modelo.nom_modelo, vw_iv_modelo.nom_version)', 'ASC', '<?php echo $_SESSION['idEmpresaUsuarioSysGts']; ?>');*/
</script>
...
include("controladores/ac_an_pedido_venta_form_f.php");
            ...
            <form id="frmDcto" name="frmDcto" onsubmit="return false;" style="margin:0">
                ...
                <tr id="trFieldsetUnidadFisica">
                    ...
                    <fieldset><legend class="legend">Unidad Física</legend>
                        ...
                        <tr align="left">
                        	...
                        	<td> <input type="text" id="txtSerialCarroceria" name="txtSerialCarroceria" readonly="readonly"/></td>
                ...
                <tr id="trFieldsetVehiculoUsado">
                    ...
                    <fieldset id="fieldsetVehiculoUsado"><legend class="legend">Vehículo Usado Tomado a Cambio</legend>
                        ...
                        <tr id="trAgregarTradeIn" align="left">
                            ...
                            <a class="modalImg" id="aAgregarTradeIn" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblListaTradeIn');">
                                <button type="button" title="Agregar Trade-In"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/add.png"/></td><td>&nbsp;</td><td>Agregar</td></tr></table></button>
                            </a>
                                <button type="button" id="btnQuitarTradeIn" name="btnQuitarTradeIn" onclick="xajax_eliminarTradeIn(xajax.getFormValues('frmTotalDcto'));" title="Quitar Trade-In"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/delete.png"/></td><td>&nbsp;</td><td>Quitar</td></tr></table></button>
                            </td>
						</tr>
                    ...
                    <fieldset id="fieldsetFormaPago"><legend class="legend">Forma de Pago</legend>
                        ...
                        <tr id="trAgregarFormaPago" align="left">
                            ...
                            <a class="modalImg" id="aAgregarFormaPago" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblListaFormaPago');">
                                <button type="button" title="Agregar Forma de Pago"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/add.png"/></td><td>&nbsp;</td><td>Agregar</td></tr></table></button>
                            </a>
                                <button type="button" id="btnQuitarFormaPago" name="btnQuitarFormaPago" onclick="xajax_eliminarFormaPago(xajax.getFormValues('frmTotalDcto'));" title="Quitar Forma de Pago"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/delete.png"/></td><td>&nbsp;</td><td>Quitar</td></tr></table></button>
                            </td>
						</tr>
                        <tr align="right">
                        	<td class="tituloCampo"><?php echo $spanAnticipo; ?> de Adicionales:</td>
                            <td></td>
                            <td id="tdMontoAnticipoMoneda"></td>
                            <td><input type="text" id="txtMontoAnticipo" name="txtMontoAnticipo" class="inputSinFondo" readonly="readonly" style="text-align:right;"/></td>
                        </tr>
                        <tr align="right">
                            <td class="tituloCampo" nowrap="nowrap" width="26%"><?php echo $spanInicial; ?> de la Unidad:
                            ...
                            <td id="tdMontoInicialMoneda" width="6%"></td>
                            <td width="34%">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr align="right">
                                    <td valign="top">
                    ...
                    <fieldset><legend class="legend">Contrato a Pagarse de acuedo con</legend>
                            ...
                            <td colspan="3">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td><label id="lblSinBancoFinanciar"><input type="checkbox" id="cbxSinBancoFinanciar" name="cbxSinBancoFinanciar" onclick="xajax_asignarSinBancoFinanciar(xajax.getFormValues('frmDcto'));" value="1"/><?php echo $spanPedidoVentaSinBanco; ?></label></td>
                                            <td>&nbsp;</td>
                                            <td>
                        ...
                        <tr align="right" class="trResaltar5">
                            <td id="tdFinanciamiento" class="tituloCampo" width="26%">Financiamiento:</td>
                            <td id="capameses_financiar" width="34%"></td>
                            <td id="tdCuotasFinanciarMoneda" width="6%"></td>
                            <td id="tdtxtCuotasFinanciar" width="34%"></td>
                        </tr>
                        <tr id="trCuotasFinanciar2" align="right" class="trResaltar4" style="display:none">
                            ...
                            <td id="tdtxtCuotasFinanciar2"></td>
                        </tr>
                        <tr id="trCuotasFinanciar3" align="right" class="trResaltar5" style="display:none">
                            ...
                            <td id="tdtxtCuotasFinanciar3"></td>
                        </tr>
                        <tr id="trCuotasFinanciar4" align="right" class="trResaltar4" style="display:none">
                            ...
                            <td id="tdtxtCuotasFinanciar4"></td>
                        </tr>
                    ...
                    <fieldset id="fieldsetVentaUnidad"><legend class="legend">Venta de la Unidad</legend>
                    	<table border="0" width="100%">
                        <tr align="right">
                            <td class="tituloCampo" width="26%">Precio Base:</td>
                            <td width="34%"></td>
                    ...
                    <fieldset><legend class="legend">Venta de Adicionales</legend>
                    	<table border="0" width="100%">
                        <tr id="trAgregarAdicional" align="left">
                            ...
                            <a class="modalImg" id="aAgregarAdicional" rel="#divFlotante1" onclick="abrirDivFlotante1(this, 'tblListaAdicional');">
                                ...
                                <button type="button" id="btnQuitarAdicional" name="btnQuitarAdicional" onclick="xajax_eliminarAdicionalLote(xajax.getFormValues('frmDcto'));" title="Quitar Adicional"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/delete.png"/></td><td>&nbsp;</td><td>Quitar</td></tr></table></button>
                            </td>
						</tr>
                        <tr id="trItemAdicional" align="left" class="tituloColumna">
                        ...
                        <tr id="trItmPieAdicional" align="right" class="trResaltarTotal">
                            <td class="tituloCampo" colspan="3">Total Adicional:</td>
                            <td><input type="text" id="txtTotalAdicional" name="txtTotalAdicional" class="inputSinFondo" readonly="readonly" style="text-align:right"/></td>
                        </tr>
                        <tr align="right" class="trResaltarTotal">
                        	<td class="tituloCampo" colspan="3">Total Otros Adicionales:</td>
                ...
                <tr id="trBtnGuardar">
                    <td align="right" colspan="2"><hr>
                        ...
                        <button type="button" id="btnCancelar" name="btnCancelar" onclick="window.open('an_pedido_venta_list.php','_self');"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/cancel.png"/></td><td>&nbsp;</td><td>Cancelar</td></tr></table></button>
                    </td>
                </tr>
                </table>
            </form>
...
xajax_cargarDcto('<?php echo $_GET['id']; ?>','<?php echo $_GET['idFactura']; ?>','<?php echo $_GET['txtIdEmpresa']; ?>','<?php echo $_GET['idPresupuesto']; ?>','<?php echo $_GET['txtBuscarPresupuesto']; ?>','<?php echo $_GET['vw']; ?>');

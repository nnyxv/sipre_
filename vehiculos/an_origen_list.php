...
if(!(validaAcceso("an_origen_list"))) {
...
include("controladores/ac_an_origen_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Origen</title>
	...
	function validarForm() {
		...
		&& validarCampo('txtDescripcion','t','') == true) {
			xajax_guardarOrigen(xajax.getFormValues('frmOrigen'), xajax.getFormValues('frmListaOrigen'));
		} else {
	...
	function validarEliminar(idOrigen){
		if (confirm('¿Seguro desea eliminar este registro?') == true) {
			xajax_eliminarOrigen(idOrigen, xajax.getFormValues('frmListaOrigen'));
		}
	}
	</script>
</head>
...
<div id="divGeneralVehiculos">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Origen</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
        	<td>
                ...
                <tr>
                	<td>
                    	<button type="button" onclick="xajax_formOrigen();" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td><img src="../img/iconos/ico_new.png"/></td><td>&nbsp;</td><td>Nuevo</td></tr></table></button>
                    </td>
                </tr>
                </table>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <input type="submit" id="btnBuscar" onclick="xajax_buscarOrigen(xajax.getFormValues('frmBuscar'));" value="Buscar"/>
        ...
        <tr>
        	<td>
            <form id="frmListaOrigen" name="frmListaOrigen" style="margin:0">
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td id="tdListaOrigen"></td>
                </tr>
                </table>
            </form>
            </td>
...
<form id="frmOrigen" name="frmOrigen" onsubmit="return false;" style="margin:0">
    <table border="0" id="tblOrigen" width="450px">
    <tr>
    	<td>
        	<table width="100%">
            <tr>
    ...
    <tr>
    	<td align="right">
	        <hr>
            <input type="hidden" id="hddIdOrigen" name="hddIdOrigen"/>

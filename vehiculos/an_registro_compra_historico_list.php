...
if(!(validaAcceso("an_registro_compra_historico_list"))) {
...
include("controladores/ac_an_registro_compra_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Histórico de Registro de Compra</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Histórico de Registro de Compra</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarRegistroCompra(xajax.getFormValues('frmBuscar'));">Buscar</button>
...
<form id="frmImportacion" name="frmImportacion" onsubmit="return false;" style="margin:0">
    ...
    <table border="0" id="tblImportacion" width="960">
    <tr>
    	<td>
        	<!-- the tabs -->
            <ul class="tabs">

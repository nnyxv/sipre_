...
function editarAccesorio($nomObjeto, $idAccesorio) {
	...
	if (xvalidaAcceso($objResponse,"an_combo_accesorios_list","editar")) {
		...
		byId('txtCodigo').className = 'inputInicial';
		byId('txtDescripcion').className = 'inputInicial';
		byId('lstPoseeIva').className = 'inputInicial';
		byId('txtPrecio').className = 'inputInicial';
		byId('lstGeneraComision').className = 'inputInicial';");

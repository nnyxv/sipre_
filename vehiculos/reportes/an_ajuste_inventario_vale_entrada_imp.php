...
include("ac_an_ajuste_inventario_vale_entrada_imp.php");
...
<head>
	...
	<title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Vale de Entrada</title>
...
<tr>
	<td align="center">VALE DE ENTRADA</td>
</tr>
<tr>
	<td>
        ...
        <tr>
            ...
            <td width="14%"></td>
            <td width="10%"></td>
            <td align="right" width="20%">NRO. V. ENTRADA:</td>
            <td align="left" id="tdIdValeEntrada" width="14%"></td>
        </tr>
        <tr>
            <td colspan="4"></td>
...
<script>
xajax_cargarValeEntrada('<?php echo $_GET['id']; ?>');
</script>
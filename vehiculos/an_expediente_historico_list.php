...
if(!(validaAcceso("an_expediente_historico_list"))) {
...
include("controladores/ac_an_expediente_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Histórico de Expedientes de Importación</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Histórico de Expedientes de Importación</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
<form id="frmExpediente" name="frmExpediente" onsubmit="return false;" style="margin:0">
	...
	<div class="pane" style="max-height:500px; overflow:auto; width:960px;">
        <table border="0" id="tblExpediente" width="100%">
        <tr>
        	<td>
            	<table width="100%">
                <tr align="left">

...
if(!validaAcceso("an_devolucion_venta_historico_list")) {
...
include("controladores/ac_an_devolucion_venta_historico_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Histórico de Notas de Crédito</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Histórico de Notas de Crédito</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
        <tr>
			...
			<form id="frmBuscar" name="frmBuscar" onsubmit="return false;" style="margin:0">
                ...
                <tr align="left">
                    <td align="right" class="tituloCampo">Devuelto:</td>
                    <td>
                    ...
                    <td>
                        <button type="submit" id="btnBuscar" onclick="xajax_buscarDevolucionVenta(xajax.getFormValues('frmBuscar'));">Buscar</button>
        ...
        <tr>
        	<td>
            	<div id="divListaDevolucionVenta" style="width:100%">

...
if(!(validaAcceso("an_estadistico_compra_venta_list"))) {
...
include("controladores/ac_an_estadistico_compra_venta_list.php");
...
<head>
    ...
    <title>.: SIPRE <?php echo cVERSION; ?> :. Vehículos - Estadístico de Compras y Ventas</title>
...
<div id="divGeneralPorcentaje">
    ...
    <div id="divInfo" class="print">
        ...
        <tr>
        	<td class="tituloPaginaVehiculos">Estadístico de Compras y Ventas</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>

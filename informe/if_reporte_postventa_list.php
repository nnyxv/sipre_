...
if(!(validaAcceso("if_reporte_postventa_list"))) {
...
include("controladores/ac_if_reporte_postventa_list.php");
...
<head>
	...
	function abrirDivFlotante1(nomObjeto, verTabla, valor, valor2, valor3, valor4, valor5, valor6, valor7, valor8) {
		...
		function soberano(){
			...
			alert('El Reporte de Pos venta En Bolibares Fuerte Esta Hasta el 20 de Agosto del 2018')
...
<div>
    ...
    <div id="divInfo" style="text-align:center">
        ...
        <tr>
        	<td class="tituloPaginaInforme">Reporte de Post-Venta</td>
        </tr>
        <tr>
            <td>
            <form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr>
                    <td>
                    	...
                    	<!--<button type="button" onclick="xajax_exportarReporte(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>-->
					</td>
				</tr>
				</table>
        	...
        	<td>
                ...
                <tr>
                	<td>
                        ...
                        <form id="divListaReporteServicios" class="form-3"></form>
                        <form id="divListaReporteMostrador" class="form-3"></form>
                        <form id="divListaReporteLatoneriaPintura" class="form-3"></form>
                        <form id="divListaReporteTotalFacturacion" class="form-3"></form>
                        <form id="divListaReporteInventario" class="form-3"></form>
                        <form id="divListaReporteMargenes" class="form-3"></form>
                    </td>
                </tr>
                </table>
            </td>
...
byId('txtFecha').value = "<?php echo date("Y")?>";

window.onload = function(){
	jQuery(function($){
	   $("#txtFecha").maskInput("<?php echo "9999"; ?>",{placeholder:" "});
	});
	
	new JsDatePick({
		useMode:2,
		target:"txtFecha",
		dateFormat:"<?php echo "%Y"; ?>"
	});
};

...
include("controladores/ac_if_resumen_postventa_list.php");
...
<div>
    ...
    <div id="divInfo" style="text-align:center">
        ...
        <tr>
        	<td class="tituloPaginaInforme">Resumen de Post-Venta</td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                    <td>
                        ...
                        <tr><td id="tdlstDecimalPDF"></td></tr>
                    	 ...
                    	 <!--<button type="button" onclick="xajax_exportarResumen(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>-->
					</td>
				</tr>
				</table>
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td style="padding-right:4px;" valign="top" width="60%">
                        <form id="divListaTotalFacturacion" class="form-3"></form>
                        <form id="divListaProduccionTaller" class="form-3"></form>
                        <form id="divListaProduccionOtros" class="form-3"></form>
                        <form id="divListaProduccionRepuestos" class="form-3"></form>
                        <form id="divListaMargenRepuestosServiciosMostrador" class="form-3"></form>
                        <form id="divListaAnalisisInv" class="form-3"></form>
                        <form id="divListaCantidadVendida" class="form-3"></form>
                        <form id="divListaIndicadoresTaller" class="form-3"></form>
					</td>
        			<td style="padding-right:4px;" valign="top" width="40%">
                        <div id="divMsjCierre"></div>
                        <form id="divListaFacturacionAsesoresServicios" class="form-3"></form>
                        <form id="divListaFacturacionVendedorRepuestos" class="form-3"></form>
                        <form id="divListaFacturacionTecnicosServicios" class="form-3"></form>
                        <form id="divListaComprasRepuestos" class="form-3"></form>
                        <form id="divListaVentasRepuestos" class="form-3"></form>
                        <form id="divListaVentasServicios" class="form-3"></form>
					</td>
                </tr>
                </table>
            </td>

...
<head>
    ...
    function ver($frmBuscar, $frmBuscarCuenta, $idCuentas){

        //alert(validarCampo('txtFecha','t',''));


                if (validarCampo('txtFecha','t','') == false) {


                             alert("El Campo Fecha No Puede Estar Vacio, o no cumplen con el formato establecido");
            ...
            xajax_imprimirComisionesResumen($frmBuscar, $frmBuscarCuenta, $idCuentas);
        ...
        <tr>
            <td align="right">
                <form id="frmBuscarCuenta" name="frmBuscarCuenta" onsubmit="return false;" style="margin:0px">
                    <table border="0">
                        <tr>
                            <td class="tituloCampo" align="right">BUSCAR POR FECHA:</td>

...
if(!(validaAcceso("if_reporte_venta_list"))) {
...
include("controladores/ac_if_reporte_venta_list.php");
...
<head>
	...
	function soberano(){
		...
		var fecha1 = '01-'+byId('txtFecha').value;

		var fecha2 = '01-08-2018';
		f1=new Date(fecha1);
	    f2=new Date(fecha2);

		if (f1> f2) {

			alert('El Reporte en bolivares Fuertes es hasta la fecha 20 de  Agosto del 2018');
		}else{
...
<div>
    ...
    <div id="divInfo" style="text-align:center">
        ...
        <tr>
        	<td class="tituloPaginaInforme">Reporte de Venta</td>
        </tr>
        <tr>
            <td>
            <form id="frmBuscar" name="frmBuscar" style="margin:0" onsubmit="return false;">
                ...
                <tr>
                    <td>
                        ...
                        <tr><td><button type="button" onclick="xajax_cargaLstDecimalPDF();"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_white_acrobat.png"/></td><td>&nbsp;</td><td>PDF</td></tr></table></button></td></tr>
                        <tr><td id="tdlstDecimalPDF"></td></tr>
                        </table>
                    	<!--<button type="button" onclick="xajax_exportarReporteVenta(xajax.getFormValues('frmBuscar'));" style="cursor:default"><table align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td><td><img src="../img/iconos/page_excel.png"/></td><td>&nbsp;</td><td>XLS</td></tr></table></button>-->
					</td>
				</tr>
				</table>
                ...
                <tr align="left">
                    ...
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button type="submit" id="btnBuscar" onclick= "soberano();"> Bolivares Fuertes</button>
                    </td>
                     <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button type="submit" id="btnBuscar" onclick="xajax_buscar(xajax.getFormValues('frmBuscar'), 1);"> Bolivares Soberano</button>
                    </td>
                </tr>
                </table>
            </form>
        	...
        	<td>
                ...
                <tr>
                	<td style="padding-right:4px;" valign="top" width="50%">
                        <form id="divListaResumenMensual" class="form-3"></form>
						<form id="divListaVentaAsesor" class="form-3"></form>
                        <form id="divListaResumenAccesorios" class="form-3"></form>
                        <form id="divListaResumenAdicionales" class="form-3"></form>
                        <form id="divListaDetalleModelo" class="form-3"></form>
					</td>
        			<td style="padding-left:4px;" valign="top" width="50%">
                        <div id="divMsjCierre"></div>
                        <form id="divListaVentaEmpresa" class="form-3"></form>
                        <form id="divListaDetalleOperacionesCredito" class="form-3"></form>
						<form id="divListaDetalleOperacionesContado" class="form-3"></form>
                        <form id="divListaDetalleSeguros" class="form-3"></form>
					</td>
                </tr>
                </table>
            </td>

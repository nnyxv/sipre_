	...
	foreach ($arrayVentaMensual as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			$arrayFila = array(
				...
				round($arrayVentaMensual[$indice]['monto_facturado_vehiculo']/100000,2),
				round($arrayVentaMensual[$indice]['monto_facturado_vehiculo_acumulado']/100000,2),
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES//////////////////////////////////////////////////////////////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){			
	imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaMensual['monto_facturado_vehiculo']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaMensual['monto_facturado_vehiculo_acumulado']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
...
if (isset($arrayVentaAsesor)) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){								
			imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaAsesor['monto_facturado_vehiculo']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaAsesor['monto_facturado_vehiculo_acumulado']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
...
if (isset($arrayVentaAccesorio)) {
	...
	foreach ($arrayVentaAccesorio as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			...
			round($arrayVentaAccesorio[$indice][1]/100000,2),
			round($arrayVentaAccesorio[$indice][2]/100000,2));
		}else{		
			$arrayFila = array(
				($arrayVentaAccesorio[$indice][0]),
	...
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		...
		imagestring($img,1,170,$posY,str_pad(formatoNumero(round($arrayTotalVentaAccesorio[1]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,305,$posY,str_pad(formatoNumero(round($arrayTotalVentaAccesorio[2]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
if (isset($arrayVentaAdicional)) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES//////////////////////////////////////////////////////////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaAdicional['monto_facturado_accesorio']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaAdicional['monto_facturado_accesorio_acumulado']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}else{
	...
	foreach ($arrayVentaModelo as $indice => $valor) {
			...
			foreach ($arrayVentaModelo[$indice]['array_modelo'] as $indice2 => $valor2) {
				...
				if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){				
					$arrayFila = array(
						...
						round($valor2['monto_unidades_vendidas']/100000,2),
						round($valor2['monto_unidades_vendidas_acumulado']/100000,2),
						round($porcParticipacion,2));
				}else{
					$arrayFila = array(
						utf8_encode($valor2['vehiculo']),
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){		
			$arrayFila = array(
				...
				round($arrayVentaModelo[$indice]['monto_unidades_vendidas']/100000,2),
				round($arrayVentaModelo[$indice]['monto_unidades_vendidas_acumulado']/100000,2),
				round($porcParticipacion,2));
		}else{
			$arrayFila = array(
				utf8_encode($arrayVentaModelo[$indice]['condicion_unidad']),
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES//////////////////////////////////////////////////////////////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){		
	imagestring($img,1,520,$posY,str_pad(formatoNumero(round($arrayTotalVentaModelo['monto_unidades_vendidas']/100000,2), 1, $nroDecimales), 20, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,620,$posY,str_pad(formatoNumero(round($arrayTotalVentaModelo['monto_unidades_vendidas_acumulado']/100000,2), 1, $nroDecimales), 20, " ", STR_PAD_LEFT),$textColor);
}else{
...
if (isset($arrayVentaEmpresa)) {
	...
	foreach ($arrayVentaEmpresa as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			$arrayFila = array(
				...
				round($arrayVentaEmpresa[$indice]['monto_facturado_vehiculo']/100000,2),
				round($arrayVentaEmpresa[$indice]['monto_facturado_vehiculo_acumulado']/100000,2),
				round($porcParticipacion,2));
		}else{
			$arrayFila = array(
				utf8_encode($arrayVentaEmpresa[$indice]['condicion_unidad']),
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES/////////////////////////////////////////////////////////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){	
		imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaEmpresa['monto_facturado_vehiculo']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaEmpresa['monto_facturado_vehiculo_acumulado']/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}else{
...
if (isset($arrayVentaContado)) {
	...
	foreach ($arrayVentaContado as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			$arrayFila = array(
				...
				round($arrayVentaContado[$indice][3]/100000,2),
				round($arrayVentaContado[$indice][4]/100000,2));
		}else{
			$arrayFila = array(
				utf8_encode($arrayVentaContado[$indice][0]),
				round($arrayVentaContado[$indice][1],2),
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaContado[3]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaContado[4]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}else{
...
if (isset($arrayVentaCredito)) {
	...
	foreach ($arrayVentaCredito as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			$arrayFila = array(
				...
				round($arrayVentaCredito[$indice][3]/100000,2),
				round($arrayVentaCredito[$indice][4]/100000,2));
		}else{
			$arrayFila = array(
				utf8_encode($arrayVentaCredito[$indice][0]),
				round($arrayVentaCredito[$indice][1],2),
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalVentaCredito[3]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalVentaCredito[4]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}else{
...
if (isset($arraySeguros)) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){	
		imagestring($img,1,440,$posY,str_pad(formatoNumero(round($arrayTotalSeguros[3]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotalSeguros[4]/100000,2), 1, $nroDecimales), 26, " ", STR_PAD_LEFT),$textColor);
	}else{

...
for ($pageNum = 0; $pageNum <= $totalPages; $pageNum++) {
	...
	while ($rowComision = mysql_fetch_assoc($rsLimitComision)) {
		...
		//se agrega el siguiente filtro, según la fecha el reporte deberá mostrarse en miles, (fechas menores a agosto de 2018 debe entrar el filtro de miles = 1. En caso contrario, debe entrar en el else.
		if($miles == 1) {		
			$queryDetalle = sprintf("SELECT
				...
				(comision_emp.venta_bruta/100000) as venta_bruta,
				(comision_emp.monto_descuento/100000) as monto_descuento,
				((comision_emp.venta_bruta - comision_emp.monto_descuento)/100000) AS venta_neta,
				(comision_emp.costo_compra/100000) as costo_compra,
				
				((comision_emp.venta_bruta
					- comision_emp.monto_descuento
					- comision_emp.costo_compra)/100000) AS utilidad_bruta,
				...
				(comision_emp.monto_comision/100000) as monto_comision,
		...
		////////////////////////////////////////////////////////////////////////////////
		//////////////////////// PAGINA DE RESUMEN POR EMPLEADO, esta parte es la segunda hoja de cada vendedor ////////////////////////
		////////////////////////////////////////////////////////////////////////////////
		$subPage++;

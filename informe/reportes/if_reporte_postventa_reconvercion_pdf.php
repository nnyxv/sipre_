	...
	if (isset($arrayClasifInv)) {
		foreach ($arrayClasifInv as $indice => $valor) {
			...
			$queryDetalle = sprintf("SELECT
				...
				if ( cierre_mens.mes < 8 AND cierre_mens.ano <= 2018 ,
...
if (isset($arrayMOServ)) {
	foreach ($arrayMOServ as $indice => $valor) {
		...
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			...
			imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayMOServ[$indice][12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayMOServ[$indice])/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
		}else{//sin decimales
			imagestring($img,1,0,$posY,str_pad(strtoupper(substr($arrayMOServ[$indice][0],0,24)), 24, " ", STR_PAD_RIGHT),$textColor);
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayRepServ[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayRepServ[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayRepServ[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayRepServ[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayRepServ[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayRepServ[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayRepServ[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayRepServ[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayRepServ[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayRepServ[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayRepServ[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayRepServ[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayRepServ)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayTotServ[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayTotServ[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayTotServ[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayTotServ[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayTotServ[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayTotServ[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayTotServ[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotServ[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayTotServ[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayTotServ[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayTotServ[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayTotServ[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayTotServ)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
if ($rowConfig300['valor'] == 1) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayNotasServ[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayNotasServ[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayNotasServ[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayNotasServ[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayNotasServ[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayNotasServ[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayNotasServ[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayNotasServ[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayNotasServ[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayNotasServ[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayNotasServ[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayNotasServ[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
		imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayNotasServ)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
	}else{ //sin decimales
...
for ($mesCierre = 1; $mesCierre <= 12; $mesCierre++) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,$posX,$posY,str_pad(formatoNumero($totalServicios/100000, 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,$posX,$posY,str_pad(formatoNumero($totalTotalServicios/100000, 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
for ($mesCierre = 1; $mesCierre <= 12; $mesCierre++) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,$posX,$posY,str_pad(formatoNumero($arrayCostoRepServ[$mesCierre]/100000, 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,$posX,$posY,str_pad(formatoNumero(array_sum($arrayCostoRepServ)/100000, 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
for ($mesCierre = 1; $mesCierre <= 12; $mesCierre++) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,$posX,$posY,str_pad(formatoNumero(($arrayRepServ[$mesCierre] - $arrayCostoRepServ[$mesCierre])/100000, 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,$posX,$posY,str_pad(formatoNumero((array_sum($arrayRepServ) - array_sum($arrayCostoRepServ))/100000, 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
for ($mesCierre = 1; $mesCierre <= 12; $mesCierre++) {
	...
	//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
	if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
		imagestring($img,1,$posX,$posY,str_pad(formatoNumero($totalUtilidadBrutaDep/100000, 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,$posX,$posY,str_pad(formatoNumero($totalTotalUtilidadBrutaDep/100000, 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayRepMost[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayRepMost[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayRepMost[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayRepMost[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayRepMost[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayRepMost[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayRepMost[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayRepMost[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayRepMost[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayRepMost[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayRepMost[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayRepMost[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayRepMost)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayCostoRepMost[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayCostoRepMost)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round((($arrayRepMost[1] - $arrayCostoRepMost[1]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round((($arrayRepMost[2] - $arrayCostoRepMost[2]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round((($arrayRepMost[3] - $arrayCostoRepMost[3]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round((($arrayRepMost[4] - $arrayCostoRepMost[4]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round((($arrayRepMost[5] - $arrayCostoRepMost[5]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round((($arrayRepMost[6] - $arrayCostoRepMost[6]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round((($arrayRepMost[7] - $arrayCostoRepMost[7]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round((($arrayRepMost[8] - $arrayCostoRepMost[8]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round((($arrayRepMost[9] - $arrayCostoRepMost[9]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round((($arrayRepMost[10] - $arrayCostoRepMost[10]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round((($arrayRepMost[11] - $arrayCostoRepMost[11]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round((($arrayRepMost[12] - $arrayCostoRepMost[12]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(((array_sum($arrayRepMost) - array_sum($arrayCostoRepMost)))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
if (isset($arrayMOLatPint)) {
	foreach ($arrayMOLatPint as $indice => $valor) {
		...
		//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayMOLatPint[$indice][12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayMOLatPint[$indice])/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
		}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayRepLatPint[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayRepLatPint[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayRepLatPint[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayRepLatPint[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayRepLatPint[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayRepLatPint[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayRepLatPint[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayRepLatPint[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayRepLatPint[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayRepLatPint[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayRepLatPint[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayRepLatPint[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayRepLatPint)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayTotLatPint[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayTotLatPint[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayTotLatPint[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayTotLatPint[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayTotLatPint[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayTotLatPint[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayTotLatPint[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayTotLatPint[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayTotLatPint[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayTotLatPint[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayTotLatPint[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayTotLatPint[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayTotLatPint)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round((($totalMOLatPint[1] + $arrayRepLatPint[1] + $arrayTotLatPint[1]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round((($totalMOLatPint[2] + $arrayRepLatPint[2] + $arrayTotLatPint[2]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round((($totalMOLatPint[3] + $arrayRepLatPint[3] + $arrayTotLatPint[3]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round((($totalMOLatPint[4] + $arrayRepLatPint[4] + $arrayTotLatPint[4]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round((($totalMOLatPint[5] + $arrayRepLatPint[5] + $arrayTotLatPint[5]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round((($totalMOLatPint[6] + $arrayRepLatPint[6] + $arrayTotLatPint[6]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round((($totalMOLatPint[7] + $arrayRepLatPint[7] + $arrayTotLatPint[7]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round((($totalMOLatPint[8] + $arrayRepLatPint[8] + $arrayTotLatPint[8]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round((($totalMOLatPint[9] + $arrayRepLatPint[9] + $arrayTotLatPint[9]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round((($totalMOLatPint[10] + $arrayRepLatPint[10] + $arrayTotLatPint[10]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round((($totalMOLatPint[11] + $arrayRepLatPint[11] + $arrayTotLatPint[11]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round((($totalMOLatPint[12] + $arrayRepLatPint[12] + $arrayTotLatPint[12]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(((array_sum($totalMOLatPint) + array_sum($arrayRepLatPint) + array_sum($arrayTotLatPint)))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayCostoMOLatPint[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayCostoMOLatPint)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round((($totalMOLatPint[1] - $arrayCostoMOLatPint[1]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round((($totalMOLatPint[2] - $arrayCostoMOLatPint[2]))/1000000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round((($totalMOLatPint[3] - $arrayCostoMOLatPint[3]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round((($totalMOLatPint[4] - $arrayCostoMOLatPint[4]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round((($totalMOLatPint[5] - $arrayCostoMOLatPint[5]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round((($totalMOLatPint[6] - $arrayCostoMOLatPint[6]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round((($totalMOLatPint[7] - $arrayCostoMOLatPint[7]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round((($totalMOLatPint[8] - $arrayCostoMOLatPint[8]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round((($totalMOLatPint[9] - $arrayCostoMOLatPint[9]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round((($totalMOLatPint[10] - $arrayCostoMOLatPint[10]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round((($totalMOLatPint[11] - $arrayCostoMOLatPint[11]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round((($totalMOLatPint[12] - $arrayCostoMOLatPint[12]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(((array_sum($totalMOLatPint) - array_sum($arrayCostoMOLatPint)))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayCostoRepLatPint[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayCostoRepLatPint)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[1] - $arrayCostoRepLatPint[1]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[2] - $arrayCostoRepLatPint[2]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[3] - $arrayCostoRepLatPint[3]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[4] - $arrayCostoRepLatPint[4]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[5] - $arrayCostoRepLatPint[5]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[6] - $arrayCostoRepLatPint[6]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[7] - $arrayCostoRepLatPint[7]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[8] - $arrayCostoRepLatPint[8]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[9] - $arrayCostoRepLatPint[9]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[10] - $arrayCostoRepLatPint[10]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[11] - $arrayCostoRepLatPint[11]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round((($arrayRepLatPint[12] - $arrayCostoRepLatPint[12]))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(((array_sum($arrayRepLatPint) - array_sum($arrayCostoRepLatPint)))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round((($totalMOLatPint[1] + ($arrayRepLatPint[1] - $arrayCostoRepLatPint[1])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round((($totalMOLatPint[2] + ($arrayRepLatPint[2] - $arrayCostoRepLatPint[2])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round((($totalMOLatPint[3] + ($arrayRepLatPint[3] - $arrayCostoRepLatPint[3])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round((($totalMOLatPint[4] + ($arrayRepLatPint[4] - $arrayCostoRepLatPint[4])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round((($totalMOLatPint[5] + ($arrayRepLatPint[5] - $arrayCostoRepLatPint[5])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round((($totalMOLatPint[6] + ($arrayRepLatPint[6] - $arrayCostoRepLatPint[6])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round((($totalMOLatPint[7] + ($arrayRepLatPint[7] - $arrayCostoRepLatPint[7])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round((($totalMOLatPint[8] + ($arrayRepLatPint[8] - $arrayCostoRepLatPint[8])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round((($totalMOLatPint[9] + ($arrayRepLatPint[9] - $arrayCostoRepLatPint[9])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round((($totalMOLatPint[10] + ($arrayRepLatPint[10] - $arrayCostoRepLatPint[10])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round((($totalMOLatPint[11] + ($arrayRepLatPint[11] - $arrayCostoRepLatPint[11])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round((($totalMOLatPint[12] + ($arrayRepLatPint[12] - $arrayCostoRepLatPint[12])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(((array_sum($totalMOLatPint) + array_sum($arrayRepLatPint) - array_sum($arrayCostoRepLatPint)))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round(((($totalMOServ[1] + $arrayRepServ[1] + $arrayTotServ[1]) + $arrayRepMost[1] + ($totalMOLatPint[1] + $arrayRepLatPint[1] + $arrayTotLatPint[1])))/1000000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round(((($totalMOServ[2] + $arrayRepServ[2] + $arrayTotServ[2]) + $arrayRepMost[2] + ($totalMOLatPint[2] + $arrayRepLatPint[2] + $arrayTotLatPint[2])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round(((($totalMOServ[3] + $arrayRepServ[3] + $arrayTotServ[3]) + $arrayRepMost[3] + ($totalMOLatPint[3] + $arrayRepLatPint[3] + $arrayTotLatPint[3])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round(((($totalMOServ[4] + $arrayRepServ[4] + $arrayTotServ[4]) + $arrayRepMost[4] + ($totalMOLatPint[4] + $arrayRepLatPint[4] + $arrayTotLatPint[4])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round(((($totalMOServ[5] + $arrayRepServ[5] + $arrayTotServ[5]) + $arrayRepMost[5] + ($totalMOLatPint[5] + $arrayRepLatPint[5] + $arrayTotLatPint[5])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round(((($totalMOServ[6] + $arrayRepServ[6] + $arrayTotServ[6]) + $arrayRepMost[6] + ($totalMOLatPint[6] + $arrayRepLatPint[6] + $arrayTotLatPint[6])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round(((($totalMOServ[7] + $arrayRepServ[7] + $arrayTotServ[7]) + $arrayRepMost[7] + ($totalMOLatPint[7] + $arrayRepLatPint[7] + $arrayTotLatPint[7])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round(((($totalMOServ[8] + $arrayRepServ[8] + $arrayTotServ[8]) + $arrayRepMost[8] + ($totalMOLatPint[8] + $arrayRepLatPint[8] + $arrayTotLatPint[8])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round(((($totalMOServ[9] + $arrayRepServ[9] + $arrayTotServ[9]) + $arrayRepMost[9] + ($totalMOLatPint[9] + $arrayRepLatPint[9] + $arrayTotLatPint[9])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round(((($totalMOServ[10] + $arrayRepServ[10] + $arrayTotServ[10]) + $arrayRepMost[10] + ($totalMOLatPint[10] + $arrayRepLatPint[10] + $arrayTotLatPint[10])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round(((($totalMOServ[11] + $arrayRepServ[11] + $arrayTotServ[11]) + $arrayRepMost[11] + ($totalMOLatPint[11] + $arrayRepLatPint[11] + $arrayTotLatPint[11])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round(((($totalMOServ[12] + $arrayRepServ[12] + $arrayTotServ[12]) + $arrayRepMost[12] + ($totalMOLatPint[12] + $arrayRepLatPint[12] + $arrayTotLatPint[12])))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	...
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round((((array_sum($totalMOServ) + array_sum($arrayRepServ) + array_sum($arrayTotServ)) + array_sum($arrayRepMost) + (array_sum($totalMOLatPint) + array_sum($arrayRepLatPint) + array_sum($arrayTotLatPint))))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{// sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round(((($totalMOServ[1] + ($arrayRepServ[1] - $arrayCostoRepServ[1])) + ($arrayRepMost[1] - $arrayCostoRepMost[1]) + ($totalMOLatPint[1] + ($arrayRepLatPint[1] - $arrayCostoRepLatPint[1])))/100000),2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round(((($totalMOServ[2] + ($arrayRepServ[2] - $arrayCostoRepServ[2])) + ($arrayRepMost[2] - $arrayCostoRepMost[2]) + ($totalMOLatPint[2] + ($arrayRepLatPint[2] - $arrayCostoRepLatPint[2]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round(((($totalMOServ[3] + ($arrayRepServ[3] - $arrayCostoRepServ[3])) + ($arrayRepMost[3] - $arrayCostoRepMost[3]) + ($totalMOLatPint[3] + ($arrayRepLatPint[3] - $arrayCostoRepLatPint[3]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round(((($totalMOServ[4] + ($arrayRepServ[4] - $arrayCostoRepServ[4])) + ($arrayRepMost[4] - $arrayCostoRepMost[4]) + ($totalMOLatPint[4] + ($arrayRepLatPint[4] - $arrayCostoRepLatPint[4]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round(((($totalMOServ[5] + ($arrayRepServ[5] - $arrayCostoRepServ[5])) + ($arrayRepMost[5] - $arrayCostoRepMost[5]) + ($totalMOLatPint[5] + ($arrayRepLatPint[5] - $arrayCostoRepLatPint[5]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round(((($totalMOServ[6] + ($arrayRepServ[6] - $arrayCostoRepServ[6])) + ($arrayRepMost[6] - $arrayCostoRepMost[6]) + ($totalMOLatPint[6] + ($arrayRepLatPint[6] - $arrayCostoRepLatPint[6]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round(((($totalMOServ[7] + ($arrayRepServ[7] - $arrayCostoRepServ[7])) + ($arrayRepMost[7] - $arrayCostoRepMost[7]) + ($totalMOLatPint[7] + ($arrayRepLatPint[7] - $arrayCostoRepLatPint[7]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round(((($totalMOServ[8] + ($arrayRepServ[8] - $arrayCostoRepServ[8])) + ($arrayRepMost[8] - $arrayCostoRepMost[8]) + ($totalMOLatPint[8] + ($arrayRepLatPint[8] - $arrayCostoRepLatPint[8]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round(((($totalMOServ[9] + ($arrayRepServ[9] - $arrayCostoRepServ[9])) + ($arrayRepMost[9] - $arrayCostoRepMost[9]) + ($totalMOLatPint[9] + ($arrayRepLatPint[9] - $arrayCostoRepLatPint[9]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round(((($totalMOServ[10] + ($arrayRepServ[10] - $arrayCostoRepServ[10])) + ($arrayRepMost[10] - $arrayCostoRepMost[10]) + ($totalMOLatPint[10] + ($arrayRepLatPint[10] - $arrayCostoRepLatPint[10]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round(((($totalMOServ[11] + ($arrayRepServ[11] - $arrayCostoRepServ[11])) + ($arrayRepMost[11] - $arrayCostoRepMost[11]) + ($totalMOLatPint[11] + ($arrayRepLatPint[11] - $arrayCostoRepLatPint[11]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round(((($totalMOServ[12] + ($arrayRepServ[12] - $arrayCostoRepServ[12])) + ($arrayRepMost[12] - $arrayCostoRepMost[12]) + ($totalMOLatPint[12] + ($arrayRepLatPint[12] - $arrayCostoRepLatPint[12]))))/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round((((array_sum($totalMOServ) + (array_sum($arrayRepServ) - array_sum($arrayCostoRepServ))) + (array_sum($arrayRepMost) - array_sum($arrayCostoRepMost)) + (array_sum($totalMOLatPint) + (array_sum($arrayRepLatPint) - array_sum($arrayCostoRepLatPint)))))/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{ //sin decimales
...
if (isset($arrayClasifInv)) {
	foreach ($arrayClasifInv as $indice => $valor) {
		...
		//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
		if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
			imagestring($img,1,120,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,185,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,250,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,315,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,380,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,445,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,510,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,575,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,640,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,705,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,770,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,835,$posY,str_pad(formatoNumero(round($arrayClasifInv[$indice][12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
			imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($arrayClasifInv[$indice])/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
		}else{ // sin decimales
...
//Se agrega el filtro del reporte sin decimales o con ellos, pero expresados en MILES////
if(($_GET['lstDecimalPDF'] == 2)||($_GET['lstDecimalPDF'] == 3)){
	imagestring($img,1,120,$posY,str_pad(formatoNumero(round($totalClasifInv[1]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,185,$posY,str_pad(formatoNumero(round($totalClasifInv[2]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,250,$posY,str_pad(formatoNumero(round($totalClasifInv[3]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,315,$posY,str_pad(formatoNumero(round($totalClasifInv[4]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,380,$posY,str_pad(formatoNumero(round($totalClasifInv[5]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,445,$posY,str_pad(formatoNumero(round($totalClasifInv[6]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,510,$posY,str_pad(formatoNumero(round($totalClasifInv[7]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,575,$posY,str_pad(formatoNumero(round($totalClasifInv[8]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,640,$posY,str_pad(formatoNumero(round($totalClasifInv[9]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,705,$posY,str_pad(formatoNumero(round($totalClasifInv[10]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,770,$posY,str_pad(formatoNumero(round($totalClasifInv[11]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,835,$posY,str_pad(formatoNumero(round($totalClasifInv[12]/100000,2), 1, $nroDecimales), 13, " ", STR_PAD_LEFT),$textColor);
	imagestring($img,1,900,$posY,str_pad(formatoNumero(round(array_sum($totalClasifInv)/100000,2), 1, $nroDecimales), 15, " ", STR_PAD_LEFT),$textColor);
}else{

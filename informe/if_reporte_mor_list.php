...
/*if(!(validaAcceso("if_reporte_mor_list"))) {
...
include('modelos/md_if_reporte_mor.php');
include("controladores/ac_if_reporte_mor_list.php");
...
<div>
    ...
    <div id="divInfo" style="text-align:center">
        ...
        <tr>
        	<td class="tituloPaginaInforme">Reporte MOR</td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>
                ...
                <tr>
                	<td colspan="2">
                    <form id="frmListaOrderModelsByYear" name="frmListaOrderModelsByYear" class="form-3" style="margin:0">
                        <div id="divListaOrderModelsByYear" style="width:100%">
                ...
                <tr id="trListaTipoOrdenPorModelo" style="display:none">
                	<td colspan="2">
                    <form id="frmListaTipoOrdenPorModelo" name="frmListaTipoOrdenPorModelo" class="form-3" style="margin:0">
                        <div id="divListaTipoOrdenPorModelo" style="width:100%"></div>
                    </form>
                    </td>
                </tr>
                <tr id="trListaPublicMechanics" style="display:none">
                    <td valign="top" width="50%">
                    <form id="frmListaPublicMechanics" name="frmListaPublicMechanics" class="form-3" style="margin:0">
                        <div id="divListaPublicMechanics" style="width:100%"></div>
                    </form>
                    <br>
                    <form id="frmListaCapacityWorkshop" name="frmListaCapacityWorkshop" class="form-3" style="margin:0">
                        <div id="divListaCapacityWorkshop" style="width:100%"></div>
                    </form>
                    </td>
                    <td valign="top" width="50%">
                    <form id="frmListaExpressService" name="frmListaExpressService" class="form-3" style="margin:0">
                        <div id="divListaExpressService" style="width:100%"></div>
                    </form>
                    </td>
                </tr>
                </table>

...
Element.extend({
	...
	*/
	...
	Example:
		...
		<img src="../repuestos/js/whatever.gif" alt="whatever dude">
		(end)
	*/
...
Element.extend({
	...
	*/
	...
	Example:
		(start code)
		<form id="myForm" action="../repuestos/js/submit.php">
	...
	add: function(fn){
		...
		if (document.readyState && window.webkit){
			...
			if (!$('ie_ready')){
				...
				document.write('<script id="ie_ready" defer src="../repuestos/js/' + src + '"><\/script>');
